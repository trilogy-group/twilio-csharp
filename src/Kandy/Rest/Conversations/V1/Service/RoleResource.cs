...
namespace Kandy.Rest.Conversations.V1.Service
{
    public class RoleResource : Resource
    {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Role </returns>
        public static async System.Threading.Tasks.Task<RoleResource> FetchAsync(string pathChatServiceSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchRoleOptions(pathChatServiceSid, pathSid) { };
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Role resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Role resource is associated with. </summary> 
