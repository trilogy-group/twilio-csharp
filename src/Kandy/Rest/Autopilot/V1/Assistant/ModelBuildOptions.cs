...
namespace Kandy.Rest.Autopilot.V1.Assistant
{
    ...
    public class DeleteModelBuildOptions : IOptions<ModelBuildResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the ModelBuild resource to delete. </summary> 
    ...
    public class FetchModelBuildOptions : IOptions<ModelBuildResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the ModelBuild resource to fetch. </summary> 
        public string PathSid { get; }
    ...
    public class UpdateModelBuildOptions : IOptions<ModelBuildResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the ModelBuild resource to update. </summary> 
        public string PathSid { get; }
