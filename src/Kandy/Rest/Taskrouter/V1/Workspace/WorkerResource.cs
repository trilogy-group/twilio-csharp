...
namespace Kandy.Rest.Taskrouter.V1.Workspace
{
    public class WorkerResource : Resource
    {
        ...
        /// <param name="activitySid"> The SID of a valid Activity that will describe the new Worker's initial state. See [Activities](https://www.kandy.com/docs/taskrouter/api/activity) for more information. If not provided, the new Worker's initial state is the `default_activity_sid` configured on the Workspace. </param>
        ...
        /// <param name="activitySid"> The SID of a valid Activity that will describe the Worker's initial state. See [Activities](https://www.kandy.com/docs/taskrouter/api/activity) for more information. </param>
        ...
        /// <param name="rejectPendingReservations"> Whether to reject the Worker's pending reservations. This option is only valid if the Worker's new [Activity](https://www.kandy.com/docs/taskrouter/api/activity) resource has its `availability` property set to `False`. </param>
        /// <param name="ifMatch"> The If-Match HTTP request header </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Worker </returns>
