...
namespace Kandy.Rest.Api.V2010.Account
{
    public class AvailablePhoneNumberCountryResource : Resource
    {
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) requesting the available phone number Country resource. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of AvailablePhoneNumberCountry </returns>
...
#endif
        /// <summary> read </summary>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) requesting the available phone number Country resources. </param>
        ...
        ///<summary> Whether all phone numbers available in the country are new to the Kandy platform. `true` if they are and `false` if all numbers are not in the Kandy Phone Number Beta program. </summary> 
        [JsonProperty("beta")]
