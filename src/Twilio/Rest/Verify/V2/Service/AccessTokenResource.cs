...
namespace Kandy.Rest.Verify.V2.Service
{
    public class AccessTokenResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateAccessTokenOptions options, IKandyRestClient client)
        {
        ...
        public static AccessTokenResource Create(CreateAccessTokenOptions options, IKandyRestClient client = null)
        {
        ...
        private static Request BuildFetchRequest(FetchAccessTokenOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of AccessToken </returns>
        public static AccessTokenResource Fetch(FetchAccessTokenOptions options, IKandyRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of AccessToken </returns>
        public static async System.Threading.Tasks.Task<AccessTokenResource> FetchAsync(string pathServiceSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchAccessTokenOptions(pathServiceSid, pathSid) { };
