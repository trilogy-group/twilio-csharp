...
namespace Kandy.Rest.Chat.V2.Service
{
    ...
    public class CreateUserOptions : IOptions<UserResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to create the User resource under. </summary> 
        public string PathServiceSid { get; }

        ///<summary> The `identity` value that uniquely identifies the new resource's [User](https://www.kandy.com/docs/chat/rest/user-resource) within the [Service](https://www.kandy.com/docs/chat/rest/service-resource). This value is often a username or email address. See the Identity documentation for more info. </summary> 
        public string Identity { get; }

        ///<summary> The X-Kandy-Webhook-Enabled HTTP request header </summary> 
        public UserResource.WebhookEnabledTypeEnum XKandyWebhookEnabled { get; set; }

        ///<summary> The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) to assign to the new User. </summary> 
    ...
    public class DeleteUserOptions : IOptions<UserResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to delete the User resource from. </summary> 
        public string PathServiceSid { get; }
    ...
    public class FetchUserOptions : IOptions<UserResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to fetch the User resource from. </summary> 
        public string PathServiceSid { get; }
    ...
    public class ReadUserOptions : ReadOptions<UserResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to read the User resources from. </summary> 
        public string PathServiceSid { get; }
    ...
    public class UpdateUserOptions : IOptions<UserResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to update the User resource in. </summary> 
        public string PathServiceSid { get; }
        ...
        ///<summary> The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) to assign to the User. </summary> 
        public string RoleSid { get; set; }
