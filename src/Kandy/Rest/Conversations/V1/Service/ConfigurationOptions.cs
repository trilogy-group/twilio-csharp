...
namespace Kandy.Rest.Conversations.V1.Service
{
    ...
    public class UpdateConfigurationOptions : IOptions<ConfigurationResource>
    {
        ...
        ///<summary> The conversation-level role assigned to a conversation creator when they join a new conversation. See the [Conversation Role](https://www.kandy.com/docs/conversations/api/role-resource) for more info about roles. </summary> 
