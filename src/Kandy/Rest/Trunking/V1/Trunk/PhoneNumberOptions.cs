...
namespace Kandy.Rest.Trunking.V1.Trunk
{
    ...
    public class CreatePhoneNumberOptions : IOptions<PhoneNumberResource>
    {
        ...
        ///<summary> The SID of the [Incoming Phone Number](https://www.kandy.com/docs/phone-numbers/api/incomingphonenumber-resource) that you want to associate with the trunk. </summary> 
