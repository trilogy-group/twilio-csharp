...
namespace Kandy.Rest.Sync.V1.Service
{
    ...
    public class CreateSyncMapOptions : IOptions<SyncMapResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the Sync Map in. </summary> 
        ...
        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Sync Map expires (time-to-live) and is deleted. </summary> 
    ...
    public class DeleteSyncMapOptions : IOptions<SyncMapResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map resource to delete. </summary> 
        public string PathServiceSid { get; }
    ...
    public class FetchSyncMapOptions : IOptions<SyncMapResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map resource to fetch. </summary> 
        public string PathServiceSid { get; }
    ...
    public class ReadSyncMapOptions : ReadOptions<SyncMapResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map resources to read. </summary> 
        public string PathServiceSid { get; }
    ...
    public class UpdateSyncMapOptions : IOptions<SyncMapResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map resource to update. </summary> 
        public string PathServiceSid { get; }
