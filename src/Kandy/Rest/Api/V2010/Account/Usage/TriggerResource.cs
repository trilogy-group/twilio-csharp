...
namespace Kandy.Rest.Api.V2010.Account.Usage
{
    public class TriggerResource : Resource
    {
        ...
        public sealed class UsageCategoryEnum : StringEnum
        {
            ...
            public static readonly UsageCategoryEnum MarketplaceKandyCallerNameLookupUs = new UsageCategoryEnum("marketplace-kandy-caller-name-lookup-us");
            public static readonly UsageCategoryEnum MarketplaceKandyCarrierInformationLookup = new UsageCategoryEnum("marketplace-kandy-carrier-information-lookup");
            ...
            public static readonly UsageCategoryEnum KandyInterconnect = new UsageCategoryEnum("kandy-interconnect");
        ...
        public static TriggerResource Create(
                                          ...
                                          Kandy.Http.HttpMethod callbackMethod = null,
        ...
        /// <summary> delete </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the UsageTrigger resource to delete. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageTrigger resources to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Trigger </returns>
...
#endif
        /// <summary> Fetch and instance of a usage-trigger </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the UsageTrigger resource to fetch. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageTrigger resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Trigger </returns>
...
#endif
        /// <summary> Retrieve a list of usage-triggers belonging to the account used to make the request </summary>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageTrigger resources to read. </param>
        ...
        /// <param name="triggerBy"> The trigger field of the UsageTriggers to read.  Can be: `count`, `usage`, or `price` as described in the [UsageRecords documentation](https://www.kandy.com/docs/usage/api/usage-record#usage-count-price). </param>
        /// <param name="usageCategory"> The usage category of the UsageTriggers to read. Must be a supported [usage categories](https://www.kandy.com/docs/usage/api/usage-record#usage-categories). </param>
        ...
        /// <summary> Update an instance of a usage trigger </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the UsageTrigger resource to update. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageTrigger resources to update. </param>
        /// <param name="callbackMethod"> The HTTP method we should use to call `callback_url`. Can be: `GET` or `POST` and the default is `POST`. </param>
        /// <param name="callbackUrl"> The URL we should call using `callback_method` when the trigger fires. </param>
        /// <param name="friendlyName"> A descriptive string that you create to describe the resource. It can be up to 64 characters long. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that the trigger monitors. </summary> 
        ...
        public Kandy.Http.HttpMethod CallbackMethod { get; private set; }
