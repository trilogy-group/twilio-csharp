...
namespace Kandy.Rest.Autopilot.V1.Assistant
{
    ...
    public class DeleteFieldTypeOptions : IOptions<FieldTypeResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the FieldType resource to delete. </summary> 
    ...
    public class FetchFieldTypeOptions : IOptions<FieldTypeResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the FieldType resource to fetch. </summary> 
        public string PathSid { get; }
    ...
    public class UpdateFieldTypeOptions : IOptions<FieldTypeResource>
    {
        ...
        ///<summary> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the to update. </summary> 
        public string PathAssistantSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the FieldType resource to update. </summary> 
        public string PathSid { get; }
