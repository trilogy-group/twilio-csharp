...
namespace Kandy.Rest.Sync.V1.Service.SyncMap
{
    ...
    public class DeleteSyncMapPermissionOptions : IOptions<SyncMapPermissionResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map Permission resource to delete. Can be the Service's `sid` value or `default`. </summary> 
    ...
    public class FetchSyncMapPermissionOptions : IOptions<SyncMapPermissionResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map Permission resource to fetch. Can be the Service's `sid` value or `default`. </summary> 
        public string PathServiceSid { get; }
    ...
    public class ReadSyncMapPermissionOptions : ReadOptions<SyncMapPermissionResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map Permission resources to read. Can be the Service's `sid` value or `default`. </summary> 
        public string PathServiceSid { get; }
    ...
    public class UpdateSyncMapPermissionOptions : IOptions<SyncMapPermissionResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map Permission resource to update. Can be the Service's `sid` value or `default`. </summary> 
        public string PathServiceSid { get; }
