...
namespace Kandy.Rest.Chat.V2.Service
{
    public class BindingResource : Resource
    {
        ...
        /// <summary> delete </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to delete the Binding resource from. </param>
...
#endif
        /// <summary> fetch </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to fetch the Binding resource from. </param>
...
#endif
        /// <summary> read </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to read the Binding resources from. </param>
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the Binding resource is associated with. </summary> 
        ...
        ///<summary> The absolute URLs of the Binding's [User](https://www.kandy.com/docs/chat/rest/user-resource). </summary> 
        [JsonProperty("links")]
