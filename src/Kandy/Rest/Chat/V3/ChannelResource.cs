...
namespace Kandy.Rest.Chat.V3
{
    public class ChannelResource : Resource
    {
        ...
        /// <param name="messagingServiceSid"> The unique ID of the [Messaging Service](https://www.kandy.com/docs/sms/services/api) this channel belongs to. </param>
        ...
        public static ChannelResource Update(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new UpdateChannelOptions(pathServiceSid, pathSid) { Type = type, MessagingServiceSid = messagingServiceSid, XKandyWebhookEnabled = xKandyWebhookEnabled };
