...
namespace Kandy.Rest.Messaging.V1.Service
{
    ...
    public class CreateShortCodeOptions : IOptions<ShortCodeResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to create the resource under. </summary> 
    ...
    public class FetchShortCodeOptions : IOptions<ShortCodeResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to fetch the resource from. </summary> 
        public string PathServiceSid { get; }
    ...
    public class ReadShortCodeOptions : ReadOptions<ShortCodeResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to read the resources from. </summary> 
        public string PathServiceSid { get; }
