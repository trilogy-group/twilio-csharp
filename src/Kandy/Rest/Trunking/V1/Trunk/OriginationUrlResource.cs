...
namespace Kandy.Rest.Trunking.V1.Trunk
{
    public class OriginationUrlResource : Resource
    {
        ...
        /// <param name="sipUrl"> The SIP address you want Kandy to route your Origination calls to. This must be a `sip:` schema. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of OriginationUrl </returns>
        ...
        /// <param name="enabled"> Whether the URL is enabled. The default is `true`. </param>
        /// <param name="friendlyName"> A descriptive string that you create to describe the resource. It can be up to 64 characters long. </param>
        /// <param name="sipUrl"> The SIP address you want Kandy to route your Origination calls to. This must be a `sip:` schema. `sips` is NOT supported. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of OriginationUrl </returns>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the OriginationUrl resource. </summary> 
        ...
        ///<summary> The SIP address you want Kandy to route your Origination calls to. This must be a `sip:` schema. </summary> 
