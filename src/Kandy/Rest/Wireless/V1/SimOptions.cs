...
namespace Kandy.Rest.Wireless.V1
{
    ...
    public class ReadSimOptions : ReadOptions<SimResource>
    {
        ...
        ///<summary> The SID or unique name of a [RatePlan resource](https://www.kandy.com/docs/wireless/api/rateplan-resource). Only return Sim resources assigned to this RatePlan resource. </summary> 
    ...
    public class UpdateSimOptions : IOptions<SimResource>
    {
        ...
        ///<summary> The SID or unique name of the [RatePlan resource](https://www.kandy.com/docs/wireless/api/rateplan-resource) to which the Sim resource should be assigned. </summary> 
        public string RatePlan { get; set; }
        ...
        public Kandy.Http.HttpMethod CommandsCallbackMethod { get; set; }

        ///<summary> The URL we should call using the `commands_callback_method` when the SIM sends a [Command](https://www.kandy.com/docs/wireless/api/command-resource). Your server should respond with an HTTP status code in the 200 range; any response body is ignored. </summary> 
        ...
        ///<summary> The URL we should call using the `sms_method` when the SIM-connected device sends an SMS message that is not a [Command](https://www.kandy.com/docs/wireless/api/command-resource). </summary> 
