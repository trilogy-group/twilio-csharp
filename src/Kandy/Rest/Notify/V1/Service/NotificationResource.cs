...
namespace Kandy.Rest.Notify.V1.Service
{
    public class NotificationResource : Resource
    {
        ...
        ///<summary> The list of Segments to notify. The [Segment](https://www.kandy.com/docs/notify/api/segment-resource) resource is deprecated. Use the `tags` property, instead. </summary> 
