...
namespace Kandy.Rest.Video.V1
{
    public class RoomResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateRoomOptions options, IKandyRestClient client)
        {
        ...
        public static RoomResource Create(CreateRoomOptions options, IKandyRestClient client = null)
        {
        ...
        /// <param name="statusCallback"> The URL we should call using the `status_callback_method` to send status information to your application on every room event. See [Status Callbacks](https://www.kandy.com/docs/video/api/status-callbacks) for more info. </param>
        ...
        /// <param name="mediaRegion"> The region for the media server in Group Rooms.  Can be: one of the [available Media Regions](https://www.kandy.com/docs/video/ip-address-whitelisting#group-rooms-media-servers). ***This feature is not available in `peer-to-peer` rooms.*** </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Room </returns>
        public static async System.Threading.Tasks.Task<RoomResource> FetchAsync(string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchRoomOptions(pathSid) { };
        ...
        private static Request BuildUpdateRequest(UpdateRoomOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Room </returns>
        public static RoomResource Update(UpdateRoomOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Room resource. </summary> 
        ...
        ///<summary> The URL we call using the `status_callback_method` to send status information to your application on every room event. See [Status Callbacks](https://www.kandy.com/docs/video/api/status-callbacks) for more info. </summary> 
        ...
        ///<summary> The maximum number of published audio, video, and data tracks all participants combined are allowed to publish in the room at the same time. Check [Programmable Video Limits](https://www.kandy.com/docs/video/programmable-video-limits) for more details. If it is set to 0 it means unconstrained. </summary> 
        ...
        ///<summary> The region for the media server in Group Rooms.  Can be: one of the [available Media Regions](https://www.kandy.com/docs/video/ip-address-whitelisting#media-servers). ***This feature is not available in `peer-to-peer` rooms.*** </summary> 
