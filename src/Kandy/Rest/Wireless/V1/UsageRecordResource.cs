...
namespace Kandy.Rest.Wireless.V1
{
    public class UsageRecordResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the AccountUsageRecord resource. </summary> 
        ...
        ///<summary> An object that describes the aggregated Commands usage for all SIMs during the specified period. See [Commands Usage Object](https://www.kandy.com/docs/wireless/api/account-usagerecord-resource#commands-usage-object). </summary> 
        [JsonProperty("commands")]
        public object Commands { get; private set; }

        ///<summary> An object that describes the aggregated Data usage for all SIMs over the period. See [Data Usage Object](https://www.kandy.com/docs/wireless/api/account-usagerecord-resource#data-usage-object). </summary> 
        [JsonProperty("data")]
