...
namespace Kandy.Rest.Verify.V2.Service
{
    public class MessagingConfigurationResource : Resource
    {
        ...
        /// <summary> Create a new MessagingConfiguration for a service. </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/verify/api/service) that the resource is associated with. </param>
        ...
        /// <param name="messagingServiceSid"> The SID of the [Messaging Service](https://www.kandy.com/docs/sms/services/api) to be used to send SMS to the country of this configuration. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of MessagingConfiguration </returns>
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/verify/api/service) that the resource is associated with. </summary> 
        ...
        ///<summary> The SID of the [Messaging Service](https://www.kandy.com/docs/sms/services/api) to be used to send SMS to the country of this configuration. </summary> 
