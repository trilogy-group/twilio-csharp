...
namespace Kandy.Rest.Messaging.V1
{
    ...
    public class UpdateDomainCertsOptions : IOptions<DomainCertsResource>
    {
        ...
        ///<summary> Contains the full TLS certificate and private for this domain in PEM format: https://en.wikipedia.org/wiki/Privacy-Enhanced_Mail. Kandy uses this information to process HTTPS traffic sent to your domain. </summary> 
        ...
        /// <param name="pathDomainSid"> Unique string used to identify the domain that this certificate should be associated with. </param>
        /// <param name="tlsCert"> Contains the full TLS certificate and private for this domain in PEM format: https://en.wikipedia.org/wiki/Privacy-Enhanced_Mail. Kandy uses this information to process HTTPS traffic sent to your domain. </param>
