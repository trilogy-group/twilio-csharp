...
namespace Kandy.Rest.Video.V1
{
    ...
    public class CreateRoomOptions : IOptions<RoomResource>
    {
        ...
        ///<summary> The URL we should call using the `status_callback_method` to send status information to your application on every room event. See [Status Callbacks](https://www.kandy.com/docs/video/api/status-callbacks) for more info. </summary> 
        ...
        ///<summary> The region for the media server in Group Rooms.  Can be: one of the [available Media Regions](https://www.kandy.com/docs/video/ip-address-whitelisting#group-rooms-media-servers). ***This feature is not available in `peer-to-peer` rooms.*** </summary> 
