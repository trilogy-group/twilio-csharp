...
namespace Kandy.Rest.Api.V2010.Account.Usage
{
    ...
    public class CreateTriggerOptions : IOptions<TriggerResource>
    {
        ...
        public Kandy.Http.HttpMethod CallbackMethod { get; set; }
    ...
    public class DeleteTriggerOptions : IOptions<TriggerResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the UsageTrigger resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageTrigger resources to delete. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class FetchTriggerOptions : IOptions<TriggerResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the UsageTrigger resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageTrigger resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class ReadTriggerOptions : ReadOptions<TriggerResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageTrigger resources to read. </summary> 
        public string PathAccountSid { get; set; }
        ...
        ///<summary> The trigger field of the UsageTriggers to read.  Can be: `count`, `usage`, or `price` as described in the [UsageRecords documentation](https://www.kandy.com/docs/usage/api/usage-record#usage-count-price). </summary> 
        public TriggerResource.TriggerFieldEnum TriggerBy { get; set; }

        ///<summary> The usage category of the UsageTriggers to read. Must be a supported [usage categories](https://www.kandy.com/docs/usage/api/usage-record#usage-categories). </summary> 
    ...
    public class UpdateTriggerOptions : IOptions<TriggerResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the UsageTrigger resource to update. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageTrigger resources to update. </summary> 
        public string PathAccountSid { get; set; }
