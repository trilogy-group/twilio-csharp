...
namespace Kandy.Rest.Api.V2010.Account
{
    public class TranscriptionResource : Resource
    {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Transcription </returns>
        public static async System.Threading.Tasks.Task<TranscriptionResource> FetchAsync(string pathSid, string pathAccountSid = null, IKandyRestClient client = null)
        {
            var options = new FetchTranscriptionOptions(pathSid) { PathAccountSid = pathAccountSid };
