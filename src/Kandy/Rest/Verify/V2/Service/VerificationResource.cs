...
namespace Kandy.Rest.Verify.V2.Service
{
    public class VerificationResource : Resource
    {
        ...
        /// <param name="sendDigits"> The digits to send after a phone call is answered, for example, to dial an extension. For more information, see the Programmable Voice documentation of [sendDigits](https://www.kandy.com/docs/voice/twiml/number#attributes-sendDigits). </param>
        ...
        /// <param name="channelConfiguration"> [`email`](https://www.kandy.com/docs/verify/email) channel configuration in json format. The fields 'from' and 'from_name' are optional but if included the 'from' field must have a valid email address. </param>
        ...
        /// <param name="templateSid"> The message [template](https://www.kandy.com/docs/verify/api/templates). If provided, will override the default template for the Service. SMS and Voice channels only. </param>
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/verify/api/service) the resource is associated with. </summary> 
        [JsonProperty("service_sid")]
        public string ServiceSid { get; private set; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Verification resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The phone number or [email](https://www.kandy.com/docs/verify/email) being verified. Phone numbers must be in [E.164 format](https://www.kandy.com/docs/glossary/what-e164). </summary> 
        [JsonProperty("to")]
