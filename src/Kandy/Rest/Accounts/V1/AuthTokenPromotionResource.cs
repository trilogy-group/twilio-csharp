...
namespace Kandy.Rest.Accounts.V1
{
    public class AuthTokenPromotionResource : Resource
    {
        ...
        /// <summary> Promote the secondary Auth Token to primary. After promoting the new token, all requests to Kandy using your old primary Auth Token will result in an error. </summary>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that the secondary Auth Token was created for. </summary> 
