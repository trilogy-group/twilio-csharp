...
namespace Kandy.Rest.Api.V2010.Account.Sip.CredentialList
{
    ...
    public class CreateCredentialOptions : IOptions<CredentialResource>
    {
        ...
        ///<summary> The username that will be passed when authenticating SIP requests. The username should be sent in response to Kandy's challenge of the initial INVITE. It can be up to 32 characters long. </summary> 
