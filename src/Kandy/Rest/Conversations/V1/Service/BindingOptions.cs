...
namespace Kandy.Rest.Conversations.V1.Service
{
    ...
    public class DeleteBindingOptions : IOptions<BindingResource>
    {
        ...
        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to delete the Binding resource from. </summary> 
    ...
    public class ReadBindingOptions : ReadOptions<BindingResource>
    {
        ...
        ///<summary> The identity of a [Conversation User](https://www.kandy.com/docs/conversations/api/user-resource) this binding belongs to. See [access tokens](https://www.kandy.com/docs/conversations/create-tokens) for more details. </summary> 
