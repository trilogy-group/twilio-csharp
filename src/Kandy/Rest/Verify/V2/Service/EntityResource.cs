...
namespace Kandy.Rest.Verify.V2.Service
{
    public class EntityResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateEntityOptions options, IKandyRestClient client)
        {
        ...
        public static EntityResource Create(CreateEntityOptions options, IKandyRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Entity </returns>
        private static Request BuildDeleteRequest(DeleteEntityOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Entity </returns>
        public static bool Delete(DeleteEntityOptions options, IKandyRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Entity </returns>
        public static bool Delete(string pathServiceSid, string pathIdentity, IKandyRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Entity </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathServiceSid, string pathIdentity, IKandyRestClient client = null)
        {
            var options = new DeleteEntityOptions(pathServiceSid, pathIdentity);
        ...
        private static Request BuildFetchRequest(FetchEntityOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Entity </returns>
        public static EntityResource Fetch(FetchEntityOptions options, IKandyRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of Entity </returns>
        public static async System.Threading.Tasks.Task<EntityResource> FetchAsync(string pathServiceSid, string pathIdentity, IKandyRestClient client = null)
        {
            var options = new FetchEntityOptions(pathServiceSid, pathIdentity) { };
        ...
        private static Request BuildReadRequest(ReadEntityOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of Entity </returns>
        public static ResourceSet<EntityResource> Read(ReadEntityOptions options, IKandyRestClient client = null)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        public static Page<EntityResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? TwilioClient.GetRestClient();
        ...
        public static Page<EntityResource> NextPage(Page<EntityResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<EntityResource> PreviousPage(Page<EntityResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
