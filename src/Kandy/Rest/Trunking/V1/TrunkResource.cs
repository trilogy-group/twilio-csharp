...
namespace Kandy.Rest.Trunking.V1
{
    public class TrunkResource : Resource
    {
        ...
        /// <param name="domainName"> The unique address you reserve on Kandy to which you route your SIP traffic. Domain names can contain letters, digits, and `-` and must end with `pstn.kandy.com`. See [Termination Settings](https://www.kandy.com/docs/sip-trunking#termination) for more information. </param>
        ...
        public static TrunkResource Create(
                                          ...
                                          Kandy.Http.HttpMethod disasterRecoveryMethod = null,
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Trunk resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The unique address you reserve on Kandy to which you route your SIP traffic. Domain names can contain letters, digits, and `-` and must end with `pstn.kandy.com`. See [Termination Settings](https://www.kandy.com/docs/sip-trunking#termination) for more information. </summary> 
        ...
        public Kandy.Http.HttpMethod DisasterRecoveryMethod { get; private set; }

        ///<summary> The URL we call using the `disaster_recovery_method` if an error occurs while sending SIP traffic towards the configured Origination URL. We retrieve TwiML from this URL and execute the instructions like any other normal TwiML call. See [Disaster Recovery](https://www.kandy.com/docs/sip-trunking#disaster-recovery) for more information. </summary> 
