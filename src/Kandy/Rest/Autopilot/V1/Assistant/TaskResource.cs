...
namespace Kandy.Rest.Autopilot.V1.Assistant
{
    public class TaskResource : Resource
    {
        ...
        /// <param name="actions"> The JSON string that specifies the [actions](https://www.kandy.com/docs/autopilot/actions) that instruct the Assistant on how to perform the task. It is optional and not unique. </param>
