...
namespace Kandy.Rest.Api.V2010.Account.AvailablePhoneNumberCountry
{
    public class NationalResource : Resource
    {
        ...
        private static Request BuildReadRequest(ReadNationalOptions options, IKandyRestClient client)
        {
        ...
        public static ResourceSet<NationalResource> Read(ReadNationalOptions options, IKandyRestClient client = null)
        {
        ...
        public static Page<NationalResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<NationalResource> NextPage(Page<NationalResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<NationalResource> PreviousPage(Page<NationalResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
