...
namespace Kandy.Rest.Notify.V1.Service
{
    ...
    public class CreateBindingOptions : IOptions<BindingResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/notify/api/service-resource) to create the resource under. </summary> 
        public string PathServiceSid { get; }

        ///<summary> The `identity` value that uniquely identifies the new resource's [User](https://www.kandy.com/docs/chat/rest/user-resource) within the [Service](https://www.kandy.com/docs/notify/api/service-resource). Up to 20 Bindings can be created for the same Identity in a given Service. </summary> 
        ...
        ///<summary> The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) resource to be used to send notifications to this Binding. If present, this overrides the Credential specified in the Service resource. Applies to only `apn`, `fcm`, and `gcm` type Bindings. </summary> 
    ...
    public class DeleteBindingOptions : IOptions<BindingResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/notify/api/service-resource) to delete the resource from. </summary> 
        public string PathServiceSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the Binding resource to delete. </summary> 
    ...
    public class FetchBindingOptions : IOptions<BindingResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/notify/api/service-resource) to fetch the resource from. </summary> 
        public string PathServiceSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the Binding resource to fetch. </summary> 
        public string PathSid { get; }
    ...
    public class ReadBindingOptions : ReadOptions<BindingResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/notify/api/service-resource) to read the resource from. </summary> 
        public string PathServiceSid { get; }
        ...
        ///<summary> The [User](https://www.kandy.com/docs/chat/rest/user-resource)'s `identity` value of the resources to read. </summary> 
