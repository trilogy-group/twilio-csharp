...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class DeleteConnectAppOptions : IOptions<ConnectAppResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the ConnectApp resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ConnectApp resource to fetch. </summary> 
    ...
    public class ReadConnectAppOptions : ReadOptions<ConnectAppResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ConnectApp resources to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateConnectAppOptions : IOptions<ConnectAppResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the ConnectApp resource to update. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ConnectApp resources to update. </summary> 
        public string PathAccountSid { get; set; }
        ...
        public Kandy.Http.HttpMethod DeauthorizeCallbackMethod { get; set; }
