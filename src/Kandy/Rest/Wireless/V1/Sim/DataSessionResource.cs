...
namespace Kandy.Rest.Wireless.V1.Sim
{
    public class DataSessionResource : Resource
    {
...
#endif
        /// <summary> read </summary>
        /// <param name="pathSimSid"> The SID of the [Sim resource](https://www.kandy.com/docs/wireless/api/sim-resource) with the Data Sessions to read. </param>
        ...
        ///<summary> The SID of the [Sim resource](https://www.kandy.com/docs/wireless/api/sim-resource) that the Data Session is for. </summary> 
        [JsonProperty("sim_sid")]
        public string SimSid { get; private set; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the DataSession resource. </summary> 
        ...
        ///<summary> The friendly name of the mobile operator network that the [SIM](https://www.kandy.com/docs/wireless/api/sim-resource)-connected device is attached to. This is determined by looking up the `operator_mnc`. </summary> 
