...
namespace Kandy.Rest.FlexApi.V1.Interaction.InteractionChannel
{
    public class InteractionChannelParticipantResource : Resource
    {
        ...
        /// <param name="pathInteractionSid"> The Interaction Sid for this channel. </param>
        /// <param name="pathChannelSid"> The Channel Sid for this Participant. </param>
        /// <param name="pathSid"> The unique string created by Kandy to identify an Interaction Channel resource. </param>
        ...
        ///<summary> The unique string created by Kandy to identify an Interaction Channel Participant resource. </summary> 
        [JsonProperty("sid")]
