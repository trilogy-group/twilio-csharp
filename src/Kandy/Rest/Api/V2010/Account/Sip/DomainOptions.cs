...
namespace Kandy.Rest.Api.V2010.Account.Sip
{
    ...
    public class CreateDomainOptions : IOptions<DomainResource>
    {
        ...
        ///<summary> The unique address you reserve on Kandy to which you route your SIP traffic. Domain names can contain letters, digits, and \\\"-\\\" and must end with `sip.kandy.com`. </summary> 
        ...
        public Kandy.Http.HttpMethod VoiceStatusCallbackMethod { get; set; }
        ...
        /// <param name="domainName"> The unique address you reserve on Kandy to which you route your SIP traffic. Domain names can contain letters, digits, and \\\"-\\\" and must end with `sip.kandy.com`. </param>
    ...
    public class DeleteDomainOptions : IOptions<DomainResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the SipDomain resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SipDomain resources to delete. </summary> 
        public string PathAccountSid { get; set; }



        /// <summary> Construct a new DeleteSipDomainOptions </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the SipDomain resource to delete. </param>
    ...
    public class FetchDomainOptions : IOptions<DomainResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the SipDomain resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SipDomain resource to fetch. </summary> 
        public string PathAccountSid { get; set; }



        /// <summary> Construct a new FetchSipDomainOptions </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the SipDomain resource to fetch. </param>
    ...
    public class ReadDomainOptions : ReadOptions<DomainResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SipDomain resources to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateDomainOptions : IOptions<DomainResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the SipDomain resource to update. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SipDomain resource to update. </summary> 
        public string PathAccountSid { get; set; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the SipDomain resource to update. </param>
