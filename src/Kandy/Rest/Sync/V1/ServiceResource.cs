...
namespace Kandy.Rest.Sync.V1
{
    public class ServiceResource : Resource
    {
        ...
        /// <param name="aclEnabled"> Whether token identities in the Service must be granted access to Sync objects by using the [Permissions](https://www.kandy.com/docs/sync/api/sync-permissions) resource. </param>
        ...
        ///<summary> Whether token identities in the Service must be granted access to Sync objects by using the [Permissions](https://www.kandy.com/docs/sync/api/sync-permissions) resource. It is disabled (false) by default. </summary> 
