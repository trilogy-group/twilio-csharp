...
namespace Kandy.Rest.Chat.V2.Service.Channel
{
    public class InviteResource : Resource
    {
        ...
        /// <param name="roleSid"> The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) assigned to the new member. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Invite </returns>
        ...
        /// <param name="identity"> The [User](https://www.kandy.com/docs/chat/rest/user-resource)'s `identity` value of the resources to read. See [access tokens](https://www.kandy.com/docs/chat/create-tokens) for more details. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Invite resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the Invite resource belongs to. </summary> 
        [JsonProperty("channel_sid")]
        public string ChannelSid { get; private set; }

        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the Invite resource is associated with. </summary> 
        ...
        ///<summary> The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) assigned to the resource. </summary> 
