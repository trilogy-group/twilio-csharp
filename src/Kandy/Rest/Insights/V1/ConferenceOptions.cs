...
namespace Kandy.Rest.Insights.V1
{
    ...
    public class ReadConferenceOptions : ReadOptions<ConferenceResource>
    {
        ...
        ///<summary> Kandy region where the conference media was mixed. </summary> 
        public string MixerRegion { get; set; }

        ///<summary> Tags applied by Kandy for common potential configuration, quality, or performance issues. </summary> 
