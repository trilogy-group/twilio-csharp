...
namespace Kandy.Rest.Conversations.V1.Service.Conversation
{
    public class MessageResource : Resource
    {
        ...
        public static MessageResource Create(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new CreateMessageOptions(pathChatServiceSid, pathConversationSid) { Author = author, Body = body, DateCreated = dateCreated, DateUpdated = dateUpdated, Attributes = attributes, MediaSid = mediaSid, ContentSid = contentSid, ContentVariables = contentVariables, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Message </returns>
        public static bool Delete(string pathChatServiceSid, string pathConversationSid, string pathSid, MessageResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteMessageOptions(pathChatServiceSid, pathConversationSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Message </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathChatServiceSid, string pathConversationSid, string pathSid, MessageResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteMessageOptions(pathChatServiceSid, pathConversationSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        public static MessageResource Update(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new UpdateMessageOptions(pathChatServiceSid, pathConversationSid, pathSid) { Author = author, Body = body, DateCreated = dateCreated, DateUpdated = dateUpdated, Attributes = attributes, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        ///<summary> The index of the message within the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource). </summary> 
        [JsonProperty("index")]
