...
namespace Kandy.Rest.Numbers.V2.RegulatoryCompliance
{
    public class SupportingDocumentTypeResource : Resource
    {
        ...
        private static Request BuildFetchRequest(FetchSupportingDocumentTypeOptions options, IKandyRestClient client)
        {
        ...
        public static SupportingDocumentTypeResource Fetch(FetchSupportingDocumentTypeOptions options, IKandyRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of SupportingDocumentType </returns>
        public static async System.Threading.Tasks.Task<SupportingDocumentTypeResource> FetchAsync(string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchSupportingDocumentTypeOptions(pathSid) { };
        ...
        private static Request BuildReadRequest(ReadSupportingDocumentTypeOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of SupportingDocumentType </returns>
        public static ResourceSet<SupportingDocumentTypeResource> Read(ReadSupportingDocumentTypeOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<SupportingDocumentTypeResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<SupportingDocumentTypeResource> NextPage(Page<SupportingDocumentTypeResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<SupportingDocumentTypeResource> PreviousPage(Page<SupportingDocumentTypeResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
