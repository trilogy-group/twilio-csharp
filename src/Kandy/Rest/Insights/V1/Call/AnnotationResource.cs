...
namespace Kandy.Rest.Insights.V1.Call
{
    public class AnnotationResource : Resource
    {
        ...
        /// <summary> Create/Update the annotation for the call </summary>
        /// <param name="pathCallSid"> The unique string that Kandy created to identify this Call resource. It always starts with a CA. </param>
        ...
        /// <param name="comment"> Specify any comments pertaining to the call. This of type string with a max limit of 100 characters. Kandy does not treat this field as PII, so don’t put any PII in here. </param>
        /// <param name="incident"> Associate this call with an incident or support ticket. This is of type string with a max limit of 100 characters. Kandy does not treat this field as PII, so don’t put any PII in here. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Annotation </returns>
        ...
        ///<summary> Specify any comments pertaining to the call. This of type string with a max limit of 100 characters. Kandy does not treat this field as PII, so don’t put any PII in here. </summary> 
        [JsonProperty("comment")]
        public string Comment { get; private set; }

        ///<summary> Associate this call with an incident or support ticket. This is of type string with a max limit of 100 characters. Kandy does not treat this field as PII, so don’t put any PII in here. </summary> 
