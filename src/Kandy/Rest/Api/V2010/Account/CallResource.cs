...
namespace Kandy.Rest.Api.V2010.Account
{
    public class CallResource : Resource
    {
        ...
        /// <summary> Create a new outgoing call to phones, SIP-enabled endpoints or Kandy Client connections </summary>
        ...
        /// <param name="twiml"> TwiML instructions for the call Kandy will use without fetching Twiml from url parameter. If both `twiml` and `url` are provided then `twiml` parameter will be ignored. Max 4000 characters. </param>
        ...
        /// <param name="callerId"> The phone number, SIP address, or Client identifier that made this call. Phone numbers are in [E.164 format](https://wwnw.kandy.com/docs/glossary/what-e164) (e.g., +16175551212). SIP addresses are formatted as `name@company.com`. </param>
        ...
        public static CallResource Create(
                                          ...
                                          Kandy.Http.HttpMethod asyncAmdStatusCallbackMethod = null,
                                          string byoc = null,
        ...
        /// <summary> Delete a Call record from your account. Once the record is deleted, it will no longer appear in the API and Account Portal logs. </summary>
        /// <param name="pathSid"> The Kandy-provided Call SID that uniquely identifies the Call resource to delete </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call resource(s) to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Call </returns>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call resource(s) to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Call </returns>
...
#endif
        /// <summary> Retrieves a collection of calls made to and from your account </summary>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call resource(s) to read. </param>
        ...
        /// <summary> Initiates a call redirect or terminates a call </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Call resource to update </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call resource(s) to update. </param>
        /// <param name="url"> The absolute URL that returns the TwiML instructions for the call. We will call this URL using the `method` when the call connects. For more information, see the [Url Parameter](https://www.kandy.com/docs/voice/make-calls#specify-a-url-parameter) section in [Making Calls](https://www.kandy.com/docs/voice/make-calls). </param>
        ...
        /// <param name="twiml"> TwiML instructions for the call Kandy will use without fetching Twiml from url. Twiml and url parameters are mutually exclusive </param>
        /// <param name="timeLimit"> The maximum duration of the call in seconds. Constraints depend on account and configuration. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Call </returns>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created this Call resource. </summary> 
        ...
        ///<summary> The phone number, SIP address or Client identifier that received this call. Formatted for display. Non-North American phone numbers are in [E.164](https://www.kandy.com/docs/glossary/what-e164) format (e.g., +442071838750). </summary> 
        ...
        ///<summary> The calling phone number, SIP address, or Client identifier formatted for display. Non-North American phone numbers are in [E.164](https://www.kandy.com/docs/glossary/what-e164) format (e.g., +442071838750). </summary> 
        ...
        ///<summary> A list of subresources available to this call, identified by their URIs relative to `https://api.kandy.com`. </summary> 
