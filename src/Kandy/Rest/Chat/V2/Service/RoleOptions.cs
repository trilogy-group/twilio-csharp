...
namespace Kandy.Rest.Chat.V2.Service
{
    ...
    public class CreateRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to create the Role resource under. </summary> 
        ...
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to create the Role resource under. </param>
    ...
    public class DeleteRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to delete the Role resource from. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to delete the Role resource from. </param>
    ...
    public class FetchRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to fetch the Role resource from. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to fetch the Role resource from. </param>
    ...
    public class ReadRoleOptions : ReadOptions<RoleResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to read the Role resources from. </summary> 
        public string PathServiceSid { get; }



        /// <summary> Construct a new ListRoleOptions </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to read the Role resources from. </param>
    ...
    public class UpdateRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to update the Role resource in. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to update the Role resource in. </param>
