...
namespace Kandy.Rest.Api.V2010.Account.Sip.IpAccessControlList
{
    public class IpAddressResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateIpAddressOptions options, IKandyRestClient client)
        {
        ...
        public static IpAddressResource Create(CreateIpAddressOptions options, IKandyRestClient client = null)
        {
        ...
        /// <param name="ipAddress"> An IP address in dotted decimal notation from which you want to accept traffic. Any SIP requests from this IP address will be allowed by Kandy. IPv4 only supported today. </param>
        /// <param name="pathAccountSid"> The unique id of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this resource. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of IpAddress </returns>
        private static Request BuildDeleteRequest(DeleteIpAddressOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of IpAddress </returns>
        public static bool Delete(DeleteIpAddressOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of IpAddress </returns>
        public static bool Delete(string pathIpAccessControlListSid, string pathSid, string pathAccountSid = null, IKandyRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of IpAddress </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathIpAccessControlListSid, string pathSid, string pathAccountSid = null, IKandyRestClient client = null)
        {
            var options = new DeleteIpAddressOptions(pathIpAccessControlListSid, pathSid) { PathAccountSid = pathAccountSid };
        ...
        private static Request BuildFetchRequest(FetchIpAddressOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of IpAddress </returns>
        public static IpAddressResource Fetch(FetchIpAddressOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of IpAddress </returns>
        public static async System.Threading.Tasks.Task<IpAddressResource> FetchAsync(string pathIpAccessControlListSid, string pathSid, string pathAccountSid = null, IKandyRestClient client = null)
        {
            var options = new FetchIpAddressOptions(pathIpAccessControlListSid, pathSid) { PathAccountSid = pathAccountSid };
        ...
        private static Request BuildReadRequest(ReadIpAddressOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of IpAddress </returns>
        public static ResourceSet<IpAddressResource> Read(ReadIpAddressOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<IpAddressResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<IpAddressResource> NextPage(Page<IpAddressResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<IpAddressResource> PreviousPage(Page<IpAddressResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        private static Request BuildUpdateRequest(UpdateIpAddressOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of IpAddress </returns>
        public static IpAddressResource Update(UpdateIpAddressOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        ///<summary> An IP address in dotted decimal notation from which you want to accept traffic. Any SIP requests from this IP address will be allowed by Kandy. IPv4 only supported today. </summary> 
