...
namespace Kandy.Rest.Autopilot.V1.Assistant.FieldType
{
    ...
    public class CreateFieldValueOptions : IOptions<FieldValueResource>
    {
        ...
        ///<summary> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the FieldType associated with the new resource. </summary> 
        ...
        /// <param name="pathAssistantSid"> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the FieldType associated with the new resource. </param>
    ...
    public class DeleteFieldValueOptions : IOptions<FieldValueResource>
    {
        ...
        ///<summary> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the FieldType associated with the resources to delete. </summary> 
        public string PathAssistantSid { get; }

        ///<summary> The SID of the Field Type associated with the Field Value to delete. </summary> 
        public string PathFieldTypeSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the FieldValue resource to delete. </summary> 
        public string PathSid { get; }



        /// <summary> Construct a new DeleteFieldValueOptions </summary>
        /// <param name="pathAssistantSid"> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the FieldType associated with the resources to delete. </param>
        /// <param name="pathFieldTypeSid"> The SID of the Field Type associated with the Field Value to delete. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the FieldValue resource to delete. </param>
    ...
    public class FetchFieldValueOptions : IOptions<FieldValueResource>
    {
        ...
        ///<summary> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the FieldType associated with the resource to fetch. </summary> 
        public string PathAssistantSid { get; }

        ///<summary> The SID of the Field Type associated with the Field Value to fetch. </summary> 
        public string PathFieldTypeSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the FieldValue resource to fetch. </summary> 
        public string PathSid { get; }



        /// <summary> Construct a new FetchFieldValueOptions </summary>
        /// <param name="pathAssistantSid"> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the FieldType associated with the resource to fetch. </param>
        /// <param name="pathFieldTypeSid"> The SID of the Field Type associated with the Field Value to fetch. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the FieldValue resource to fetch. </param>
    ...
    public class ReadFieldValueOptions : ReadOptions<FieldValueResource>
    {
        ...
        ///<summary> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the FieldType associated with the resources to read. </summary> 
        public string PathAssistantSid { get; }
        ...
        /// <param name="pathAssistantSid"> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the FieldType associated with the resources to read. </param>
