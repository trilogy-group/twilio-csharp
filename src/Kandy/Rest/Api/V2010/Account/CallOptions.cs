...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class CreateCallOptions : IOptions<CallResource>
    {
        ...
        public Kandy.Http.HttpMethod FallbackMethod { get; set; }
        ...
        ///<summary> The phone number, SIP address, or Client identifier that made this call. Phone numbers are in [E.164 format](https://wwnw.kandy.com/docs/glossary/what-e164) (e.g., +16175551212). SIP addresses are formatted as `name@company.com`. </summary> 
        ...
        public Kandy.Http.HttpMethod AsyncAmdStatusCallbackMethod { get; set; }
        ...
        ///<summary> TwiML instructions for the call Kandy will use without fetching Twiml from url parameter. If both `twiml` and `url` are provided then `twiml` parameter will be ignored. Max 4000 characters. </summary> 
    ...
    public class DeleteCallOptions : IOptions<CallResource>
    {
        ...
        ///<summary> The Kandy-provided Call SID that uniquely identifies the Call resource to delete </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call resource(s) to delete. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class FetchCallOptions : IOptions<CallResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call resource(s) to fetch. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class ReadCallOptions : ReadOptions<CallResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call resource(s) to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateCallOptions : IOptions<CallResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Call resource to update </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call resource(s) to update. </summary> 
        public string PathAccountSid { get; set; }
        ...
        ///<summary> TwiML instructions for the call Kandy will use without fetching Twiml from url. Twiml and url parameters are mutually exclusive </summary> 
        public Types.Twiml Twiml { get; set; }
