...
namespace Kandy.Rest.Proxy.V1
{
    ...
    /// <summary> Create a new Service for Kandy Proxy </summary>
    ...
    /// <summary> Retrieve a list of all Services for Kandy Proxy. A maximum of 100 records will be returned per page. </summary>
