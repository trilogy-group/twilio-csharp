...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    ...
    public class CreatePaymentOptions : IOptions<PaymentResource>
    {
        ...
        ///<summary> Provide an absolute or relative URL to receive status updates regarding your Pay session. Read more about the [expected StatusCallback values](https://www.kandy.com/docs/voice/api/payment-resource#statuscallback) </summary> 
        ...
        ///<summary> A single-level JSON object used to pass custom parameters to payment processors. (Required for ACH payments). The information that has to be included here depends on the <Pay> Connector. [Read more](https://www.kandy.com/console/voice/pay-connectors). </summary> 
        public object Parameter { get; set; }

        ///<summary> This is the unique name corresponding to the Pay Connector installed in the Kandy Add-ons. Learn more about [<Pay> Connectors](https://www.kandy.com/console/voice/pay-connectors). The default value is `Default`. </summary> 
    ...
    public class UpdatePaymentOptions : IOptions<PaymentResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that will update the resource. </summary> 
        public string PathAccountSid { get; set; }
