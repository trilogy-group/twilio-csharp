...
namespace Kandy.Rest.Conversations.V1.Service
{
    ...
    public class CreateRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to create the Role resource under. </summary> 
        ...
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to create the Role resource under. </param>
    ...
    public class DeleteRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to delete the Role resource from. </summary> 
        public string PathChatServiceSid { get; }
        ...
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to delete the Role resource from. </param>
    ...
    public class FetchRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to fetch the Role resource from. </summary> 
        public string PathChatServiceSid { get; }
        ...
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to fetch the Role resource from. </param>
    ...
    public class ReadRoleOptions : ReadOptions<RoleResource>
    {
        ...
        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to read the Role resources from. </summary> 
        public string PathChatServiceSid { get; }



        /// <summary> Construct a new ListServiceRoleOptions </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to read the Role resources from. </param>
    ...
    public class UpdateRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to update the Role resource in. </summary> 
        public string PathChatServiceSid { get; }
        ...
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to update the Role resource in. </param>
