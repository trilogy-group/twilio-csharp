...
namespace Kandy.Rest.Voice.V1
{
    ...
    public class DeleteByocTrunkOptions : IOptions<ByocTrunkResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the BYOC Trunk resource to delete. </summary> 
    ...
    public class FetchByocTrunkOptions : IOptions<ByocTrunkResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the BYOC Trunk resource to fetch. </summary> 
        public string PathSid { get; }
    ...
    public class UpdateByocTrunkOptions : IOptions<ByocTrunkResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the BYOC Trunk resource to update. </summary> 
        public string PathSid { get; }
