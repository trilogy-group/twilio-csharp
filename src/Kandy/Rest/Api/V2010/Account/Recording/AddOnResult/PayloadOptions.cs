...
namespace Kandy.Rest.Api.V2010.Account.Recording.AddOnResult
{
    ...
    public class DeletePayloadOptions : IOptions<PayloadResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Recording AddOnResult Payload resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording AddOnResult Payload resources to delete. </summary> 
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Recording AddOnResult Payload resource to delete. </param>
    ...
    public class FetchPayloadOptions : IOptions<PayloadResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Recording AddOnResult Payload resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording AddOnResult Payload resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Recording AddOnResult Payload resource to fetch. </param>
    ...
    public class ReadPayloadOptions : ReadOptions<PayloadResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording AddOnResult Payload resources to read. </summary> 
        public string PathAccountSid { get; set; }
