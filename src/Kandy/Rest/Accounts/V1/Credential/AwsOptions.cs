...
namespace Kandy.Rest.Accounts.V1.Credential
{
    ...
    public class DeleteAwsOptions : IOptions<AwsResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the AWS resource to delete. </summary> 
        public string PathSid { get; }



        /// <summary> Construct a new DeleteCredentialAwsOptions </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the AWS resource to delete. </param>
    ...
    public class FetchAwsOptions : IOptions<AwsResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the AWS resource to fetch. </summary> 
        public string PathSid { get; }



        /// <summary> Construct a new FetchCredentialAwsOptions </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the AWS resource to fetch. </param>
    ...
    public class UpdateAwsOptions : IOptions<AwsResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the AWS resource to update. </summary> 
        public string PathSid { get; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the AWS resource to update. </param>
