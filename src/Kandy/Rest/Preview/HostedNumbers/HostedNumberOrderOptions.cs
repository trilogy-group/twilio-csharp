...
namespace Kandy.Rest.Preview.HostedNumbers
{
    ...
    public class CreateHostedNumberOrderOptions : IOptions<HostedNumberOrderResource>
    {
        ...
        ///<summary> Used to specify that the SMS capability will be hosted on Kandy's platform. </summary> 
        ...
        ///<summary> The URL that Kandy should request when somebody sends an SMS to the phone number. This will be copied onto the IncomingPhoneNumber resource. </summary> 
        ...
        ///<summary> A URL that Kandy will request if an error occurs requesting or executing the TwiML defined by SmsUrl. This will be copied onto the IncomingPhoneNumber resource. </summary> 
        ...
        ///<summary> Optional. The 34 character sid of the application Kandy should use to handle SMS messages sent to this number. If a `SmsApplicationSid` is present, Kandy will ignore all of the SMS urls above and use those set on the application. </summary> 
