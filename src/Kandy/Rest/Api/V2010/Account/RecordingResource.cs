...
namespace Kandy.Rest.Api.V2010.Account
{
    public class RecordingResource : Resource
    {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Recording </returns>
        public static async System.Threading.Tasks.Task<RecordingResource> FetchAsync(string pathSid, string pathAccountSid = null, bool? includeSoftDeleted = null, IKandyRestClient client = null)
        {
            var options = new FetchRecordingOptions(pathSid) { PathAccountSid = pathAccountSid, IncludeSoftDeleted = includeSoftDeleted };
        ...
        /// <param name="callSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resources to read. </param>
        ...
        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Recording resource is associated with. This will always refer to the parent leg of a two-leg call. </summary> 
