...
namespace Kandy.Rest.Api.V2010.Account.Sip.Domain.AuthTypes.AuthTypeCalls
{
    ...
    public class DeleteAuthCallsIpAccessControlListMappingOptions : IOptions<AuthCallsIpAccessControlListMappingResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the IpAccessControlListMapping resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IpAccessControlListMapping resources to delete. </summary> 
        public string PathAccountSid { get; set; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the IpAccessControlListMapping resource to delete. </param>
    ...
    public class FetchAuthCallsIpAccessControlListMappingOptions : IOptions<AuthCallsIpAccessControlListMappingResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the IpAccessControlListMapping resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IpAccessControlListMapping resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the IpAccessControlListMapping resource to fetch. </param>
    ...
    public class ReadAuthCallsIpAccessControlListMappingOptions : ReadOptions<AuthCallsIpAccessControlListMappingResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IpAccessControlListMapping resources to read. </summary> 
        public string PathAccountSid { get; set; }
