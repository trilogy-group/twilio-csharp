...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    public class RecordingResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateRecordingOptions options, IKandyRestClient client)
        {
        ...
        public static RecordingResource Create(CreateRecordingOptions options, IKandyRestClient client = null)
        {
        ...
        /// <param name="recordingTrack"> The audio track to record for the call. Can be: `inbound`, `outbound` or `both`. The default is `both`. `inbound` records the audio that is received by Kandy. `outbound` records the audio that is generated from Kandy. `both` records the audio that is received and generated by Kandy. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Recording </returns>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording resources to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Recording </returns>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Recording </returns>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Recording </returns>
        public static async System.Threading.Tasks.Task<RecordingResource> FetchAsync(string pathCallSid, string pathSid, string pathAccountSid = null, IKandyRestClient client = null)
        {
            var options = new FetchRecordingOptions(pathCallSid, pathSid) { PathAccountSid = pathAccountSid };
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording resources to read. </param>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording resource to update. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording resource. </summary> 
        ...
        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Recording resource is associated with. </summary> 
        ...
        ///<summary> How to decrypt the recording if it was encrypted using [Call Recording Encryption](https://www.kandy.com/docs/voice/tutorials/voice-recording-encryption) feature. </summary> 
        ...
        ///<summary> The error code that describes why the recording is `absent`. The error code is described in our [Error Dictionary](https://www.kandy.com/docs/api/errors). This value is null if the recording `status` is not `absent`. </summary> 
