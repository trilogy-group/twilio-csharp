...
namespace Kandy.Rest.Conversations.V1
{
    ...
    public class UpdateConfigurationOptions : IOptions<ConfigurationResource>
    {
        ...
        ///<summary> The SID of the default [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to use when creating a conversation. </summary> 
        public string DefaultChatServiceSid { get; set; }

        ///<summary> The SID of the default [Messaging Service](https://www.kandy.com/docs/sms/services/api) to use when creating a conversation. </summary> 
