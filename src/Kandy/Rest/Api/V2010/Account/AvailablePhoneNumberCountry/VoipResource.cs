...
namespace Kandy.Rest.Api.V2010.Account.AvailablePhoneNumberCountry
{
    public class VoipResource : Resource
    {
        ...
        private static Request BuildReadRequest(ReadVoipOptions options, IKandyRestClient client)
        {
        ...
        public static ResourceSet<VoipResource> Read(ReadVoipOptions options, IKandyRestClient client = null)
        {
        ...
        public static Page<VoipResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<VoipResource> NextPage(Page<VoipResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<VoipResource> PreviousPage(Page<VoipResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
