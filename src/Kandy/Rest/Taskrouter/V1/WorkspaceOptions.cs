...
namespace Kandy.Rest.Taskrouter.V1
{
    ...
    public class UpdateWorkspaceOptions : IOptions<WorkspaceResource>
    {
        ...
        ///<summary> The URL we should call when an event occurs. See [Workspace Events](https://www.kandy.com/docs/taskrouter/api/event) for more information. This parameter supports Kandy's [Webhooks (HTTP callbacks) Connection Overrides](https://www.kandy.com/docs/usage/webhooks/webhooks-connection-overrides). </summary> 
        public Uri EventCallbackUrl { get; set; }
