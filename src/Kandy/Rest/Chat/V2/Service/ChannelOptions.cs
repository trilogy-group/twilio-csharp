...
namespace Kandy.Rest.Chat.V2.Service
{
    ...
    public class CreateChannelOptions : IOptions<ChannelResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to create the Channel resource under. </summary> 
    ...
    public class DeleteChannelOptions : IOptions<ChannelResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to delete the resource from. </summary> 
        public string PathServiceSid { get; }
    ...
    public class FetchChannelOptions : IOptions<ChannelResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to fetch the Channel resource from. </summary> 
        public string PathServiceSid { get; }
    ...
    public class ReadChannelOptions : ReadOptions<ChannelResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to read the Channel resources from. </summary> 
        public string PathServiceSid { get; }
    ...
    public class UpdateChannelOptions : IOptions<ChannelResource>
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to update the Channel resource in. </summary> 
        public string PathServiceSid { get; }
