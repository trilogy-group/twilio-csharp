...
namespace Kandy.Rest.Chat.V2.Service.Channel
{
    public class MessageResource : Resource
    {
        ...
        /// <summary> create </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to create the Message resource under. </param>
        /// <param name="pathChannelSid"> The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the new Message resource belongs to. This value can be the Channel resource's `sid` or `unique_name`. </param>
        /// <param name="from"> The [Identity](https://www.kandy.com/docs/chat/identity) of the new message's author. The default value is `system`. </param>
        ...
        /// <param name="lastUpdatedBy"> The [Identity](https://www.kandy.com/docs/chat/identity) of the User who last updated the Message, if applicable. </param>
        ...
        /// <param name="mediaSid"> The SID of the [Media](https://www.kandy.com/docs/chat/rest/media) to attach to the new Message. </param>
        ...
        public static MessageResource Create(
                                          ...
                                          MessageResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null,
                                          IKandyRestClient client = null)
        {
            var options = new CreateMessageOptions(pathServiceSid, pathChannelSid) { From = from, Attributes = attributes, DateCreated = dateCreated, DateUpdated = dateUpdated, LastUpdatedBy = lastUpdatedBy, Body = body, MediaSid = mediaSid, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <summary> delete </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to delete the Message resource from. </param>
        /// <param name="pathChannelSid"> The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the Message resource to delete belongs to. This value can be the Channel resource's `sid` or `unique_name`. </param>
        /// <param name="pathSid"> The SID of the Message resource to delete. </param>
        /// <param name="xKandyWebhookEnabled"> The X-Kandy-Webhook-Enabled HTTP request header </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Message </returns>
        public static bool Delete(string pathServiceSid, string pathChannelSid, string pathSid, MessageResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteMessageOptions(pathServiceSid, pathChannelSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Message </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathServiceSid, string pathChannelSid, string pathSid, MessageResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteMessageOptions(pathServiceSid, pathChannelSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
...
#endif
        /// <summary> fetch </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to fetch the Message resource from. </param>
        /// <param name="pathChannelSid"> The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the Message resource to fetch belongs to. This value can be the Channel resource's `sid` or `unique_name`. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Message </returns>
        public static async System.Threading.Tasks.Task<MessageResource> FetchAsync(string pathServiceSid, string pathChannelSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchMessageOptions(pathServiceSid, pathChannelSid, pathSid) { };
...
#endif
        /// <summary> read </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to read the Message resources from. </param>
        /// <param name="pathChannelSid"> The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the Message resource to read belongs to. This value can be the Channel resource's `sid` or `unique_name`. </param>
        ...
        /// <summary> update </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to update the Message resource in. </param>
        /// <param name="pathChannelSid"> The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the Message resource to update belongs to. This value can be the Channel resource's `sid` or `unique_name`. </param>
        ...
        /// <param name="dateUpdated"> The date, specified in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format, to assign to the resource as the date it was last updated. </param>
        /// <param name="lastUpdatedBy"> The [Identity](https://www.kandy.com/docs/chat/identity) of the User who last updated the Message, if applicable. </param>
        /// <param name="from"> The [Identity](https://www.kandy.com/docs/chat/identity) of the message's author. </param>
        /// <param name="xKandyWebhookEnabled"> The X-Kandy-Webhook-Enabled HTTP request header </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Message </returns>
        public static MessageResource Update(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new UpdateMessageOptions(pathServiceSid, pathChannelSid, pathSid) { Body = body, Attributes = attributes, DateCreated = dateCreated, DateUpdated = dateUpdated, LastUpdatedBy = lastUpdatedBy, From = from, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Message resource. </summary> 
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the Message resource is associated with. </summary> 
        [JsonProperty("service_sid")]
        public string ServiceSid { get; private set; }

        ///<summary> The SID of the [Channel](https://www.kandy.com/docs/chat/channels) that the message was sent to. </summary> 
        [JsonProperty("to")]
        public string To { get; private set; }

        ///<summary> The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the Message resource belongs to. </summary> 
        ...
        ///<summary> The [Identity](https://www.kandy.com/docs/chat/identity) of the User who last updated the Message, if applicable. </summary> 
        ...
        ///<summary> The [Identity](https://www.kandy.com/docs/chat/identity) of the message's author. The default value is `system`. </summary> 
        [JsonProperty("from")]
        ...
        ///<summary> The index of the message within the [Channel](https://www.kandy.com/docs/chat/channels). Indices may skip numbers, but will always be in order of when the message was received. </summary> 
        [JsonProperty("index")]
