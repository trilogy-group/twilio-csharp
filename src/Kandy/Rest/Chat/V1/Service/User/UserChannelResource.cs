...
namespace Kandy.Rest.Chat.V1.Service.User
{
    public class UserChannelResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the User Channel resource. </summary> 
        ...
        ///<summary> The SID of a [Member](https://www.kandy.com/docs/api/chat/rest/members) that represents the User on the Channel. </summary> 
