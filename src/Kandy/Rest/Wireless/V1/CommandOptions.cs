...
namespace Kandy.Rest.Wireless.V1
{
    ...
    public class CreateCommandOptions : IOptions<CommandResource>
    {
        ...
        ///<summary> The `sid` or `unique_name` of the [SIM](https://www.kandy.com/docs/wireless/api/sim-resource) to send the Command to. </summary> 
    ...
    public class ReadCommandOptions : ReadOptions<CommandResource>
    {
        ...
        ///<summary> The `sid` or `unique_name` of the [Sim resources](https://www.kandy.com/docs/wireless/api/sim-resource) to read. </summary> 
        public string Sim { get; set; }
