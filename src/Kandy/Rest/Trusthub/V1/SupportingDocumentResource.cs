...
namespace Kandy.Rest.Trusthub.V1
{
    public class SupportingDocumentResource : Resource
    {
        ...
        /// <summary> Delete a specific Supporting Document. </summary>
        /// <param name="pathSid"> The unique string created by Kandy to identify the Supporting Document resource. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of SupportingDocument </returns>
        ...
        ///<summary> The unique string created by Kandy to identify the Supporting Document resource. </summary> 
        [JsonProperty("sid")]
