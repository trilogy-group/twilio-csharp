...
namespace Kandy.Rest.Chat.V1.Service
{
    public class UserResource : Resource
    {
        ...
        /// <param name="roleSid"> The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to the new User. </param>
        ...
        /// <param name="roleSid"> The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to this user. </param>
        /// <param name="attributes"> A valid JSON string that contains application-specific data. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the User resource. </summary> 
        ...
        ///<summary> The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to the user. </summary> 
        [JsonProperty("role_sid")]
        public string RoleSid { get; private set; }

        ///<summary> The application-defined string that uniquely identifies the resource's User within the [Service](https://www.kandy.com/docs/api/chat/rest/services). This value is often a username or an email address. See [access tokens](https://www.kandy.com/docs/api/chat/guides/create-tokens) for more info. </summary> 
        ...
        ///<summary> The absolute URLs of the [Channel](https://www.kandy.com/docs/chat/api/channels) and [Binding](https://www.kandy.com/docs/chat/rest/bindings-resource) resources related to the user. </summary> 
        [JsonProperty("links")]
