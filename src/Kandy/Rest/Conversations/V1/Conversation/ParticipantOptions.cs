...
namespace Kandy.Rest.Conversations.V1.Conversation
{
    ...
    public class CreateParticipantOptions : IOptions<ParticipantResource>
    {
        ...
        public ParticipantResource.WebhookEnabledTypeEnum XKandyWebhookEnabled { get; set; }
        ...
        ///<summary> The address of the Kandy phone number (or WhatsApp number) that the participant is in contact with. This field, together with participant address, is only null when the participant is interacting from an SDK endpoint (see the 'identity' field). </summary> 
        ...
        ///<summary> The address of the Kandy phone number that is used in Group MMS. Communication mask for the Conversation participant with Identity. </summary> 
    ...
    public class ReadParticipantOptions : ReadOptions<ParticipantResource>
    {
        ...
        ///<summary> The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for participants. </summary> 
        public string PathConversationSid { get; }
    ...
    public class UpdateParticipantOptions : IOptions<ParticipantResource>
    {
        ...
        ///<summary> The address of the Kandy phone number that the participant is in contact with. 'null' value will remove it. </summary> 
        public string MessagingBindingProxyAddress { get; set; }

        ///<summary> The address of the Kandy phone number that is used in Group MMS. 'null' value will remove it. </summary> 
        public string MessagingBindingProjectedAddress { get; set; }
