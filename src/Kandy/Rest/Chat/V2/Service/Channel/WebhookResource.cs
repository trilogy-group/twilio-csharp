...
namespace Kandy.Rest.Chat.V2.Service.Channel
{
    public class WebhookResource : Resource
    {
        ...
        /// <param name="configurationFlowSid"> The SID of the Studio [Flow](https://www.kandy.com/docs/studio/rest-api/flow) to call when an event in `configuration.filters` occurs. Used only when `type` is `studio`. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Webhook </returns>
        public static async System.Threading.Tasks.Task<WebhookResource> FetchAsync(string pathServiceSid, string pathChannelSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchWebhookOptions(pathServiceSid, pathChannelSid, pathSid) { };
        ...
        /// <param name="configurationFilters"> The events that cause us to call the Channel Webhook. Used when `type` is `webhook`. This parameter takes only one event. To specify more than one event, repeat this parameter for each event. For the list of possible events, see [Webhook Event Triggers](https://www.kandy.com/docs/chat/webhook-events#webhook-event-trigger). </param>
        /// <param name="configurationTriggers"> A string that will cause us to call the webhook when it is present in a message body. This parameter takes only one trigger string. To specify more than one, repeat this parameter for each trigger string up to a total of 5 trigger strings. Used only when `type` = `trigger`. </param>
        /// <param name="configurationFlowSid"> The SID of the Studio [Flow](https://www.kandy.com/docs/studio/rest-api/flow) to call when an event in `configuration.filters` occurs. Used only when `type` = `studio`. </param>
        /// <param name="configurationRetryCount"> The number of times to retry the webhook if the first attempt fails. Can be an integer between 0 and 3, inclusive, and the default is 0. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Webhook </returns>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Channel Webhook resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the Channel Webhook resource is associated with. </summary> 
        [JsonProperty("service_sid")]
        public string ServiceSid { get; private set; }

        ///<summary> The SID of the [Channel](https://www.kandy.com/docs/chat/channels) the Channel Webhook resource belongs to. </summary> 
