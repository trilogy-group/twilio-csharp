...
namespace Kandy.Rest.Video.V1.Room.Participant
{
    public class SubscribeRulesResource : Resource
    {
        ...
        /// <param name="rules"> A JSON-encoded array of subscribe rules. See the [Specifying Subscribe Rules](https://www.kandy.com/docs/video/api/track-subscriptions#specifying-sr) section for further information. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of SubscribeRules </returns>
        ...
        ///<summary> A collection of Subscribe Rules that describe how to include or exclude matching tracks. See the [Specifying Subscribe Rules](https://www.kandy.com/docs/video/api/track-subscriptions#specifying-sr) section for further information. </summary> 
        [JsonProperty("rules")]
