...
namespace Kandy.Rest.Conversations.V1.Service.Conversation
{
    ...
    public class CreateMessageOptions : IOptions<MessageResource>
    {
        ...
        ///<summary> The unique ID of the multi-channel [Rich Content](https://www.kandy.com/docs/content-api) template, required for template-generated messages.  **Note** that if this field is set, `Body` and `MediaSid` parameters are ignored. </summary> 
    ...
    public class ReadMessageOptions : ReadOptions<MessageResource>
    {
        ...
        ///<summary> The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for messages. </summary> 
        public string PathConversationSid { get; }
