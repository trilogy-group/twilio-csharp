...
namespace Kandy.Rest.Messaging.V1.Service
{
    public class AlphaSenderResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateAlphaSenderOptions options, IKandyRestClient client)
        {
        ...
        public static AlphaSenderResource Create(CreateAlphaSenderOptions options, IKandyRestClient client = null)
        {
        ...
        /// <summary> create </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to create the resource under. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of AlphaSender </returns>
        private static Request BuildDeleteRequest(DeleteAlphaSenderOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of AlphaSender </returns>
        public static bool Delete(DeleteAlphaSenderOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        private static Request BuildFetchRequest(FetchAlphaSenderOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of AlphaSender </returns>
        public static AlphaSenderResource Fetch(FetchAlphaSenderOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
...
#endif
        /// <summary> fetch </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to fetch the resource from. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of AlphaSender </returns>
        public static async System.Threading.Tasks.Task<AlphaSenderResource> FetchAsync(string pathServiceSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchAlphaSenderOptions(pathServiceSid, pathSid) { };
        ...
        private static Request BuildReadRequest(ReadAlphaSenderOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of AlphaSender </returns>
        public static ResourceSet<AlphaSenderResource> Read(ReadAlphaSenderOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
...
#endif
        /// <summary> read </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to read the resources from. </param>
        ...
        public static Page<AlphaSenderResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<AlphaSenderResource> NextPage(Page<AlphaSenderResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<AlphaSenderResource> PreviousPage(Page<AlphaSenderResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the AlphaSender resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the resource is associated with. </summary> 
