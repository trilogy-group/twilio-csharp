...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    public class UserDefinedMessageSubscriptionResource : Resource
    {
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that subscribed to the User Defined Messages. </param>
        ...
        /// <param name="method"> The HTTP method Kandy will use when requesting the above `Url`. Either `GET` or `POST`. Default is `POST`. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of UserDefinedMessageSubscription </returns>
