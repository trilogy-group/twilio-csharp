...
namespace Kandy.Rest.Numbers.V2.RegulatoryCompliance
{
    public class BundleResource : Resource
    {
...
#endif
        /// <summary> Retrieve a list of all Bundles for an account. </summary>
        /// <param name="status"> The verification status of the Bundle resource. Please refer to [Bundle Statuses](https://www.kandy.com/docs/phone-numbers/regulatory/api/bundles#bundle-statuses) for more details. </param>
        ...
        /// <param name="regulationSid"> The unique string of a [Regulation resource](https://www.kandy.com/docs/phone-numbers/regulatory/api/regulations) that is associated to the Bundle resource. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Bundle resource. </summary> 
