...
namespace Kandy.Rest.Notify.V1.Service
{
    public class BindingResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateBindingOptions options, IKandyRestClient client)
        {
        ...
        public static BindingResource Create(CreateBindingOptions options, IKandyRestClient client = null)
        {
        ...
        /// <summary> create </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/notify/api/service-resource) to create the resource under. </param>
        /// <param name="identity"> The `identity` value that uniquely identifies the new resource's [User](https://www.kandy.com/docs/chat/rest/user-resource) within the [Service](https://www.kandy.com/docs/notify/api/service-resource). Up to 20 Bindings can be created for the same Identity in a given Service. </param>
        ...
        /// <param name="credentialSid"> The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) resource to be used to send notifications to this Binding. If present, this overrides the Credential specified in the Service resource. Applies to only `apn`, `fcm`, and `gcm` type Bindings. </param>
        ...
        /// <summary> delete </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/notify/api/service-resource) to delete the resource from. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Binding resource to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Binding </returns>
...
#endif
        /// <summary> fetch </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/notify/api/service-resource) to fetch the resource from. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Binding resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Binding </returns>
...
#endif
        /// <summary> read </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/notify/api/service-resource) to read the resource from. </param>
        ...
        /// <param name="identity"> The [User](https://www.kandy.com/docs/chat/rest/user-resource)'s `identity` value of the resources to read. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Binding resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Service](https://www.kandy.com/docs/notify/api/service-resource) the resource is associated with. </summary> 
        [JsonProperty("service_sid")]
        public string ServiceSid { get; private set; }

        ///<summary> The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) resource to be used to send notifications to this Binding. If present, this overrides the Credential specified in the Service resource. Applicable only to `apn`, `fcm`, and `gcm` type Bindings. </summary> 
        ...
        ///<summary> The `identity` value that uniquely identifies the resource's [User](https://www.kandy.com/docs/chat/rest/user-resource) within the [Service](https://www.kandy.com/docs/notify/api/service-resource). Up to 20 Bindings can be created for the same Identity in a given Service. </summary> 
