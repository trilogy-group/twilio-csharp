...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    ...
    public class CreateRecordingOptions : IOptions<RecordingResource>
    {
        ...
        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) to associate the resource with. </summary> 
        public string PathCallSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that will create the resource. </summary> 
        ...
        ///<summary> The URL we should call using the `recording_status_callback_method` on each recording event specified in  `recording_status_callback_event`. For more information, see [RecordingStatusCallback parameters](https://www.kandy.com/docs/voice/api/recording#recordingstatuscallback). </summary> 
        ...
        ///<summary> The audio track to record for the call. Can be: `inbound`, `outbound` or `both`. The default is `both`. `inbound` records the audio that is received by Kandy. `outbound` records the audio that is generated from Kandy. `both` records the audio that is received and generated by Kandy. </summary> 
        public string RecordingTrack { get; set; }


        /// <summary> Construct a new CreateCallRecordingOptions </summary>
        /// <param name="pathCallSid"> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) to associate the resource with. </param>
    ...
    public class DeleteRecordingOptions : IOptions<RecordingResource>
    {
        ...
        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resources to delete. </summary> 
        public string PathCallSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the Recording resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording resources to delete. </summary> 
        public string PathAccountSid { get; set; }



        /// <summary> Construct a new DeleteCallRecordingOptions </summary>
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resources to delete. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Recording resource to delete. </param>
    ...
    public class FetchRecordingOptions : IOptions<RecordingResource>
    {
        ...
        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resource to fetch. </summary> 
        public string PathCallSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the Recording resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording resource to fetch. </summary> 
        public string PathAccountSid { get; set; }



        /// <summary> Construct a new FetchCallRecordingOptions </summary>
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resource to fetch. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Recording resource to fetch. </param>
    ...
    public class ReadRecordingOptions : ReadOptions<RecordingResource>
    {
        ...
        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resources to read. </summary> 
        public string PathCallSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording resources to read. </summary> 
        public string PathAccountSid { get; set; }
        ...
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resources to read. </param>
    ...
    /// <summary> Changes the status of the recording to paused, stopped, or in-progress. Note: Pass `Kandy.CURRENT` instead of recording sid to reference current active recording. </summary>
    public class UpdateRecordingOptions : IOptions<RecordingResource>
    {

        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resource to update. </summary> 
        public string PathCallSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the Recording resource to update. </summary> 
        public string PathSid { get; }


        public RecordingResource.StatusEnum Status { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording resource to update. </summary> 
        public string PathAccountSid { get; set; }
        ...
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resource to update. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Recording resource to update. </param>
