...
namespace Kandy.Rest.Conversations.V1
{
    public class UserResource : Resource
    {
        ...
        public static UserResource Create(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new CreateUserOptions(identity) { FriendlyName = friendlyName, Attributes = attributes, RoleSid = roleSid, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of User </returns>
        public static bool Delete(string pathSid, UserResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteUserOptions(pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of User </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathSid, UserResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteUserOptions(pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        public static UserResource Update(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new UpdateUserOptions(pathSid) { FriendlyName = friendlyName, Attributes = attributes, RoleSid = roleSid, XKandyWebhookEnabled = xKandyWebhookEnabled };
