...
namespace Kandy.Rest.Api.V2010.Account.Conference
{
    ...
    public class DeleteRecordingOptions : IOptions<RecordingResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Conference Recording resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference Recording resources to delete. </summary> 
    ...
    public class FetchRecordingOptions : IOptions<RecordingResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Conference Recording resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference Recording resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class ReadRecordingOptions : ReadOptions<RecordingResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference Recording resources to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateRecordingOptions : IOptions<RecordingResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Conference Recording resource to update. Use `Kandy.CURRENT` to reference the current active recording. </summary> 
        public string PathSid { get; }


        public RecordingResource.StatusEnum Status { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference Recording resource to update. </summary> 
        public string PathAccountSid { get; set; }
