...
namespace Kandy.Rest.Conversations.V1.Service
{
    public class ParticipantConversationResource : Resource
    {
...
#endif
        /// <summary> Retrieve a list of all Conversations that this Participant belongs to by identity or by address. Only one parameter should be specified. </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Participant Conversations resource is associated with. </param>
        ...
        ///<summary> The unique ID of the [Participant](https://www.kandy.com/docs/conversations/api/conversation-participant-resource). </summary> 
        [JsonProperty("participant_sid")]
        public string ParticipantSid { get; private set; }

        ///<summary> The unique string that identifies the conversation participant as [Conversation User](https://www.kandy.com/docs/conversations/api/user-resource). </summary> 
        ...
        ///<summary> The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) this Participant belongs to. </summary> 
