...
namespace Kandy.Rest.Api.V2010.Account.Usage.Record
{
    public class MonthlyResource : Resource
    {
        ...
        private static Request BuildReadRequest(ReadMonthlyOptions options, IKandyRestClient client)
        {
        ...
        public static ResourceSet<MonthlyResource> Read(ReadMonthlyOptions options, IKandyRestClient client = null)
        {
        ...
        public static Page<MonthlyResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<MonthlyResource> NextPage(Page<MonthlyResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<MonthlyResource> PreviousPage(Page<MonthlyResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
