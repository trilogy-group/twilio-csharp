...
namespace Kandy.Rest.Api.V2010.Account.Queue
{
    ...
    public class FetchMemberOptions : IOptions<MemberResource>
    {
        ...
        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resource(s) to fetch. </summary> 
        public string PathCallSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Member resource(s) to fetch. </summary> 
        ...
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resource(s) to fetch. </param>
    ...
    public class ReadMemberOptions : ReadOptions<MemberResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Member resource(s) to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateMemberOptions : IOptions<MemberResource>
    {
        ...
        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resource(s) to update. </summary> 
        public string PathCallSid { get; }

        ///<summary> The absolute URL of the Queue resource. </summary> 
        public Uri Url { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Member resource(s) to update. </summary> 
        public string PathAccountSid { get; set; }
        ...
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the resource(s) to update. </param>
