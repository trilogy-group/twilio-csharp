...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    ...
    public class CreateUserDefinedMessageSubscriptionOptions : IOptions<UserDefinedMessageSubscriptionResource>
    {
        ...
        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the User Defined Messages subscription is associated with. This refers to the Call SID that is producing the user defined messages. </summary> 
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that subscribed to the User Defined Messages. </summary> 
        ...
        ///<summary> The HTTP method Kandy will use when requesting the above `Url`. Either `GET` or `POST`. Default is `POST`. </summary> 
        public Kandy.Http.HttpMethod Method { get; set; }


        /// <summary> Construct a new CreateUserDefinedMessageSubscriptionOptions </summary>
        /// <param name="pathCallSid"> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the User Defined Messages subscription is associated with. This refers to the Call SID that is producing the user defined messages. </param>
    ...
    public class DeleteUserDefinedMessageSubscriptionOptions : IOptions<UserDefinedMessageSubscriptionResource>
    {
        ...
        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the User Defined Message Subscription is associated with. This refers to the Call SID that is producing the User Defined Messages. </summary> 
        public string PathCallSid { get; }
        ...
        /// <param name="pathCallSid"> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the User Defined Message Subscription is associated with. This refers to the Call SID that is producing the User Defined Messages. </param>
