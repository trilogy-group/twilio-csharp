...
namespace Kandy.Rest.Events.V1
{
    public class SinkResource : Resource
    {
        ...
        /// <param name="sinkConfiguration"> The information required for Kandy to connect to the provided Sink encoded as JSON. </param>
        ...
        ///<summary> The information required for Kandy to connect to the provided Sink encoded as JSON. </summary> 
