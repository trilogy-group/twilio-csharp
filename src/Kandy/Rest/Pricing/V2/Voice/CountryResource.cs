...
namespace Kandy.Rest.Pricing.V2.Voice
{
    public class CountryResource : Resource
    {
        ...
        ///<summary> The list of [OutboundPrefixPriceWithOrigin](https://www.kandy.com/docs/voice/pricing#outbound-prefix-price-with-origin) records. </summary> 
        [JsonProperty("outbound_prefix_prices")]
        public List<OutboundPrefixPriceWithOrigin> OutboundPrefixPrices { get; private set; }

        ///<summary> The list of [InboundCallPrice](https://www.kandy.com/docs/voice/pricing#inbound-call-price) records. </summary> 
