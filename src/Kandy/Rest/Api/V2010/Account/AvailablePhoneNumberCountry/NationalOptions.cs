...
namespace Kandy.Rest.Api.V2010.Account.AvailablePhoneNumberCountry
{
    ...
    public class ReadNationalOptions : ReadOptions<NationalResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) requesting the AvailablePhoneNumber resources. </summary> 
        ...
        ///<summary> The pattern on which to match phone numbers. Valid characters are `*`, `0-9`, `a-z`, and `A-Z`. The `*` character matches any single digit. For examples, see [Example 2](https://www.kandy.com/docs/phone-numbers/api/availablephonenumber-resource#local-get-basic-example-2) and [Example 3](https://www.kandy.com/docs/phone-numbers/api/availablephonenumber-resource#local-get-basic-example-3). If specified, this value must have at least two characters. </summary> 
        ...
        ///<summary> Whether to exclude phone numbers that require an [Address](https://www.kandy.com/docs/usage/api/address). Can be: `true` or `false` and the default is `false`. </summary> 
        public bool? ExcludeAllAddressRequired { get; set; }

        ///<summary> Whether to exclude phone numbers that require a local [Address](https://www.kandy.com/docs/usage/api/address). Can be: `true` or `false` and the default is `false`. </summary> 
        public bool? ExcludeLocalAddressRequired { get; set; }

        ///<summary> Whether to exclude phone numbers that require a foreign [Address](https://www.kandy.com/docs/usage/api/address). Can be: `true` or `false` and the default is `false`. </summary> 
        public bool? ExcludeForeignAddressRequired { get; set; }

        ///<summary> Whether to read phone numbers that are new to the Kandy platform. Can be: `true` or `false` and the default is `true`. </summary> 
