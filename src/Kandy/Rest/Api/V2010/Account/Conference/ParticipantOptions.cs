...
namespace Kandy.Rest.Api.V2010.Account.Conference
{
    ...
    public class CreateParticipantOptions : IOptions<ParticipantResource>
    {
        ...
        ///<summary> Jitter buffer size for the connecting participant. Kandy will use this setting to apply Jitter Buffer before participant's audio is mixed into the conference. Can be: `off`, `small`, `medium`, and `large`. Default to `large`. </summary> 
        ...
        ///<summary> The audio track to record for the call. Can be: `inbound`, `outbound` or `both`. The default is `both`. `inbound` records the audio that is received by Kandy. `outbound` records the audio that is sent from Kandy. `both` records the audio that is received and sent by Kandy. </summary> 
    ...
    public class DeleteParticipantOptions : IOptions<ParticipantResource>
    {
        ...
        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID or label of the participant to delete. Non URL safe characters in a label must be percent encoded, for example, a space character is represented as %20. </summary> 
        public string PathCallSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Participant resources to delete. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class FetchParticipantOptions : IOptions<ParticipantResource>
    {
        ...
        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID or label of the participant to fetch. Non URL safe characters in a label must be percent encoded, for example, a space character is represented as %20. </summary> 
        public string PathCallSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Participant resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class ReadParticipantOptions : ReadOptions<ParticipantResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Participant resources to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateParticipantOptions : IOptions<ParticipantResource>
    {
        ...
        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID or label of the participant to update. Non URL safe characters in a label must be percent encoded, for example, a space character is represented as %20. </summary> 
        public string PathCallSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Participant resources to update. </summary> 
        public string PathAccountSid { get; set; }
        ...
        public Kandy.Http.HttpMethod HoldMethod { get; set; }
        ...
        public Kandy.Http.HttpMethod AnnounceMethod { get; set; }

        ///<summary> The URL we call using the `wait_method` for the music to play while participants are waiting for the conference to start. The URL may return an MP3 file, a WAV file, or a TwiML document that contains `<Play>`, `<Say>`, `<Pause>`, or `<Redirect>` verbs. The default value is the URL of our standard hold music. [Learn more about hold music](https://www.kandy.com/labs/twimlets/holdmusic). </summary> 
        public Uri WaitUrl { get; set; }
