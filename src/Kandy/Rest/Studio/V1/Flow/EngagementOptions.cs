...
namespace Kandy.Rest.Studio.V1.Flow
{
    ...
    public class CreateEngagementOptions : IOptions<EngagementResource>
    {
        ...
        ///<summary> The Kandy phone number to send messages or initiate calls from during the Flow Engagement. Available as variable `{{flow.channel.address}}` </summary> 
        ...
        /// <param name="from"> The Kandy phone number to send messages or initiate calls from during the Flow Engagement. Available as variable `{{flow.channel.address}}` </param>
