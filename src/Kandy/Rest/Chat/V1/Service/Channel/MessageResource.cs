...
namespace Kandy.Rest.Chat.V1.Service.Channel
{
    public class MessageResource : Resource
    {
        ...
        /// <param name="from"> The [identity](https://www.kandy.com/docs/api/chat/guides/identity) of the new message's author. The default value is `system`. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the Message resource. </summary> 
        ...
        ///<summary> The SID of the [Channel](https://www.kandy.com/docs/chat/api/channels) that the message was sent to. </summary> 
        [JsonProperty("to")]
        public string To { get; private set; }

        ///<summary> The unique ID of the [Channel](https://www.kandy.com/docs/api/chat/rest/channels) the Message resource belongs to. </summary> 
        ...
        ///<summary> The [identity](https://www.kandy.com/docs/api/chat/guides/identity) of the message's author. The default value is `system`. </summary> 
        [JsonProperty("from")]
        ...
        ///<summary> The index of the message within the [Channel](https://www.kandy.com/docs/chat/api/channels). </summary> 
        [JsonProperty("index")]
