...
namespace Kandy.Rest.Messaging.V1.BrandRegistration
{
    public class BrandVettingResource : Resource
    {
        ...
        /// <param name="pathBrandVettingSid"> The Kandy SID of the third-party vetting record. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of BrandVetting </returns>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the vetting record. </summary> 
        ...
        ///<summary> The Kandy SID of the third-party vetting record. </summary> 
