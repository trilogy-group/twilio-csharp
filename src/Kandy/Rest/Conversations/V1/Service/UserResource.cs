...
namespace Kandy.Rest.Conversations.V1.Service
{
    public class UserResource : Resource
    {
        ...
        /// <summary> Add a new conversation user to your service </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the User resource is associated with. </param>
        /// <param name="identity"> The application-defined string that uniquely identifies the resource's User within the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource). This value is often a username or an email address, and is case-sensitive. </param>
        ...
        /// <param name="roleSid"> The SID of a service-level [Role](https://www.kandy.com/docs/conversations/api/role-resource) to assign to the user. </param>
        ...
        public static UserResource Create(
                                          ...
                                          string roleSid = null,
                                          UserResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null,
                                          IKandyRestClient client = null)
        {
            var options = new CreateUserOptions(pathChatServiceSid, identity) { FriendlyName = friendlyName, Attributes = attributes, RoleSid = roleSid, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <summary> Remove a conversation user from your service </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to delete the User resource from. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of User </returns>
        public static bool Delete(string pathChatServiceSid, string pathSid, UserResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteUserOptions(pathChatServiceSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of User </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathChatServiceSid, string pathSid, UserResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteUserOptions(pathChatServiceSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
...
#endif
        /// <summary> Fetch a conversation user from your service </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to fetch the User resource from. </param>
...
#endif
        /// <summary> Retrieve a list of all conversation users in your service </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to read the User resources from. </param>
        ...
        public static UserResource Update(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new UpdateUserOptions(pathChatServiceSid, pathSid) { FriendlyName = friendlyName, Attributes = attributes, RoleSid = roleSid, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the User resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the User resource is associated with. </summary> 
        [JsonProperty("chat_service_sid")]
        public string ChatServiceSid { get; private set; }

        ///<summary> The SID of a service-level [Role](https://www.kandy.com/docs/conversations/api/role-resource) assigned to the user. </summary> 
        [JsonProperty("role_sid")]
        public string RoleSid { get; private set; }

        ///<summary> The application-defined string that uniquely identifies the resource's User within the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource). This value is often a username or an email address, and is case-sensitive. </summary> 
