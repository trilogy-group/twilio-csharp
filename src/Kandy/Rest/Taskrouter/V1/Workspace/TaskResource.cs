...
namespace Kandy.Rest.Taskrouter.V1.Workspace
{
    public class TaskResource : Resource
    {
        ...
        /// <param name="attributes"> A URL-encoded JSON string with the attributes of the new task. This value is passed to the Workflow's `assignment_callback_url` when the Task is assigned to a Worker. For example: `{ \\\"task_type\\\": \\\"call\\\", \\\"kandy_call_sid\\\": \\\"CAxxx\\\", \\\"customer_ticket_number\\\": \\\"12345\\\" }`. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Task </returns>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Task </returns>
        public static async System.Threading.Tasks.Task<TaskResource> FetchAsync(string pathWorkspaceSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchTaskOptions(pathWorkspaceSid, pathSid) { };
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Task resource. </summary> 
        ...
        ///<summary> An object that contains the [addon](https://www.kandy.com/docs/taskrouter/marketplace) data for all installed addons. </summary> 
        [JsonProperty("addons")]
