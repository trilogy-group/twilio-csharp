...
namespace Kandy.Rest.Trunking.V1.Trunk
{
    public class PhoneNumberResource : Resource
    {
        ...
        /// <param name="phoneNumberSid"> The SID of the [Incoming Phone Number](https://www.kandy.com/docs/phone-numbers/api/incomingphonenumber-resource) that you want to associate with the trunk. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of PhoneNumber </returns>
