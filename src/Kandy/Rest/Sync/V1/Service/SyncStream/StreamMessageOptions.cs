...
namespace Kandy.Rest.Sync.V1.Service.SyncStream
{
    ...
    public class CreateStreamMessageOptions : IOptions<StreamMessageResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the new Stream Message in. </summary> 
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the new Stream Message in. </param>
