...
namespace Kandy.Rest.Conversations.V1.Conversation
{
    public class ParticipantResource : Resource
    {
        ...
        /// <param name="identity"> A unique string identifier for the conversation participant as [Conversation User](https://www.kandy.com/docs/conversations/api/user-resource). This parameter is non-null if (and only if) the participant is using the Conversations SDK to communicate. Limited to 256 characters. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Participant </returns>
        public static bool Delete(string pathConversationSid, string pathSid, ParticipantResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteParticipantOptions(pathConversationSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Participant </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathConversationSid, string pathSid, ParticipantResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteParticipantOptions(pathConversationSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Participant </returns>
        public static async System.Threading.Tasks.Task<ParticipantResource> FetchAsync(string pathConversationSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchParticipantOptions(pathConversationSid, pathSid) { };
        ...
        ///<summary> A unique string identifier for the conversation participant as [Conversation User](https://www.kandy.com/docs/conversations/api/user-resource). This parameter is non-null if (and only if) the participant is using the Conversations SDK to communicate. Limited to 256 characters. </summary> 
