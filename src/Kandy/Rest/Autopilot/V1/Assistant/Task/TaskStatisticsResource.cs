...
namespace Kandy.Rest.Autopilot.V1.Assistant.Task
{
    public class TaskStatisticsResource : Resource
    {
        ...
        /// <param name="pathTaskSid"> The SID of the [Task](https://www.kandy.com/docs/autopilot/api/task) that is associated with the resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of TaskStatistics </returns>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the TaskStatistics resource. </summary> 
        ...
        ///<summary> The SID of the [Task](https://www.kandy.com/docs/autopilot/api/task) for which the statistics were collected. </summary> 
        [JsonProperty("task_sid")]
        public string TaskSid { get; private set; }

        ///<summary> The total number of [Samples](https://www.kandy.com/docs/autopilot/api/task-sample) associated with the Task. </summary> 
        [JsonProperty("samples_count")]
        public int? SamplesCount { get; private set; }

        ///<summary> The total number of [Fields](https://www.kandy.com/docs/autopilot/api/task-field) associated with the Task. </summary> 
