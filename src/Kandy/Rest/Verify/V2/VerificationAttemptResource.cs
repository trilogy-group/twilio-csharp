...
namespace Kandy.Rest.Verify.V2
{
    public class VerificationAttemptResource : Resource
    {
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/verify/api/service) used to generate the attempt. </summary> 
        [JsonProperty("service_sid")]
        public string ServiceSid { get; private set; }

        ///<summary> The SID of the [Verification](https://www.kandy.com/docs/verify/api/verification) that generated the attempt. </summary> 
