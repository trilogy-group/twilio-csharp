...
namespace Kandy.Rest.Trunking.V1.Trunk
{
    ...
    public class CreateCredentialListOptions : IOptions<CredentialListResource>
    {
        ...
        ///<summary> The SID of the [Credential List](https://www.kandy.com/docs/voice/sip/api/sip-credentiallist-resource) that you want to associate with the trunk. Once associated, we will authenticate access to the trunk against this list. </summary> 
