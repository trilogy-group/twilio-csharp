...
namespace Kandy.Rest.Sync.V1.Service.SyncMap
{
    ...
    public class CreateSyncMapItemOptions : IOptions<SyncMapItemResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the Map Item in. </summary> 
        ...
        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Map Item expires (time-to-live) and is deleted. </summary> 
        public int? ItemTtl { get; set; }

        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Map Item's parent Sync Map expires (time-to-live) and is deleted. </summary> 
        public int? CollectionTtl { get; set; }


        /// <summary> Construct a new CreateSyncMapItemOptions </summary>
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the Map Item in. </param>
    ...
    public class DeleteSyncMapItemOptions : IOptions<SyncMapItemResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map Item resource to delete. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map Item resource to delete. </param>
    ...
    public class FetchSyncMapItemOptions : IOptions<SyncMapItemResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map Item resource to fetch. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map Item resource to fetch. </param>
    ...
    public class ReadSyncMapItemOptions : ReadOptions<SyncMapItemResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Map Item resources to read. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Map Item resources to read. </param>
        /// <param name="pathMapSid"> The SID of the Sync Map with the Sync Map Item resource to fetch. Can be the Sync Map resource's `sid` or its `unique_name`. </param>
    ...
    public class UpdateSyncMapItemOptions : IOptions<SyncMapItemResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map Item resource to update. </summary> 
        public string PathServiceSid { get; }
        ...
        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Map Item's parent Sync Map expires (time-to-live) and is deleted. This parameter can only be used when the Map Item's `data` or `ttl` is updated in the same request. </summary> 
        public int? CollectionTtl { get; set; }



        /// <summary> Construct a new UpdateSyncMapItemOptions </summary>
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Map Item resource to update. </param>
