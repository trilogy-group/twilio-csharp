...
namespace Kandy.Rest.Taskrouter.V1.Workspace
{
    ...
    public class CreateTaskOptions : IOptions<TaskResource>
    {
        ...
        ///<summary> A URL-encoded JSON string with the attributes of the new task. This value is passed to the Workflow's `assignment_callback_url` when the Task is assigned to a Worker. For example: `{ \\\"task_type\\\": \\\"call\\\", \\\"kandy_call_sid\\\": \\\"CAxxx\\\", \\\"customer_ticket_number\\\": \\\"12345\\\" }`. </summary> 
