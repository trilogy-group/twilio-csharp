...
namespace Kandy.Rest.Api.V2010.Account.IncomingPhoneNumber
{
    ...
    public class DeleteAssignedAddOnOptions : IOptions<AssignedAddOnResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the resources to delete. </summary> 
        public string PathAccountSid { get; set; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the resource to delete. </param>
    ...
    public class FetchAssignedAddOnOptions : IOptions<AssignedAddOnResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
