...
namespace Kandy.Rest.Monitor.V1
{
    ...
    public class ReadEventOptions : ReadOptions<EventResource>
    {
        ...
        ///<summary> Only include events of this [Event Type](https://www.kandy.com/docs/usage/monitor-events#event-types). </summary> 
        ...
        ///<summary> Only include events that originated from this IP address. Useful for tracking suspicious activity originating from the API or the Kandy Console. </summary> 
