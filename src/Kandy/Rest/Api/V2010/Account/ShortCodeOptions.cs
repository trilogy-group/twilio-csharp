...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class FetchShortCodeOptions : IOptions<ShortCodeResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ShortCode resource(s) to fetch. </summary> 
    ...
    public class ReadShortCodeOptions : ReadOptions<ShortCodeResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ShortCode resource(s) to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateShortCodeOptions : IOptions<ShortCodeResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ShortCode resource(s) to update. </summary> 
        public string PathAccountSid { get; set; }
