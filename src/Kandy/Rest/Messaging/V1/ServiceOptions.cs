...
namespace Kandy.Rest.Messaging.V1
{
    ...
    public class CreateServiceOptions : IOptions<ServiceResource>
    {
        ...
        public Kandy.Http.HttpMethod InboundMethod { get; set; }
        ...
        ///<summary> The URL we should call to [pass status updates](https://www.kandy.com/docs/sms/api/message-resource#message-status-values) about message delivery. </summary> 
