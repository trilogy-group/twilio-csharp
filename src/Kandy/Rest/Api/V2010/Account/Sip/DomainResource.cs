...
namespace Kandy.Rest.Api.V2010.Account.Sip
{
    public class DomainResource : Resource
    {
        ...
        public static DomainResource Create(
                                          ...
                                          Kandy.Http.HttpMethod voiceStatusCallbackMethod = null,
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SipDomain resources to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Domain </returns>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SipDomain resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Domain </returns>
...
#endif
        /// <summary> Retrieve a list of domains belonging to the account used to make the request </summary>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SipDomain resources to read. </param>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SipDomain resource to update. </param>
        /// <param name="friendlyName"> A descriptive string that you created to describe the resource. It can be up to 64 characters long. </param>
        /// <param name="voiceFallbackMethod"> The HTTP method we should use to call `voice_fallback_url`. Can be: `GET` or `POST`. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SipDomain resource. </summary> 
        ...
        public Kandy.Http.HttpMethod VoiceStatusCallbackMethod { get; private set; }
