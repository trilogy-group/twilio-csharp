...
namespace Kandy.Rest.Api.V2010.Account
{
    public class NotificationResource : Resource
    {
...
#endif
        /// <summary> Fetch a notification belonging to the account used to make the request </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Notification resource to fetch. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Notification resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Notification </returns>
...
#endif
        /// <summary> Retrieve a list of notifications belonging to the account used to make the request </summary>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Notification resources to read. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Notification resource. </summary> 
        ...
        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Notification resource is associated with. </summary> 
