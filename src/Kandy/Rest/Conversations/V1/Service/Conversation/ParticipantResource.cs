...
namespace Kandy.Rest.Conversations.V1.Service.Conversation
{
    public class ParticipantResource : Resource
    {
        ...
        /// <param name="pathConversationSid"> The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for this participant. </param>
        /// <param name="identity"> A unique string identifier for the conversation participant as [Conversation User](https://www.kandy.com/docs/conversations/api/user-resource). This parameter is non-null if (and only if) the participant is using the Conversation SDK to communicate. Limited to 256 characters. </param>
        ...
        /// <param name="messagingBindingProxyAddress"> The address of the Kandy phone number (or WhatsApp number) that the participant is in contact with. This field, together with participant address, is only null when the participant is interacting from an SDK endpoint (see the 'identity' field). </param>
        ...
        /// <param name="messagingBindingProjectedAddress"> The address of the Kandy phone number that is used in Group MMS. Communication mask for the Conversation participant with Identity. </param>
        /// <param name="roleSid"> The SID of a conversation-level [Role](https://www.kandy.com/docs/conversations/api/role-resource) to assign to the participant. </param>
        ...
        public static ParticipantResource Create(
                                          ...
                                          string roleSid = null,
                                          ParticipantResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null,
                                          IKandyRestClient client = null)
        {
            var options = new CreateParticipantOptions(pathChatServiceSid, pathConversationSid) { Identity = identity, MessagingBindingAddress = messagingBindingAddress, MessagingBindingProxyAddress = messagingBindingProxyAddress, DateCreated = dateCreated, DateUpdated = dateUpdated, Attributes = attributes, MessagingBindingProjectedAddress = messagingBindingProjectedAddress, RoleSid = roleSid, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Participant </returns>
        public static bool Delete(string pathChatServiceSid, string pathConversationSid, string pathSid, ParticipantResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteParticipantOptions(pathChatServiceSid, pathConversationSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Participant </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathChatServiceSid, string pathConversationSid, string pathSid, ParticipantResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteParticipantOptions(pathChatServiceSid, pathConversationSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Participant </returns>
        public static async System.Threading.Tasks.Task<ParticipantResource> FetchAsync(string pathChatServiceSid, string pathConversationSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchParticipantOptions(pathChatServiceSid, pathConversationSid, pathSid) { };
        ...
        /// <summary> Retrieve a list of all participants of the conversation </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Participant resource is associated with. </param>
        /// <param name="pathConversationSid"> The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for participants. </param>
        ...
        /// <param name="attributes"> An optional string metadata field you can use to store any data you wish. The string value must contain structurally valid JSON if specified.  **Note** that if the attributes are not set \\\"{}\\\" will be returned. </param>
        /// <param name="roleSid"> The SID of a conversation-level [Role](https://www.kandy.com/docs/conversations/api/role-resource) to assign to the participant. </param>
        /// <param name="messagingBindingProxyAddress"> The address of the Kandy phone number that the participant is in contact with. 'null' value will remove it. </param>
        /// <param name="messagingBindingProjectedAddress"> The address of the Kandy phone number that is used in Group MMS. 'null' value will remove it. </param>
        /// <param name="lastReadMessageIndex"> Index of last “read” message in the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for the Participant. </param>
        /// <param name="lastReadTimestamp"> Timestamp of last “read” message in the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for the Participant. </param>
        /// <param name="xKandyWebhookEnabled"> The X-Kandy-Webhook-Enabled HTTP request header </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Participant </returns>
        public static ParticipantResource Update(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new UpdateParticipantOptions(pathChatServiceSid, pathConversationSid, pathSid) { DateCreated = dateCreated, DateUpdated = dateUpdated, Identity = identity, Attributes = attributes, RoleSid = roleSid, MessagingBindingProxyAddress = messagingBindingProxyAddress, MessagingBindingProjectedAddress = messagingBindingProjectedAddress, LastReadMessageIndex = lastReadMessageIndex, LastReadTimestamp = lastReadTimestamp, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        ///<summary> The unique ID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this participant. </summary> 
        ...
        ///<summary> The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for this participant. </summary> 
        ...
        ///<summary> A unique string identifier for the conversation participant as [Conversation User](https://www.kandy.com/docs/conversations/api/user-resource). This parameter is non-null if (and only if) the participant is using the Conversation SDK to communicate. Limited to 256 characters. </summary> 
        ...
        ///<summary> The SID of a conversation-level [Role](https://www.kandy.com/docs/conversations/api/role-resource) to assign to the participant. </summary> 
        ...
        ///<summary> Index of last “read” message in the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for the Participant. </summary> 
        [JsonProperty("last_read_message_index")]
        public int? LastReadMessageIndex { get; private set; }

        ///<summary> Timestamp of last “read” message in the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for the Participant. </summary> 
