...
namespace Kandy.Rest.Sync.V1.Service.SyncList
{
    ...
    public class CreateSyncListItemOptions : IOptions<SyncListItemResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the new List Item in. </summary> 
        ...
        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the List Item expires (time-to-live) and is deleted. </summary> 
        public int? ItemTtl { get; set; }

        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the List Item's parent Sync List expires (time-to-live) and is deleted. </summary> 
    ...
    public class DeleteSyncListItemOptions : IOptions<SyncListItemResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Item resource to delete. </summary> 
        public string PathServiceSid { get; }
    ...
    public class FetchSyncListItemOptions : IOptions<SyncListItemResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Item resource to fetch. </summary> 
        public string PathServiceSid { get; }
    ...
    public class ReadSyncListItemOptions : ReadOptions<SyncListItemResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the List Item resources to read. </summary> 
        public string PathServiceSid { get; }
    ...
    public class UpdateSyncListItemOptions : IOptions<SyncListItemResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Item resource to update. </summary> 
        public string PathServiceSid { get; }
        ...
        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the List Item's parent Sync List expires (time-to-live) and is deleted. This parameter can only be used when the List Item's `data` or `ttl` is updated in the same request. </summary> 
        public int? CollectionTtl { get; set; }
