...
namespace Kandy.Rest.Api.V2010.Account.Usage.Record
{
    public class TodayResource : Resource
    {
        ...
        private static Request BuildReadRequest(ReadTodayOptions options, IKandyRestClient client)
        {
        ...
        public static ResourceSet<TodayResource> Read(ReadTodayOptions options, IKandyRestClient client = null)
        {
        ...
        public static Page<TodayResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<TodayResource> NextPage(Page<TodayResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<TodayResource> PreviousPage(Page<TodayResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
