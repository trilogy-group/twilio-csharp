...
namespace Kandy.Rest.Sync.V1.Service
{
    ...
    public class CreateSyncListOptions : IOptions<SyncListResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the new Sync List in. </summary> 
        ...
        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Sync List expires (time-to-live) and is deleted. </summary> 
        public int? CollectionTtl { get; set; }


        /// <summary> Construct a new CreateSyncListOptions </summary>
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the new Sync List in. </param>
    ...
    public class DeleteSyncListOptions : IOptions<SyncListResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List resource to delete. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List resource to delete. </param>
    ...
    public class FetchSyncListOptions : IOptions<SyncListResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List resource to fetch. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List resource to fetch. </param>
    ...
    public class ReadSyncListOptions : ReadOptions<SyncListResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List resources to read. </summary> 
        public string PathServiceSid { get; }



        /// <summary> Construct a new ListSyncListOptions </summary>
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List resources to read. </param>
    ...
    public class UpdateSyncListOptions : IOptions<SyncListResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List resource to update. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List resource to update. </param>
