...
namespace Kandy.Rest.Api.V2010.Account.Usage.Record
{
    public class LastMonthResource : Resource
    {
        ...
        private static Request BuildReadRequest(ReadLastMonthOptions options, IKandyRestClient client)
        {
        ...
        public static ResourceSet<LastMonthResource> Read(ReadLastMonthOptions options, IKandyRestClient client = null)
        {
        ...
        public static Page<LastMonthResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<LastMonthResource> NextPage(Page<LastMonthResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<LastMonthResource> PreviousPage(Page<LastMonthResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
