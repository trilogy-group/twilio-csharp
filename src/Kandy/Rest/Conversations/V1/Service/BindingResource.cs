...
namespace Kandy.Rest.Conversations.V1.Service
{
    public class BindingResource : Resource
    {
        ...
        /// <summary> Remove a push notification binding from the conversation service </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to delete the Binding resource from. </param>
        /// <param name="pathSid"> The SID of the Binding resource to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Binding </returns>
        public static bool Delete(string pathChatServiceSid, string pathSid, IKandyRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Binding </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathChatServiceSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new DeleteBindingOptions(pathChatServiceSid, pathSid);
...
#endif
        /// <summary> Fetch a push notification binding from the conversation service </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Binding resource is associated with. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Binding </returns>
        public static async System.Threading.Tasks.Task<BindingResource> FetchAsync(string pathChatServiceSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchBindingOptions(pathChatServiceSid, pathSid) { };
        ...
        /// <summary> Retrieve a list of all push notification bindings in the conversation service </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Binding resource is associated with. </param>
        /// <param name="bindingType"> The push technology used by the Binding resources to read.  Can be: `apn`, `gcm`, or `fcm`.  See [push notification configuration](https://www.kandy.com/docs/chat/push-notification-configuration) for more info. </param>
        /// <param name="identity"> The identity of a [Conversation User](https://www.kandy.com/docs/conversations/api/user-resource) this binding belongs to. See [access tokens](https://www.kandy.com/docs/conversations/create-tokens) for more details. </param>
        ...
        ///<summary> The unique ID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this binding. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Binding resource is associated with. </summary> 
        [JsonProperty("chat_service_sid")]
        public string ChatServiceSid { get; private set; }

        ///<summary> The SID of the [Credential](https://www.kandy.com/docs/conversations/api/credential-resource) for the binding. See [push notification configuration](https://www.kandy.com/docs/chat/push-notification-configuration) for more info. </summary> 
        ...
        ///<summary> The [Conversation message types](https://www.kandy.com/docs/chat/push-notification-configuration#push-types) the binding is subscribed to. </summary> 
