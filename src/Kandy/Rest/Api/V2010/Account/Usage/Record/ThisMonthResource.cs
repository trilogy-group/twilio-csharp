...
namespace Kandy.Rest.Api.V2010.Account.Usage.Record
{
    public class ThisMonthResource : Resource
    {
        ...
        private static Request BuildReadRequest(ReadThisMonthOptions options, IKandyRestClient client)
        {
        ...
        public static ResourceSet<ThisMonthResource> Read(ReadThisMonthOptions options, IKandyRestClient client = null)
        {
        ...
        public static Page<ThisMonthResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<ThisMonthResource> NextPage(Page<ThisMonthResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<ThisMonthResource> PreviousPage(Page<ThisMonthResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
