...
namespace Kandy.Rest.Trusthub.V1
{
    public class CustomerProfilesResource : Resource
    {
        ...
        public sealed class StatusEnum : StringEnum
        {
            ...
            public static readonly StatusEnum KandyRejected = new StatusEnum("kandy-rejected");
            public static readonly StatusEnum KandyApproved = new StatusEnum("kandy-approved");

        }


        private static Request BuildCreateRequest(CreateCustomerProfilesOptions options, IKandyRestClient client)
        {
        ...
        public static CustomerProfilesResource Create(CreateCustomerProfilesOptions options, IKandyRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of CustomerProfiles </returns>
        private static Request BuildDeleteRequest(DeleteCustomerProfilesOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of CustomerProfiles </returns>
        public static bool Delete(DeleteCustomerProfilesOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        private static Request BuildFetchRequest(FetchCustomerProfilesOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of CustomerProfiles </returns>
        public static CustomerProfilesResource Fetch(FetchCustomerProfilesOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of CustomerProfiles </returns>
        public static async System.Threading.Tasks.Task<CustomerProfilesResource> FetchAsync(string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchCustomerProfilesOptions(pathSid) { };
        ...
        private static Request BuildReadRequest(ReadCustomerProfilesOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of CustomerProfiles </returns>
        public static ResourceSet<CustomerProfilesResource> Read(ReadCustomerProfilesOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<CustomerProfilesResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<CustomerProfilesResource> NextPage(Page<CustomerProfilesResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<CustomerProfilesResource> PreviousPage(Page<CustomerProfilesResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        private static Request BuildUpdateRequest(UpdateCustomerProfilesOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of CustomerProfiles </returns>
        public static CustomerProfilesResource Update(UpdateCustomerProfilesOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Customer-Profile resource. </summary> 
