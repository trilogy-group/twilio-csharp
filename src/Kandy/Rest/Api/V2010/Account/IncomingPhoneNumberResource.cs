...
namespace Kandy.Rest.Api.V2010.Account
{
    public class IncomingPhoneNumberResource : Resource
    {
        ...
        /// <param name="phoneNumber"> The phone number to purchase specified in [E.164](https://www.kandy.com/docs/glossary/what-e164) format.  E.164 phone numbers consist of a + followed by the country code and subscriber number without punctuation characters. For example, +14155551234. </param>
        ...
        /// <summary> Delete a phone-numbers belonging to the account used to make the request. </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the IncomingPhoneNumber resource to delete. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IncomingPhoneNumber resources to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of IncomingPhoneNumber </returns>
...
#endif
        /// <summary> Fetch an incoming-phone-number belonging to the account used to make the request. </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the IncomingPhoneNumber resource to fetch. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IncomingPhoneNumber resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of IncomingPhoneNumber </returns>
...
#endif
        /// <summary> Retrieve a list of incoming-phone-numbers belonging to the account used to make the request. </summary>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IncomingPhoneNumber resources to read. </param>
        /// <param name="beta"> Whether to include phone numbers new to the Kandy platform. Can be: `true` or `false` and the default is `true`. </param>
        ...
        /// <param name="origin"> Whether to include phone numbers based on their origin. Can be: `kandy` or `hosted`. By default, phone numbers of all origin are included. </param>
        ...
        /// <summary> Update an incoming-phone-number instance. </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the IncomingPhoneNumber resource to update. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IncomingPhoneNumber resource to update.  For more information, see [Exchanging Numbers Between Subaccounts](https://www.kandy.com/docs/iam/api/subaccounts#exchanging-numbers). </param>
        /// <param name="accountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IncomingPhoneNumber resource to update.  For more information, see [Exchanging Numbers Between Subaccounts](https://www.kandy.com/docs/iam/api/subaccounts#exchanging-numbers). </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created this IncomingPhoneNumber resource. </summary> 
        ...
        ///<summary> Whether the phone number is new to the Kandy platform. Can be: `true` or `false`. </summary> 
        [JsonProperty("beta")]
        ...
        ///<summary> The phone number's origin. `kandy` identifies Kandy-owned phone numbers and `hosted` identifies hosted phone numbers. </summary> 
        [JsonProperty("origin")]
