...
namespace Kandy.Rest.Wireless.V1
{
    public class CommandResource : Resource
    {
        ...
        /// <param name="sim"> The `sid` or `unique_name` of the [SIM](https://www.kandy.com/docs/wireless/api/sim-resource) to send the Command to. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Command </returns>
        private static Request BuildDeleteRequest(DeleteCommandOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Command </returns>
        public static bool Delete(DeleteCommandOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
...
#endif
        /// <summary> Retrieve a list of Commands from your account. </summary>
        /// <param name="sim"> The `sid` or `unique_name` of the [Sim resources](https://www.kandy.com/docs/wireless/api/sim-resource) to read. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Command resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Sim resource](https://www.kandy.com/docs/wireless/api/sim-resource) that the Command was sent to or from. </summary> 
