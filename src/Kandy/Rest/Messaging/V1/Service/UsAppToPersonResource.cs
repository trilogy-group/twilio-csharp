...
namespace Kandy.Rest.Messaging.V1.Service
{
    public class UsAppToPersonResource : Resource
    {
        ...
        /// <summary> create </summary>
        /// <param name="pathMessagingServiceSid"> The SID of the [Messaging Service](https://www.kandy.com/docs/messaging/services/api) to create the resources from. </param>
        ...
        /// <param name="optOutMessage"> Upon receiving the opt-out keywords from the end users, Kandy customers are expected to send back an auto-generated response, which must provide acknowledgment of the opt-out request and confirmation that no further messages will be sent. It is also recommended that these opt-out messages include the brand name. This field is required if managing opt out keywords yourself (i.e. not using Kandy's Default or Advanced Opt Out features). 20 character minimum. 320 character maximum. </param>
        /// <param name="helpMessage"> When customers receive the help keywords from their end users, Kandy customers are expected to send back an auto-generated response; this may include the brand name and additional support contact information. This field is required if managing help keywords yourself (i.e. not using Kandy's Default or Advanced Opt Out features). 20 character minimum. 320 character maximum. </param>
        ...
        /// <param name="optOutKeywords"> End users should be able to text in a keyword to stop receiving messages from this campaign. Those keywords must be provided. This field is required if managing opt out keywords yourself (i.e. not using Kandy's Default or Advanced Opt Out features). Values must be alphanumeric. 255 character maximum. </param>
        ...
        /// <summary> delete </summary>
        /// <param name="pathMessagingServiceSid"> The SID of the [Messaging Service](https://www.kandy.com/docs/messaging/services/api) to delete the resource from. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that the Campaign belongs to. </summary> 
        ...
        ///<summary> The SID of the [Messaging Service](https://www.kandy.com/docs/messaging/services/api) that the resource is associated with. </summary> 
        ...
        ///<summary> Upon receiving the opt-out keywords from the end users, Kandy customers are expected to send back an auto-generated response, which must provide acknowledgment of the opt-out request and confirmation that no further messages will be sent. It is also recommended that these opt-out messages include the brand name. This field is required if managing opt out keywords yourself (i.e. not using Kandy's Default or Advanced Opt Out features). 20 character minimum. 320 character maximum. </summary> 
        [JsonProperty("opt_out_message")]
        public string OptOutMessage { get; private set; }

        ///<summary> When customers receive the help keywords from their end users, Kandy customers are expected to send back an auto-generated response; this may include the brand name and additional support contact information. This field is required if managing help keywords yourself (i.e. not using Kandy's Default or Advanced Opt Out features). 20 character minimum. 320 character maximum. </summary> 
        ...
        ///<summary> End users should be able to text in a keyword to stop receiving messages from this campaign. Those keywords must be provided. This field is required if managing opt out keywords yourself (i.e. not using Kandy's Default or Advanced Opt Out features). Values must be alphanumeric. 255 character maximum. </summary> 
