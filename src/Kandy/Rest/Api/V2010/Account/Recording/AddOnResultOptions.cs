...
namespace Kandy.Rest.Api.V2010.Account.Recording
{
    ...
    public class DeleteAddOnResultOptions : IOptions<AddOnResultResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Recording AddOnResult resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording AddOnResult resources to delete. </summary> 
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Recording AddOnResult resource to delete. </param>
    ...
    public class FetchAddOnResultOptions : IOptions<AddOnResultResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Recording AddOnResult resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording AddOnResult resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Recording AddOnResult resource to fetch. </param>
    ...
    public class ReadAddOnResultOptions : ReadOptions<AddOnResultResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Recording AddOnResult resources to read. </summary> 
        public string PathAccountSid { get; set; }
