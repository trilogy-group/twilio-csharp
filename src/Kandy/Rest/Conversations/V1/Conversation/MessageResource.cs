...
namespace Kandy.Rest.Conversations.V1.Conversation
{
    public class MessageResource : Resource
    {
        ...
        /// <summary> Add a new message to the conversation </summary>
        /// <param name="pathConversationSid"> The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for this message. </param>
        ...
        /// <param name="contentSid"> The unique ID of the multi-channel [Rich Content](https://www.kandy.com/docs/content-api) template, required for template-generated messages.  **Note** that if this field is set, `Body` and `MediaSid` parameters are ignored. </param>
        ...
        public static MessageResource Create(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new CreateMessageOptions(pathConversationSid) { Author = author, Body = body, DateCreated = dateCreated, DateUpdated = dateUpdated, Attributes = attributes, MediaSid = mediaSid, ContentSid = contentSid, ContentVariables = contentVariables, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Message </returns>
        public static bool Delete(string pathConversationSid, string pathSid, MessageResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteMessageOptions(pathConversationSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Message </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathConversationSid, string pathSid, MessageResource.WebhookEnabledTypeEnum xKandyWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteMessageOptions(pathConversationSid, pathSid) { XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Message </returns>
        public static async System.Threading.Tasks.Task<MessageResource> FetchAsync(string pathConversationSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchMessageOptions(pathConversationSid, pathSid) { };
...
#endif
        /// <summary> Retrieve a list of all messages in the conversation </summary>
        /// <param name="pathConversationSid"> The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for messages. </param>
        ...
        public static MessageResource Update(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new UpdateMessageOptions(pathConversationSid, pathSid) { Author = author, Body = body, DateCreated = dateCreated, DateUpdated = dateUpdated, Attributes = attributes, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        ///<summary> The unique ID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this message. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The unique ID of the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) for this message. </summary> 
        ...
        ///<summary> The index of the message within the [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource).  Indices may skip numbers, but will always be in order of when the message was received. </summary> 
        [JsonProperty("index")]
        ...
        ///<summary> The unique ID of the multi-channel [Rich Content](https://www.kandy.com/docs/content-api) template. </summary> 
