...
namespace Kandy.Rest.Media.V1
{
    public class PlayerStreamerResource : Resource
    {
        ...
        /// <param name="statusCallback"> The URL to which Kandy will send asynchronous webhook requests for every PlayerStreamer event. See [Status Callbacks](/docs/live/status-callbacks) for more details. </param>
        ...
        /// <param name="maxDuration"> The maximum time, in seconds, that the PlayerStreamer is active (`created` or `started`) before automatically ends. The default value is 300 seconds, and the maximum value is 90000 seconds. Once this maximum duration is reached, Kandy will end the PlayerStreamer, regardless of whether media is still streaming. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of PlayerStreamer </returns>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the PlayerStreamer resource. </summary> 
