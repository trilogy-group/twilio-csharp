...
namespace Kandy.Rest.Supersim.V1
{
    ...
    public class ReadEsimProfileOptions : ReadOptions<EsimProfileResource>
    {
        ...
        ///<summary> Find the eSIM Profile resource related to a [Sim](https://www.kandy.com/docs/wireless/api/sim-resource) resource by providing the SIM SID. Will always return an array with either 1 or 0 records. </summary> 
