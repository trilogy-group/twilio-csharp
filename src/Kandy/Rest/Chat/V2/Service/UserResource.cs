...
namespace Kandy.Rest.Chat.V2.Service
{
    public class UserResource : Resource
    {
        ...
        /// <summary> create </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to create the User resource under. </param>
        ...
        /// <param name="roleSid"> The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) to assign to the new User. </param>
        ...
        public static UserResource Create(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new CreateUserOptions(pathServiceSid, identity) { RoleSid = roleSid, Attributes = attributes, FriendlyName = friendlyName, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        /// <summary> delete </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to delete the User resource from. </param>
...
#endif
        /// <summary> fetch </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to fetch the User resource from. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of User </returns>
        public static async System.Threading.Tasks.Task<UserResource> FetchAsync(string pathServiceSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchUserOptions(pathServiceSid, pathSid) { };
...
#endif
        /// <summary> read </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to read the User resources from. </param>
        ...
        /// <summary> update </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) to update the User resource in. </param>
        ...
        /// <param name="roleSid"> The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) to assign to the User. </param>
        /// <param name="attributes"> A valid JSON string that contains application-specific data. </param>
        ...
        public static UserResource Update(
                                          ...
                                          IKandyRestClient client = null)
        {
            var options = new UpdateUserOptions(pathServiceSid, pathSid) { RoleSid = roleSid, Attributes = attributes, FriendlyName = friendlyName, XKandyWebhookEnabled = xKandyWebhookEnabled };
        ...
        ///<summary> The SID of the [Service](https://www.kandy.com/docs/chat/rest/service-resource) the User resource is associated with. </summary> 
        ...
        ///<summary> The SID of the [Role](https://www.kandy.com/docs/chat/rest/role-resource) assigned to the user. </summary> 
        [JsonProperty("role_sid")]
        public string RoleSid { get; private set; }

        ///<summary> The application-defined string that uniquely identifies the resource's User within the [Service](https://www.kandy.com/docs/chat/rest/service-resource). This value is often a username or an email address, and is case-sensitive. See [access tokens](https://www.kandy.com/docs/chat/create-tokens) for more info. </summary> 
        ...
        ///<summary> The absolute URLs of the [Channel](https://www.kandy.com/docs/chat/channels) and [Binding](https://www.kandy.com/docs/chat/rest/binding-resource) resources related to the user. </summary> 
        [JsonProperty("links")]
