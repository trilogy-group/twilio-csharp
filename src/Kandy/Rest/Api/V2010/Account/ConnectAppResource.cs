...
namespace Kandy.Rest.Api.V2010.Account
{
    public class ConnectAppResource : Resource
    {
        ...
        /// <summary> Delete an instance of a connect-app </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the ConnectApp resource to fetch. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ConnectApp resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of ConnectApp </returns>
...
#endif
        /// <summary> Retrieve a list of connect-apps belonging to the account used to make the request </summary>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ConnectApp resources to read. </param>
        ...
        /// <summary> Update a connect-app with the specified parameters </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the ConnectApp resource to update. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ConnectApp resources to update. </param>
        ...
        public static ConnectAppResource Update(
                                          ...
                                          Kandy.Http.HttpMethod deauthorizeCallbackMethod = null,
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ConnectApp resource. </summary> 
        ...
        public Kandy.Http.HttpMethod DeauthorizeCallbackMethod { get; private set; }
