...
namespace Kandy.Rest.Api.V2010.Account.Usage
{
    public class RecordResource : Resource
    {
        ...
        private static Request BuildReadRequest(ReadRecordOptions options, IKandyRestClient client)
        {
        ...
        public static ResourceSet<RecordResource> Read(ReadRecordOptions options, IKandyRestClient client = null)
        {
        ...
        public static Page<RecordResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<RecordResource> NextPage(Page<RecordResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<RecordResource> PreviousPage(Page<RecordResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
