...
namespace Kandy.Rest.Api.V2010.Account.Sip.Domain.AuthTypes.AuthTypeCalls
{
    public class AuthCallsIpAccessControlListMappingResource : Resource
    {
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IpAccessControlListMapping resources to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of AuthCallsIpAccessControlListMapping </returns>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IpAccessControlListMapping resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of AuthCallsIpAccessControlListMapping </returns>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IpAccessControlListMapping resources to read. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IpAccessControlListMapping resource. </summary> 
