...
namespace Kandy.Rest.Media.V1
{
    public class MediaRecordingResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the MediaRecording resource. </summary> 
        ...
        ///<summary> The URL to which Kandy will send asynchronous webhook requests for every MediaRecording event. See [Status Callbacks](/docs/live/status-callbacks) for more details. </summary> 
