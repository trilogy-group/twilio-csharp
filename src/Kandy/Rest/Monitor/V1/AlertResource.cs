...
namespace Kandy.Rest.Monitor.V1
{
    public class AlertResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Alert resource. </summary> 
        ...
        ///<summary> The error code for the condition that generated the alert. See the [Error Dictionary](https://www.kandy.com/docs/api/errors) for possible causes and solutions to the error. </summary> 
        ...
        ///<summary> The URL of the page in our [Error Dictionary](https://www.kandy.com/docs/api/errors) with more information about the error condition. </summary> 
