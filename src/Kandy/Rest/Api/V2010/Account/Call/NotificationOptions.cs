...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    ...
    public class FetchNotificationOptions : IOptions<NotificationResource>
    {
        ...
        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the Call Notification resource to fetch. </summary> 
        public string PathCallSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the Call Notification resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call Notification resource to fetch. </summary> 
    ...
    public class ReadNotificationOptions : ReadOptions<NotificationResource>
    {
        ...
        ///<summary> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the Call Notification resources to read. </summary> 
        public string PathCallSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call Notification resources to read. </summary> 
        public string PathAccountSid { get; set; }
