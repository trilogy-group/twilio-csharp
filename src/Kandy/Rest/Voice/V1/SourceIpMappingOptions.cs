...
namespace Kandy.Rest.Voice.V1
{
    ...
    public class CreateSourceIpMappingOptions : IOptions<SourceIpMappingResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the IP Record resource to map from. </summary> 
        ...
        /// <param name="ipRecordSid"> The Kandy-provided string that uniquely identifies the IP Record resource to map from. </param>
    ...
    public class DeleteSourceIpMappingOptions : IOptions<SourceIpMappingResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the IP Record resource to delete. </summary> 
    ...
    public class FetchSourceIpMappingOptions : IOptions<SourceIpMappingResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the IP Record resource to fetch. </summary> 
        public string PathSid { get; }
    ...
    public class UpdateSourceIpMappingOptions : IOptions<SourceIpMappingResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the IP Record resource to update. </summary> 
        public string PathSid { get; }
