...
namespace Kandy.Rest.Api.V2010.Account.Conference
{
    public class RecordingResource : Resource
    {
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Conference Recording resource to delete. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference Recording resources to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Recording </returns>
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Conference Recording resource to fetch. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference Recording resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Recording </returns>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference Recording resources to read. </param>
        ...
        /// <summary> Changes the status of the recording to paused, stopped, or in-progress. Note: To use `Kandy.CURRENT`, pass it as recording sid. </summary>
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Conference Recording resource to update. Use `Kandy.CURRENT` to reference the current active recording. </param>
        /// <param name="status">  </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference Recording resource to update. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference Recording resource. </summary> 
        ...
        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Conference Recording resource is associated with. </summary> 
