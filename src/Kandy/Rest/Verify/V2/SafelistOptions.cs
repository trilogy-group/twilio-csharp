...
namespace Kandy.Rest.Verify.V2
{
    ...
    public class CreateSafelistOptions : IOptions<SafelistResource>
    {
        ...
        ///<summary> The phone number to be added in SafeList. Phone numbers must be in [E.164 format](https://www.kandy.com/docs/glossary/what-e164). </summary> 
    ...
    public class DeleteSafelistOptions : IOptions<SafelistResource>
    {
        ...
        ///<summary> The phone number to be removed from SafeList. Phone numbers must be in [E.164 format](https://www.kandy.com/docs/glossary/what-e164). </summary> 
    ...
    public class FetchSafelistOptions : IOptions<SafelistResource>
    {
        ...
        ///<summary> The phone number to be fetched from SafeList. Phone numbers must be in [E.164 format](https://www.kandy.com/docs/glossary/what-e164). </summary> 
        public string PathPhoneNumber { get; }
