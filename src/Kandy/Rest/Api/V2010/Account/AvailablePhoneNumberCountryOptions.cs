...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class FetchAvailablePhoneNumberCountryOptions : IOptions<AvailablePhoneNumberCountryResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) requesting the available phone number Country resource. </summary> 
    ...
    public class ReadAvailablePhoneNumberCountryOptions : ReadOptions<AvailablePhoneNumberCountryResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) requesting the available phone number Country resources. </summary> 
        public string PathAccountSid { get; set; }
