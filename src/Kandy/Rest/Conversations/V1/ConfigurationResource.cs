...
namespace Kandy.Rest.Conversations.V1
{
    public class ConfigurationResource : Resource
    {
        ...
        /// <summary> Update the global configuration of conversations on your account </summary>
        /// <param name="defaultChatServiceSid"> The SID of the default [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to use when creating a conversation. </param>
        /// <param name="defaultMessagingServiceSid"> The SID of the default [Messaging Service](https://www.kandy.com/docs/sms/services/api) to use when creating a conversation. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this configuration. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the default [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) used when creating a conversation. </summary> 
        [JsonProperty("default_chat_service_sid")]
        public string DefaultChatServiceSid { get; private set; }

        ///<summary> The SID of the default [Messaging Service](https://www.kandy.com/docs/sms/services/api) used when creating a conversation. </summary> 
