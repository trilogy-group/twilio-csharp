...
namespace Kandy.Rest.Pricing.V1.PhoneNumber
{
    public class CountryResource : Resource
    {
        ...
        ///<summary> The list of [PhoneNumberPrice](https://www.kandy.com/docs/phone-numbers/pricing#phone-number-price) records. </summary> 
