...
namespace Kandy.Rest.Chat.V1
{
    ...
    public class DeleteCredentialOptions : IOptions<CredentialResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Credential resource to delete. </summary> 
        public string PathSid { get; }



        /// <summary> Construct a new DeleteCredentialOptions </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Credential resource to delete. </param>
    ...
    public class FetchCredentialOptions : IOptions<CredentialResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Credential resource to fetch. </summary> 
        public string PathSid { get; }



        /// <summary> Construct a new FetchCredentialOptions </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Credential resource to fetch. </param>
    ...
    public class UpdateCredentialOptions : IOptions<CredentialResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Credential resource to update. </summary> 
        public string PathSid { get; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Credential resource to update. </param>
