...
namespace Kandy.Rest.Verify.V2.Service
{
    ...
    public class CreateVerificationOptions : IOptions<VerificationResource>
    {
        ...
        ///<summary> The SID of the verification [Service](https://www.kandy.com/docs/verify/api/service) to create the resource under. </summary> 
        public string PathServiceSid { get; }

        ///<summary> The phone number or [email](https://www.kandy.com/docs/verify/email) to verify. Phone numbers must be in [E.164 format](https://www.kandy.com/docs/glossary/what-e164). </summary> 
        public string To { get; }

        ///<summary> The verification method to use. One of: [`email`](https://www.kandy.com/docs/verify/email), `sms`, `whatsapp`, `call`, `sna` or `auto`. </summary> 
        ...
        ///<summary> The digits to send after a phone call is answered, for example, to dial an extension. For more information, see the Programmable Voice documentation of [sendDigits](https://www.kandy.com/docs/voice/twiml/number#attributes-sendDigits). </summary> 
        ...
        ///<summary> [`email`](https://www.kandy.com/docs/verify/email) channel configuration in json format. The fields 'from' and 'from_name' are optional but if included the 'from' field must have a valid email address. </summary> 
        ...
        ///<summary> The message [template](https://www.kandy.com/docs/verify/api/templates). If provided, will override the default template for the Service. SMS and Voice channels only. </summary> 
        ...
        /// <param name="pathServiceSid"> The SID of the verification [Service](https://www.kandy.com/docs/verify/api/service) to create the resource under. </param>
        /// <param name="to"> The phone number or [email](https://www.kandy.com/docs/verify/email) to verify. Phone numbers must be in [E.164 format](https://www.kandy.com/docs/glossary/what-e164). </param>
        /// <param name="channel"> The verification method to use. One of: [`email`](https://www.kandy.com/docs/verify/email), `sms`, `whatsapp`, `call`, `sna` or `auto`. </param>
    ...
    public class FetchVerificationOptions : IOptions<VerificationResource>
    {
        ...
        ///<summary> The SID of the verification [Service](https://www.kandy.com/docs/verify/api/service) to fetch the resource from. </summary> 
        public string PathServiceSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the Verification resource to fetch. </summary> 
        public string PathSid { get; }



        /// <summary> Construct a new FetchVerificationOptions </summary>
        /// <param name="pathServiceSid"> The SID of the verification [Service](https://www.kandy.com/docs/verify/api/service) to fetch the resource from. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Verification resource to fetch. </param>
    ...
    public class UpdateVerificationOptions : IOptions<VerificationResource>
    {
        ...
        ///<summary> The SID of the verification [Service](https://www.kandy.com/docs/verify/api/service) to update the resource from. </summary> 
        public string PathServiceSid { get; }

        ///<summary> The Kandy-provided string that uniquely identifies the Verification resource to update. </summary> 
        public string PathSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the verification [Service](https://www.kandy.com/docs/verify/api/service) to update the resource from. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Verification resource to update. </param>
