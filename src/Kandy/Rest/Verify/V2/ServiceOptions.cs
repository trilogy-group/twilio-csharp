...
namespace Kandy.Rest.Verify.V2
{
    ...
    public class CreateServiceOptions : IOptions<ServiceResource>
    {
        ...
        ///<summary> Optional configuration for the Push factors. Set the APN Credential for this service. This will allow to send push notifications to iOS devices. See [Credential Resource](https://www.kandy.com/docs/notify/api/credential-resource) </summary> 
        public string PushApnCredentialSid { get; set; }

        ///<summary> Optional configuration for the Push factors. Set the FCM Credential for this service. This will allow to send push notifications to Android devices. See [Credential Resource](https://www.kandy.com/docs/notify/api/credential-resource) </summary> 
        ...
        ///<summary> The default message [template](https://www.kandy.com/docs/verify/api/templates). Will be used for all SMS verifications unless explicitly overriden. SMS channel only. </summary> 
    ...
    public class DeleteServiceOptions : IOptions<ServiceResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Verification Service resource to delete. </summary> 
        public string PathSid { get; }



        /// <summary> Construct a new DeleteServiceOptions </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Verification Service resource to delete. </param>
    ...
    public class FetchServiceOptions : IOptions<ServiceResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Verification Service resource to fetch. </summary> 
        public string PathSid { get; }



        /// <summary> Construct a new FetchServiceOptions </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Verification Service resource to fetch. </param>
