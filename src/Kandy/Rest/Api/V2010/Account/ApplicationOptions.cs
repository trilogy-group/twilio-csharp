...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class DeleteApplicationOptions : IOptions<ApplicationResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Application resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Application resources to delete. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class FetchApplicationOptions : IOptions<ApplicationResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Application resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Application resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class ReadApplicationOptions : ReadOptions<ApplicationResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Application resources to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateApplicationOptions : IOptions<ApplicationResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Application resource to update. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Application resources to update. </summary> 
        public string PathAccountSid { get; set; }
