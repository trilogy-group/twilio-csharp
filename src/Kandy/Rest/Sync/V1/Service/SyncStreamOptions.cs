...
namespace Kandy.Rest.Sync.V1.Service
{
    ...
    public class CreateSyncStreamOptions : IOptions<SyncStreamResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the new Stream in. </summary> 
        ...
        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Stream expires and is deleted (time-to-live). </summary> 
    ...
    public class DeleteSyncStreamOptions : IOptions<SyncStreamResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Stream resource to delete. </summary> 
        public string PathServiceSid { get; }
    ...
    public class FetchSyncStreamOptions : IOptions<SyncStreamResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Stream resource to fetch. </summary> 
        public string PathServiceSid { get; }
    ...
    public class ReadSyncStreamOptions : ReadOptions<SyncStreamResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Stream resources to read. </summary> 
        public string PathServiceSid { get; }
    ...
    public class UpdateSyncStreamOptions : IOptions<SyncStreamResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync Stream resource to update. </summary> 
        public string PathServiceSid { get; }
