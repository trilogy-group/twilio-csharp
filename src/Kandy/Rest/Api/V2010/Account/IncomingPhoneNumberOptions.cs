...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class CreateIncomingPhoneNumberOptions : IOptions<IncomingPhoneNumberResource>
    {
        ...
        public Kandy.Http.HttpMethod SmsFallbackMethod { get; set; }
        ...
        public Kandy.Http.HttpMethod SmsMethod { get; set; }
        ...
        public Kandy.Http.HttpMethod VoiceFallbackMethod { get; set; }
        ...
        public Kandy.Http.HttpMethod VoiceMethod { get; set; }
        ...
        ///<summary> The phone number to purchase specified in [E.164](https://www.kandy.com/docs/glossary/what-e164) format.  E.164 phone numbers consist of a + followed by the country code and subscriber number without punctuation characters. For example, +14155551234. </summary> 
    ...
    public class DeleteIncomingPhoneNumberOptions : IOptions<IncomingPhoneNumberResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the IncomingPhoneNumber resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IncomingPhoneNumber resources to delete. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class FetchIncomingPhoneNumberOptions : IOptions<IncomingPhoneNumberResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the IncomingPhoneNumber resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IncomingPhoneNumber resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class ReadIncomingPhoneNumberOptions : ReadOptions<IncomingPhoneNumberResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IncomingPhoneNumber resources to read. </summary> 
        public string PathAccountSid { get; set; }

        ///<summary> Whether to include phone numbers new to the Kandy platform. Can be: `true` or `false` and the default is `true`. </summary> 
        ...
        ///<summary> Whether to include phone numbers based on their origin. Can be: `kandy` or `hosted`. By default, phone numbers of all origin are included. </summary> 
    ...
    public class UpdateIncomingPhoneNumberOptions : IOptions<IncomingPhoneNumberResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the IncomingPhoneNumber resource to update. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IncomingPhoneNumber resource to update.  For more information, see [Exchanging Numbers Between Subaccounts](https://www.kandy.com/docs/iam/api/subaccounts#exchanging-numbers). </summary> 
        public string PathAccountSid { get; set; }
