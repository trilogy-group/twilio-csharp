...
namespace Kandy.Rest.Lookups.V1
{
    ...
    public class FetchPhoneNumberOptions : IOptions<PhoneNumberResource>
    {
        ...
        ///<summary> The phone number to lookup in [E.164](https://www.kandy.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number. </summary> 
