...
namespace Kandy.Rest.Wireless.V1
{
    public class SimResource : Resource
    {
        ...
        /// <param name="ratePlan"> The SID or unique name of a [RatePlan resource](https://www.kandy.com/docs/wireless/api/rateplan-resource). Only return Sim resources assigned to this RatePlan resource. </param>
        ...
        /// <param name="ratePlan"> The SID or unique name of the [RatePlan resource](https://www.kandy.com/docs/wireless/api/rateplan-resource) to which the Sim resource should be assigned. </param>
        ...
        /// <param name="commandsCallbackUrl"> The URL we should call using the `commands_callback_method` when the SIM sends a [Command](https://www.kandy.com/docs/wireless/api/command-resource). Your server should respond with an HTTP status code in the 200 range; any response body is ignored. </param>
        ...
        /// <param name="smsUrl"> The URL we should call using the `sms_method` when the SIM-connected device sends an SMS message that is not a [Command](https://www.kandy.com/docs/wireless/api/command-resource). </param>
        ...
        public static SimResource Update(
                                          ...
                                          string ratePlan = null,
                                          SimResource.StatusEnum status = null,
                                          Kandy.Http.HttpMethod commandsCallbackMethod = null,
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) to which the Sim resource belongs. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [RatePlan resource](https://www.kandy.com/docs/wireless/api/rateplan-resource) to which the Sim resource is assigned. </summary> 
        ...
        ///<summary> The URL we call using the `commands_callback_method` when the SIM originates a machine-to-machine [Command](https://www.kandy.com/docs/wireless/api/command-resource). Your server should respond with an HTTP status code in the 200 range; any response body will be ignored. </summary> 
        ...
        public Kandy.Http.HttpMethod CommandsCallbackMethod { get; private set; }
