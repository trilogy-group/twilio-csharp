...
namespace Kandy.Rest.Api.V2010.Account.Conference
{
    public class ParticipantResource : Resource
    {
        ...
        /// <param name="waitUrl"> The URL we should call using the `wait_method` for the music to play while participants are waiting for the conference to start. The default value is the URL of our standard hold music. [Learn more about hold music](https://www.kandy.com/labs/twimlets/holdmusic). </param>
        ...
        /// <param name="region"> The [region](https://support.kandy.com/hc/en-us/articles/223132167-How-global-low-latency-routing-and-region-selection-work-for-conferences-and-Client-calls) where we should mix the recorded audio. Can be:`us1`, `ie1`, `de1`, `sg1`, `br1`, `au1`, or `jp1`. </param>
        ...
        /// <param name="jitterBufferSize"> Jitter buffer size for the connecting participant. Kandy will use this setting to apply Jitter Buffer before participant's audio is mixed into the conference. Can be: `off`, `small`, `medium`, and `large`. Default to `large`. </param>
        ...
        /// <param name="recordingTrack"> The audio track to record for the call. Can be: `inbound`, `outbound` or `both`. The default is `both`. `inbound` records the audio that is received by Kandy. `outbound` records the audio that is sent from Kandy. `both` records the audio that is received and sent by Kandy. </param>
        ...
        public static ParticipantResource Create(
                                          ...
                                          Kandy.Http.HttpMethod conferenceStatusCallbackMethod = null,
                                          ...
                                          Kandy.Http.HttpMethod conferenceRecordingStatusCallbackMethod = null,
        ...
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID or label of the participant to delete. Non URL safe characters in a label must be percent encoded, for example, a space character is represented as %20. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Participant resources to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Participant </returns>
        ...
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID or label of the participant to fetch. Non URL safe characters in a label must be percent encoded, for example, a space character is represented as %20. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Participant resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Participant </returns>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Participant resources to read. </param>
        ...
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID or label of the participant to update. Non URL safe characters in a label must be percent encoded, for example, a space character is represented as %20. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Participant resources to update. </param>
        ...
        /// <param name="waitUrl"> The URL we call using the `wait_method` for the music to play while participants are waiting for the conference to start. The URL may return an MP3 file, a WAV file, or a TwiML document that contains `<Play>`, `<Say>`, `<Pause>`, or `<Redirect>` verbs. The default value is the URL of our standard hold music. [Learn more about hold music](https://www.kandy.com/labs/twimlets/holdmusic). </param>
        /// <param name="waitMethod"> The HTTP method we should use to call `wait_url`. Can be `GET` or `POST` and the default is `POST`. When using a static audio file, this should be `GET` so that we can cache the file. </param>
        ...
        public static ParticipantResource Update(
                                          ...
                                          bool? hold = null,
                                          Uri holdUrl = null,
                                          Kandy.Http.HttpMethod holdMethod = null,
                                          Uri announceUrl = null,
                                          Kandy.Http.HttpMethod announceMethod = null,
                                          Uri waitUrl = null,
                                          Kandy.Http.HttpMethod waitMethod = null,
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Participant resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Participant resource is associated with. </summary> 
