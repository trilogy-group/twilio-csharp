...
namespace Kandy.Rest.Autopilot.V1.Assistant.Task
{
    ...
    public class FetchTaskActionsOptions : IOptions<TaskActionsResource>
    {
        ...
        ///<summary> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the Task for which the task actions to fetch were defined. </summary> 
        public string PathAssistantSid { get; }

        ///<summary> The SID of the [Task](https://www.kandy.com/docs/autopilot/api/task) for which the task actions to fetch were defined. </summary> 
    ...
    public class UpdateTaskActionsOptions : IOptions<TaskActionsResource>
    {
        ...
        ///<summary> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the Task for which the task actions to update were defined. </summary> 
        public string PathAssistantSid { get; }

        ///<summary> The SID of the [Task](https://www.kandy.com/docs/autopilot/api/task) for which the task actions to update were defined. </summary> 
        public string PathTaskSid { get; }
