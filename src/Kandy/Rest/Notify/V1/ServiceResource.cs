...
namespace Kandy.Rest.Notify.V1
{
    public class ServiceResource : Resource
    {
        ...
        /// <param name="apnCredentialSid"> The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) to use for APN Bindings. </param>
        /// <param name="gcmCredentialSid"> The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) to use for GCM Bindings. </param>
        /// <param name="messagingServiceSid"> The SID of the [Messaging Service](https://www.kandy.com/docs/sms/send-messages#messaging-services) to use for SMS Bindings. This parameter must be set in order to send SMS notifications. </param>
        /// <param name="facebookMessengerPageId"> Deprecated. </param>
        /// <param name="defaultApnNotificationProtocolVersion"> The protocol version to use for sending APNS notifications. Can be overridden on a Binding by Binding basis when creating a [Binding](https://www.kandy.com/docs/notify/api/binding-resource) resource. </param>
        /// <param name="defaultGcmNotificationProtocolVersion"> The protocol version to use for sending GCM notifications. Can be overridden on a Binding by Binding basis when creating a [Binding](https://www.kandy.com/docs/notify/api/binding-resource) resource. </param>
        /// <param name="fcmCredentialSid"> The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) to use for FCM Bindings. </param>
        /// <param name="defaultFcmNotificationProtocolVersion"> The protocol version to use for sending FCM notifications. Can be overridden on a Binding by Binding basis when creating a [Binding](https://www.kandy.com/docs/notify/api/binding-resource) resource. </param>
        ...
        ///<summary> The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) to use for APN Bindings. </summary> 
        [JsonProperty("apn_credential_sid")]
        public string ApnCredentialSid { get; private set; }

        ///<summary> The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) to use for GCM Bindings. </summary> 
        [JsonProperty("gcm_credential_sid")]
        public string GcmCredentialSid { get; private set; }

        ///<summary> The SID of the [Credential](https://www.kandy.com/docs/notify/api/credential-resource) to use for FCM Bindings. </summary> 
        [JsonProperty("fcm_credential_sid")]
        public string FcmCredentialSid { get; private set; }

        ///<summary> The SID of the [Messaging Service](https://www.kandy.com/docs/sms/send-messages#messaging-services) to use for SMS Bindings. In order to send SMS notifications this parameter has to be set. </summary> 
        ...
        ///<summary> The protocol version to use for sending APNS notifications. Can be overridden on a Binding by Binding basis when creating a [Binding](https://www.kandy.com/docs/notify/api/binding-resource) resource. </summary> 
        ...
        ///<summary> The protocol version to use for sending GCM notifications. Can be overridden on a Binding by Binding basis when creating a [Binding](https://www.kandy.com/docs/notify/api/binding-resource) resource. </summary> 
        ...
        ///<summary> The protocol version to use for sending FCM notifications. Can be overridden on a Binding by Binding basis when creating a [Binding](https://www.kandy.com/docs/notify/api/binding-resource) resource. </summary> 
