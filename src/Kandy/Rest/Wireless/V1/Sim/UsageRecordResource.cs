...
namespace Kandy.Rest.Wireless.V1.Sim
{
    public class UsageRecordResource : Resource
    {
...
#endif
        /// <summary> read </summary>
        /// <param name="pathSimSid"> The SID of the [Sim resource](https://www.kandy.com/docs/wireless/api/sim-resource)  to read the usage from. </param>
        ...
        ///<summary> The SID of the [Sim resource](https://www.kandy.com/docs/wireless/api/sim-resource) that this Usage Record is for. </summary> 
        [JsonProperty("sim_sid")]
        public string SimSid { get; private set; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageRecord resource. </summary> 
        ...
        ///<summary> An object that describes the SIM's usage of Commands during the specified period. See [Commands Usage Object](https://www.kandy.com/docs/wireless/api/sim-usagerecord-resource#commands-usage-object). </summary> 
        [JsonProperty("commands")]
        public object Commands { get; private set; }

        ///<summary> An object that describes the SIM's data usage during the specified period. See [Data Usage Object](https://www.kandy.com/docs/wireless/api/sim-usagerecord-resource#data-usage-object). </summary> 
        [JsonProperty("data")]
