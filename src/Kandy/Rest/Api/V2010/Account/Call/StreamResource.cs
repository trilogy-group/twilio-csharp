...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    public class StreamResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateStreamOptions options, IKandyRestClient client)
        {
        ...
        public static StreamResource Create(CreateStreamOptions options, IKandyRestClient client = null)
        {
        ...
        /// <summary> Create a Stream </summary>
        /// <param name="pathCallSid"> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Stream resource is associated with. </param>
        /// <param name="url"> Relative or absolute url where WebSocket connection will be established. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created this Stream resource. </param>
        ...
        private static Request BuildUpdateRequest(UpdateStreamOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Stream </returns>
        public static StreamResource Update(UpdateStreamOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created this Stream resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Stream resource is associated with. </summary> 
