...
namespace Kandy.Rest.Preview.HostedNumbers
{
    public class HostedNumberOrderResource : Resource
    {
        ...
        /// <summary> Host a phone number's capability on Kandy's platform. </summary>
        ...
        /// <param name="smsCapability"> Used to specify that the SMS capability will be hosted on Kandy's platform. </param>
        ...
        /// <param name="smsUrl"> The URL that Kandy should request when somebody sends an SMS to the phone number. This will be copied onto the IncomingPhoneNumber resource. </param>
        ...
        /// <param name="smsFallbackUrl"> A URL that Kandy will request if an error occurs requesting or executing the TwiML defined by SmsUrl. This will be copied onto the IncomingPhoneNumber resource. </param>
        ...
        /// <param name="smsApplicationSid"> Optional. The 34 character sid of the application Kandy should use to handle SMS messages sent to this number. If a `SmsApplicationSid` is present, Kandy will ignore all of the SMS urls above and use those set on the application. </param>
        ...
        ///<summary> A 34 character string that uniquely identifies the [IncomingPhoneNumber](https://www.kandy.com/docs/api/rest/incoming-phone-numbers) resource that represents the phone number being hosted. </summary> 
        ...
        ///<summary> A 34 character string that uniquely identifies the [Authorization Document](https://www.kandy.com/docs/api/phone-numbers/hosted-number-authorization-documents) the user needs to sign. </summary> 
