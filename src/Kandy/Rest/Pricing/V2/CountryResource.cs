...
namespace Kandy.Rest.Pricing.V2
{
    public class CountryResource : Resource
    {
        ...
        ///<summary> The list of [TerminatingPrefixPrice](https://www.kandy.com/docs/voice/pricing#outbound-prefix-price-with-origin) records. </summary> 
        [JsonProperty("terminating_prefix_prices")]
        public List<OutboundPrefixPriceWithOrigin> TerminatingPrefixPrices { get; private set; }

        ///<summary> The list of [OriginatingCallPrice](https://www.kandy.com/docs/voice/pricing#inbound-call-price) records. </summary> 
