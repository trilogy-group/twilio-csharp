...
namespace Kandy.Rest.Messaging.V1.Service
{
    ...
    public class CreateUsAppToPersonOptions : IOptions<UsAppToPersonResource>
    {
        ...
        ///<summary> The SID of the [Messaging Service](https://www.kandy.com/docs/messaging/services/api) to create the resources from. </summary> 
    ...
    public class DeleteUsAppToPersonOptions : IOptions<UsAppToPersonResource>
    {
        ...
        ///<summary> The SID of the [Messaging Service](https://www.kandy.com/docs/messaging/services/api) to delete the resource from. </summary> 
        public string PathMessagingServiceSid { get; }
    ...
    public class FetchUsAppToPersonOptions : IOptions<UsAppToPersonResource>
    {
        ...
        ///<summary> The SID of the [Messaging Service](https://www.kandy.com/docs/messaging/services/api) to fetch the resource from. </summary> 
        public string PathMessagingServiceSid { get; }
