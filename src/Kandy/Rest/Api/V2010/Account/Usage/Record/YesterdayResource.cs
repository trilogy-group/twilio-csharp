...
namespace Kandy.Rest.Api.V2010.Account.Usage.Record
{
    public class YesterdayResource : Resource
    {
        ...
        public sealed class CategoryEnum : StringEnum
        {
            ...
            public static readonly CategoryEnum MarketplaceKandyCallerNameLookupUs = new CategoryEnum("marketplace-kandy-caller-name-lookup-us");
            public static readonly CategoryEnum MarketplaceKandyCarrierInformationLookup = new CategoryEnum("marketplace-kandy-carrier-information-lookup");
            ...
            public static readonly CategoryEnum KandyInterconnect = new CategoryEnum("kandy-interconnect");
        ...
        private static Request BuildReadRequest(ReadYesterdayOptions options, IKandyRestClient client)
        {
        ...
        public static ResourceSet<YesterdayResource> Read(ReadYesterdayOptions options, IKandyRestClient client = null)
        {
...
#endif
        /// <summary> read </summary>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the UsageRecord resources to read. </param>
        /// <param name="category"> The [usage category](https://www.kandy.com/docs/usage/api/usage-record#usage-categories) of the UsageRecord resources to read. Only UsageRecord resources in the specified category are retrieved. </param>
        ...
        public static Page<YesterdayResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<YesterdayResource> NextPage(Page<YesterdayResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<YesterdayResource> PreviousPage(Page<YesterdayResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that accrued the usage. </summary> 
        ...
        ///<summary> A list of related resources identified by their URIs. For more information, see [List Subresources](https://www.kandy.com/docs/usage/api/usage-record#list-subresources). </summary> 
