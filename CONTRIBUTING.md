# Contributing to `kandy-csharp`

We'd love for you to contribute to our source code and to make `kandy-csharp`
...
Help us keep `kandy-csharp` open and inclusive. Please be kind to and considerate
of other developers, as we all have the same goal: make `kandy-csharp` as good as
it can be.

## <a name="question"></a> Got an API/Product Question or Problem?

If you have questions about how to use `kandy-csharp`, please see our
...
- **Major Changes** that you wish to contribute to the project should be
  discussed first with `kandy-csharp` contributors in an issue or pull request so
...
- **`kandy-csharp` Version(s)** - is it a regression?
...
- Run the full `kandy-csharp` test suite (aliased by `make test`), and ensure
  that all tests pass.
...
In GitHub, send a pull request to `kandy-csharp:main`.
If we suggest changes, then:

- Make the required updates.
- Re-run the `kandy-csharp` test suite to ensure tests are still passing.
...
[issue-link]: https://github.com/kandy/kandy-csharp/issues/new
[github]: https://github.com/kandy/kandy-csharp
