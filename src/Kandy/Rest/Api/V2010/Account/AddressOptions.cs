...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class CreateAddressOptions : IOptions<AddressResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that will be responsible for the new Address resource. </summary> 
    ...
    public class DeleteAddressOptions : IOptions<AddressResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Address resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that is responsible for the Address resource to delete. </summary> 
        public string PathAccountSid { get; set; }



        /// <summary> Construct a new DeleteAddressOptions </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Address resource to delete. </param>
    ...
    public class FetchAddressOptions : IOptions<AddressResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Address resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that is responsible for the Address resource to fetch. </summary> 
        public string PathAccountSid { get; set; }



        /// <summary> Construct a new FetchAddressOptions </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Address resource to fetch. </param>
    ...
    public class ReadAddressOptions : ReadOptions<AddressResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that is responsible for the Address resource to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateAddressOptions : IOptions<AddressResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Address resource to update. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that is responsible for the Address resource to update. </summary> 
        public string PathAccountSid { get; set; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Address resource to update. </param>
