...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class FetchNotificationOptions : IOptions<NotificationResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Notification resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Notification resource to fetch. </summary> 
    ...
    public class ReadNotificationOptions : ReadOptions<NotificationResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Notification resources to read. </summary> 
        public string PathAccountSid { get; set; }
