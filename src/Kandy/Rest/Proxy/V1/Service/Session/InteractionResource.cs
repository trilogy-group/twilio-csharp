...
namespace Kandy.Rest.Proxy.V1.Service.Session
{
    public class InteractionResource : Resource
    {
        ...
        private static Request BuildDeleteRequest(DeleteInteractionOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Interaction </returns>
        public static bool Delete(DeleteInteractionOptions options, IKandyRestClient client = null)
        {
        ...
        /// <summary> Delete a specific Interaction. </summary>
        /// <param name="pathServiceSid"> The SID of the parent [Service](https://www.kandy.com/docs/proxy/api/service) of the resource to delete. </param>
        /// <param name="pathSessionSid"> The SID of the parent [Session](https://www.kandy.com/docs/proxy/api/session) of the resource to delete. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Interaction resource to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Interaction </returns>
        ...
        /// <summary> Retrieve a list of Interactions for a given [Session](https://www.kandy.com/docs/proxy/api/session). </summary>
...
#endif
        /// <summary> Retrieve a list of Interactions for a given [Session](https://www.kandy.com/docs/proxy/api/session). </summary>
        /// <param name="pathServiceSid"> The SID of the parent [Service](https://www.kandy.com/docs/proxy/api/service) of the resource to fetch. </param>
        /// <param name="pathSessionSid"> The SID of the parent [Session](https://www.kandy.com/docs/proxy/api/session) of the resource to fetch. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Interaction resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Interaction </returns>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Interaction </returns>
        public static async System.Threading.Tasks.Task<InteractionResource> FetchAsync(string pathServiceSid, string pathSessionSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchInteractionOptions(pathServiceSid, pathSessionSid, pathSid) { };
        ...
        private static Request BuildReadRequest(ReadInteractionOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Interaction </returns>
        public static ResourceSet<InteractionResource> Read(ReadInteractionOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
...
#endif
        /// <summary> Retrieve a list of all Interactions for a Session. A maximum of 100 records will be returned per page. </summary>
        /// <param name="pathServiceSid"> The SID of the parent [Service](https://www.kandy.com/docs/proxy/api/service) to read the resources from. </param>
        /// <param name="pathSessionSid"> The SID of the parent [Session](https://www.kandy.com/docs/proxy/api/session) to read the resources from. </param>
        ...
        public static Page<InteractionResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<InteractionResource> NextPage(Page<InteractionResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<InteractionResource> PreviousPage(Page<InteractionResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        ///<summary> The SID of the parent [Session](https://www.kandy.com/docs/proxy/api/session) resource. </summary> 
        [JsonProperty("session_sid")]
        public string SessionSid { get; private set; }

        ///<summary> The SID of the parent [Service](https://www.kandy.com/docs/proxy/api/service) resource. </summary> 
        [JsonProperty("service_sid")]
        public string ServiceSid { get; private set; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Interaction resource. </summary> 
        ...
        ///<summary> The SID of the inbound [Participant](https://www.kandy.com/docs/proxy/api/participant) resource. </summary> 
        [JsonProperty("inbound_participant_sid")]
        public string InboundParticipantSid { get; private set; }

        ///<summary> The SID of the inbound resource; either the [Call](https://www.kandy.com/docs/voice/api/call-resource) or [Message](https://www.kandy.com/docs/sms/api/message. </summary> 
        ...
        ///<summary> The inbound resource type. Can be [Call](https://www.kandy.com/docs/voice/api/call-resource) or [Message](https://www.kandy.com/docs/sms/api/message-resource). </summary> 
        [JsonProperty("inbound_resource_type")]
        public string InboundResourceType { get; private set; }

        ///<summary> The URL of the Kandy inbound resource </summary> 
        [JsonProperty("inbound_resource_url")]
        public Uri InboundResourceUrl { get; private set; }

        ///<summary> The SID of the outbound [Participant](https://www.kandy.com/docs/proxy/api/participant)). </summary> 
        [JsonProperty("outbound_participant_sid")]
        public string OutboundParticipantSid { get; private set; }

        ///<summary> The SID of the outbound resource; either the [Call](https://www.kandy.com/docs/voice/api/call-resource) or [Message](https://www.kandy.com/docs/sms/api/message-resource). </summary> 
        ...
        ///<summary> The outbound resource type. Can be: [Call](https://www.kandy.com/docs/voice/api/call-resource) or [Message](https://www.kandy.com/docs/sms/api/message-resource). </summary> 
        [JsonProperty("outbound_resource_type")]
        public string OutboundResourceType { get; private set; }

        ///<summary> The URL of the Kandy outbound resource. </summary> 
