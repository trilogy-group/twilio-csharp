...
namespace Kandy.Rest.Insights.V1.Room
{
    public class ParticipantResource : Resource
    {
        ...
        public sealed class KandyRealmEnum : StringEnum
        {
            private KandyRealmEnum(string value) : base(value) { }
            public KandyRealmEnum() { }
            public static implicit operator KandyRealmEnum(string value)
            {
                return new KandyRealmEnum(value);
            }
            public static readonly KandyRealmEnum Us1 = new KandyRealmEnum("us1");
            public static readonly KandyRealmEnum Us2 = new KandyRealmEnum("us2");
            public static readonly KandyRealmEnum Au1 = new KandyRealmEnum("au1");
            public static readonly KandyRealmEnum Br1 = new KandyRealmEnum("br1");
            public static readonly KandyRealmEnum Ie1 = new KandyRealmEnum("ie1");
            public static readonly KandyRealmEnum Jp1 = new KandyRealmEnum("jp1");
            public static readonly KandyRealmEnum Sg1 = new KandyRealmEnum("sg1");
            public static readonly KandyRealmEnum In1 = new KandyRealmEnum("in1");
            public static readonly KandyRealmEnum De1 = new KandyRealmEnum("de1");
            public static readonly KandyRealmEnum Gll = new KandyRealmEnum("gll");
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Participant </returns>
        public static async System.Threading.Tasks.Task<ParticipantResource> FetchAsync(string pathRoomSid, string pathParticipantSid, IKandyRestClient client = null)
        {
            var options = new FetchParticipantOptions(pathRoomSid, pathParticipantSid) { };
        ...
        ///<summary> Reason the participant left the room. See [the list of possible values here](https://www.kandy.com/docs/video/video-log-analyzer/video-log-analyzer-api#end_reason). </summary> 
        ...
        ///<summary> Kandy error code dictionary link. </summary> 
        [JsonProperty("error_code_url")]
        public string ErrorCodeUrl { get; private set; }


        [JsonProperty("media_region")]
        public ParticipantResource.KandyRealmEnum MediaRegion { get; private set; }

        ///<summary> Object containing information about the participant's data from the room. See [below](https://www.kandy.com/docs/video/video-log-analyzer/video-log-analyzer-api#properties) for more information. </summary> 
        ...
        ///<summary> Object containing information about the SDK name and version. See [below](https://www.kandy.com/docs/video/video-log-analyzer/video-log-analyzer-api#publisher_info) for more information. </summary> 
