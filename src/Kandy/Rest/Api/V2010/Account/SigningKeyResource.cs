...
namespace Kandy.Rest.Api.V2010.Account
{
    public class SigningKeyResource : Resource
    {
        ...
        private static Request BuildDeleteRequest(DeleteSigningKeyOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of SigningKey </returns>
        public static bool Delete(DeleteSigningKeyOptions options, IKandyRestClient client = null)
        {
        ...
        private static Request BuildFetchRequest(FetchSigningKeyOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of SigningKey </returns>
        public static SigningKeyResource Fetch(FetchSigningKeyOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of SigningKey </returns>
        public static async System.Threading.Tasks.Task<SigningKeyResource> FetchAsync(string pathSid, string pathAccountSid = null, IKandyRestClient client = null)
        {
            var options = new FetchSigningKeyOptions(pathSid) { PathAccountSid = pathAccountSid };
        ...
        private static Request BuildReadRequest(ReadSigningKeyOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of SigningKey </returns>
        public static ResourceSet<SigningKeyResource> Read(ReadSigningKeyOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<SigningKeyResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<SigningKeyResource> NextPage(Page<SigningKeyResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<SigningKeyResource> PreviousPage(Page<SigningKeyResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        private static Request BuildUpdateRequest(UpdateSigningKeyOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of SigningKey </returns>
        public static SigningKeyResource Update(UpdateSigningKeyOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
