...
namespace Kandy.Rest.Api.V2010.Account.Usage.Record
{
    public class AllTimeResource : Resource
    {
        ...
        private static Request BuildReadRequest(ReadAllTimeOptions options, IKandyRestClient client)
        {
        ...
        public static ResourceSet<AllTimeResource> Read(ReadAllTimeOptions options, IKandyRestClient client = null)
        {
        ...
        public static Page<AllTimeResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<AllTimeResource> NextPage(Page<AllTimeResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<AllTimeResource> PreviousPage(Page<AllTimeResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
