...
namespace Kandy.Rest.Sync.V1.Service.SyncList
{
    ...
    public class DeleteSyncListPermissionOptions : IOptions<SyncListPermissionResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Permission resource to delete. </summary> 
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Permission resource to delete. </param>
    ...
    public class FetchSyncListPermissionOptions : IOptions<SyncListPermissionResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Permission resource to fetch. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Permission resource to fetch. </param>
    ...
    public class ReadSyncListPermissionOptions : ReadOptions<SyncListPermissionResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Permission resources to read. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Permission resources to read. </param>
    ...
    public class UpdateSyncListPermissionOptions : IOptions<SyncListPermissionResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Permission resource to update. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Sync List Permission resource to update. </param>
