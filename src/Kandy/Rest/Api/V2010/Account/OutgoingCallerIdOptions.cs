...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class DeleteOutgoingCallerIdOptions : IOptions<OutgoingCallerIdResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the OutgoingCallerId resource to delete. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the OutgoingCallerId resources to delete. </summary> 
    ...
    public class FetchOutgoingCallerIdOptions : IOptions<OutgoingCallerIdResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the OutgoingCallerId resource to fetch. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the OutgoingCallerId resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class ReadOutgoingCallerIdOptions : ReadOptions<OutgoingCallerIdResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the OutgoingCallerId resources to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateOutgoingCallerIdOptions : IOptions<OutgoingCallerIdResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the OutgoingCallerId resource to update. </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the OutgoingCallerId resources to update. </summary> 
        public string PathAccountSid { get; set; }
