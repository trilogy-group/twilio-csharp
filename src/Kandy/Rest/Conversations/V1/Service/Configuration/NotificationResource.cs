...
namespace Kandy.Rest.Conversations.V1.Service.Configuration
{
    public class NotificationResource : Resource
    {
...
#endif
        /// <summary> Fetch push notification service settings </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Configuration applies to. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Notification </returns>
        ...
        ///<summary> The unique ID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this configuration. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Configuration applies to. </summary> 
