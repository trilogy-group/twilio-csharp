...
namespace Kandy.Rest.Chat.V2
{
    public class ServiceResource : Resource
    {
        ...
        /// <param name="defaultServiceRoleSid"> The service role assigned to users when they are added to the service. See the [Role resource](https://www.kandy.com/docs/chat/rest/role-resource) for more info about roles. </param>
        /// <param name="defaultChannelRoleSid"> The channel role assigned to users when they are added to a channel. See the [Role resource](https://www.kandy.com/docs/chat/rest/role-resource) for more info about roles. </param>
        /// <param name="defaultChannelCreatorRoleSid"> The channel role assigned to a channel creator when they join a new channel. See the [Role resource](https://www.kandy.com/docs/chat/rest/role-resource) for more info about roles. </param>
        ...
        /// <param name="preWebhookUrl"> The URL for pre-event webhooks, which are called by using the `webhook_method`. See [Webhook Events](https://www.kandy.com/docs/chat/webhook-events) for more details. </param>
        /// <param name="postWebhookUrl"> The URL for post-event webhooks, which are called by using the `webhook_method`. See [Webhook Events](https://www.kandy.com/docs/chat/webhook-events) for more details. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Service resource. </summary> 
        ...
        ///<summary> The service role assigned to users when they are added to the service. See the [Role resource](https://www.kandy.com/docs/chat/rest/role-resource) for more info about roles. </summary> 
        [JsonProperty("default_service_role_sid")]
        public string DefaultServiceRoleSid { get; private set; }

        ///<summary> The channel role assigned to users when they are added to a channel. See the [Role resource](https://www.kandy.com/docs/chat/rest/role-resource) for more info about roles. </summary> 
        [JsonProperty("default_channel_role_sid")]
        public string DefaultChannelRoleSid { get; private set; }

        ///<summary> The channel role assigned to a channel creator when they join a new channel. See the [Role resource](https://www.kandy.com/docs/chat/rest/role-resource) for more info about roles. </summary> 
        ...
        ///<summary> The URL for pre-event webhooks, which are called by using the `webhook_method`. See [Webhook Events](https://www.kandy.com/docs/chat/webhook-events) for more details. </summary> 
        [JsonProperty("pre_webhook_url")]
        public string PreWebhookUrl { get; private set; }

        ///<summary> The URL for post-event webhooks, which are called by using the `webhook_method`. See [Webhook Events](https://www.kandy.com/docs/chat/webhook-events) for more details. </summary> 
        ...
        ///<summary> The notification configuration for the Service instance. See [Push Notification Configuration](https://www.kandy.com/docs/chat/push-notification-configuration) for more info. </summary> 
        ...
        ///<summary> The absolute URLs of the Service's [Channels](https://www.kandy.com/docs/chat/channels), [Roles](https://www.kandy.com/docs/chat/rest/role-resource), [Bindings](https://www.kandy.com/docs/chat/rest/binding-resource), and [Users](https://www.kandy.com/docs/chat/rest/user-resource). </summary> 
        [JsonProperty("links")]
