...
namespace Kandy.Rest.Conversations.V1
{
    public class UserResource : Resource
    {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> A single instance of User </returns>
        public static bool Delete(string pathSid, UserResource.WebhookEnabledTypeEnum xTwilioWebhookEnabled = null, IKandyRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Twilio </param>
        /// <returns> Task that resolves to A single instance of User </returns>
        public static async System.Threading.Tasks.Task<bool> DeleteAsync(string pathSid, UserResource.WebhookEnabledTypeEnum xTwilioWebhookEnabled = null, IKandyRestClient client = null)
        {
            var options = new DeleteUserOptions(pathSid) { XTwilioWebhookEnabled = xTwilioWebhookEnabled };
