...
namespace Kandy.Rest.Sync.V1.Service
{
    ...
    public class CreateDocumentOptions : IOptions<DocumentResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the new Document resource in. </summary> 
        ...
        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Sync Document expires and is deleted (the Sync Document's time-to-live). </summary> 
        public int? Ttl { get; set; }


        /// <summary> Construct a new CreateDocumentOptions </summary>
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) to create the new Document resource in. </param>
    ...
    public class DeleteDocumentOptions : IOptions<DocumentResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Document resource to delete. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Document resource to delete. </param>
    ...
    public class FetchDocumentOptions : IOptions<DocumentResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Document resource to fetch. </summary> 
        public string PathServiceSid { get; }
        ...
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Document resource to fetch. </param>
    ...
    public class ReadDocumentOptions : ReadOptions<DocumentResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Document resources to read. </summary> 
        public string PathServiceSid { get; }



        /// <summary> Construct a new ListDocumentOptions </summary>
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Document resources to read. </param>
    ...
    public class UpdateDocumentOptions : IOptions<DocumentResource>
    {
        ...
        ///<summary> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Document resource to update. </summary> 
        public string PathServiceSid { get; }
        ...
        ///<summary> How long, [in seconds](https://www.kandy.com/docs/sync/limits#sync-payload-limits), before the Sync Document expires and is deleted (time-to-live). </summary> 
        public int? Ttl { get; set; }



        /// <summary> Construct a new UpdateDocumentOptions </summary>
        /// <param name="pathServiceSid"> The SID of the [Sync Service](https://www.kandy.com/docs/sync/api/service) with the Document resource to update. </param>
