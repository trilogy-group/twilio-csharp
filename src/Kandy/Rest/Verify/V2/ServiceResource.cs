...
namespace Kandy.Rest.Verify.V2
{
    public class ServiceResource : Resource
    {
        ...
        /// <param name="pushApnCredentialSid"> Optional configuration for the Push factors. Set the APN Credential for this service. This will allow to send push notifications to iOS devices. See [Credential Resource](https://www.kandy.com/docs/notify/api/credential-resource) </param>
        /// <param name="pushFcmCredentialSid"> Optional configuration for the Push factors. Set the FCM Credential for this service. This will allow to send push notifications to Android devices. See [Credential Resource](https://www.kandy.com/docs/notify/api/credential-resource) </param>
        ...
        /// <param name="defaultTemplateSid"> The default message [template](https://www.kandy.com/docs/verify/api/templates). Will be used for all SMS verifications unless explicitly overriden. SMS channel only. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Service </returns>
