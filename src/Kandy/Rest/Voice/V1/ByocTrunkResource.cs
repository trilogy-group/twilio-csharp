...
namespace Kandy.Rest.Voice.V1
{
    public class ByocTrunkResource : Resource
    {
        ...
        /// <summary> delete </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the BYOC Trunk resource to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of ByocTrunk </returns>
...
#endif
        /// <summary> fetch </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the BYOC Trunk resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of ByocTrunk </returns>
        ...
        /// <summary> update </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the BYOC Trunk resource to update. </param>
        /// <param name="friendlyName"> A descriptive string that you create to describe the resource. It is not unique and can be up to 255 characters long. </param>
        /// <param name="voiceUrl"> The URL we should call when the BYOC Trunk receives a call. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the BYOC Trunk resource. </summary> 
