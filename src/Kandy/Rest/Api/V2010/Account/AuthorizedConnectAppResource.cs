...
namespace Kandy.Rest.Api.V2010.Account
{
    public class AuthorizedConnectAppResource : Resource
    {
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the AuthorizedConnectApp resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of AuthorizedConnectApp </returns>
...
#endif
        /// <summary> Retrieve a list of authorized-connect-apps belonging to the account used to make the request </summary>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the AuthorizedConnectApp resources to read. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the AuthorizedConnectApp resource. </summary> 
