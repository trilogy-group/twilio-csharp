...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class DeleteQueueOptions : IOptions<QueueResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Queue resource to delete </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Queue resource to delete. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class FetchQueueOptions : IOptions<QueueResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Queue resource to fetch </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Queue resource to fetch. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class ReadQueueOptions : ReadOptions<QueueResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Queue resources to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateQueueOptions : IOptions<QueueResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Queue resource to update </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Queue resource to update. </summary> 
        public string PathAccountSid { get; set; }
