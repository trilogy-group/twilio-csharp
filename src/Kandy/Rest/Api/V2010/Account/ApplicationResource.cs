...
namespace Kandy.Rest.Api.V2010.Account
{
    public class ApplicationResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateApplicationOptions options, IKandyRestClient client)
        {
        ...
        public static ApplicationResource Create(CreateApplicationOptions options, IKandyRestClient client = null)
        {
        ...
        /// <param name="publicApplicationConnectEnabled"> Whether to allow other Kandy accounts to dial this applicaton using Dial verb. Can be: `true` or `false`. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Application </returns>
        public static ApplicationResource Create(
                                          ...
                                          Uri voiceUrl = null,
                                          Kandy.Http.HttpMethod voiceMethod = null,
                                          Uri voiceFallbackUrl = null,
                                          Kandy.Http.HttpMethod voiceFallbackMethod = null,
                                          Uri statusCallback = null,
                                          Kandy.Http.HttpMethod statusCallbackMethod = null,
                                          bool? voiceCallerIdLookup = null,
                                          Uri smsUrl = null,
                                          Kandy.Http.HttpMethod smsMethod = null,
                                          Uri smsFallbackUrl = null,
                                          Kandy.Http.HttpMethod smsFallbackMethod = null,
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Application </returns>
        private static Request BuildDeleteRequest(DeleteApplicationOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Application </returns>
        public static bool Delete(DeleteApplicationOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        /// <summary> Delete the application by the specified application sid </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Application resource to delete. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Application resources to delete. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Application </returns>
        ...
        private static Request BuildFetchRequest(FetchApplicationOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Application </returns>
        public static ApplicationResource Fetch(FetchApplicationOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
...
#endif
        /// <summary> Fetch the application specified by the provided sid </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Application resource to fetch. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Application resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Application </returns>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Application </returns>
        public static async System.Threading.Tasks.Task<ApplicationResource> FetchAsync(string pathSid, string pathAccountSid = null, IKandyRestClient client = null)
        {
            var options = new FetchApplicationOptions(pathSid) { PathAccountSid = pathAccountSid };
        ...
        private static Request BuildReadRequest(ReadApplicationOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Application </returns>
        public static ResourceSet<ApplicationResource> Read(ReadApplicationOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
...
#endif
        /// <summary> Retrieve a list of applications representing an application within the requesting account </summary>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Application resources to read. </param>
        ...
        public static Page<ApplicationResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<ApplicationResource> NextPage(Page<ApplicationResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<ApplicationResource> PreviousPage(Page<ApplicationResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        private static Request BuildUpdateRequest(UpdateApplicationOptions options, IKandyRestClient client)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Application </returns>
        public static ApplicationResource Update(UpdateApplicationOptions options, IKandyRestClient client = null)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        /// <summary> Updates the application's properties </summary>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Application resource to update. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Application resources to update. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Application resource. </summary> 
        ...
        ///<summary> Whether to allow other Kandy accounts to dial this applicaton using Dial verb. Can be: `true` or `false`. </summary> 
