...
namespace Kandy.Rest.Autopilot.V1.Assistant.FieldType
{
    public class FieldValueResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the FieldValue resource. </summary> 
        ...
        ///<summary> The SID of the [Assistant](https://www.kandy.com/docs/autopilot/api/assistant) that is the parent of the FieldType associated with the resource. </summary> 
