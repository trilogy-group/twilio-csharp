...
namespace Kandy.Rest.Taskrouter.V1.Workspace
{
    ...
    public class CreateWorkerOptions : IOptions<WorkerResource>
    {
        ...
        ///<summary> The SID of a valid Activity that will describe the new Worker's initial state. See [Activities](https://www.kandy.com/docs/taskrouter/api/activity) for more information. If not provided, the new Worker's initial state is the `default_activity_sid` configured on the Workspace. </summary> 
    ...
    public class UpdateWorkerOptions : IOptions<WorkerResource>
    {
        ...
        ///<summary> The SID of a valid Activity that will describe the Worker's initial state. See [Activities](https://www.kandy.com/docs/taskrouter/api/activity) for more information. </summary> 
        public string ActivitySid { get; set; }
        ...
        ///<summary> Whether to reject the Worker's pending reservations. This option is only valid if the Worker's new [Activity](https://www.kandy.com/docs/taskrouter/api/activity) resource has its `availability` property set to `False`. </summary> 
