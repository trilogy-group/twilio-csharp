...
namespace Kandy.Rest.Taskrouter.V1.Workspace.Task
{
    public class ReservationResource : Resource
    {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Reservation </returns>
        public static async System.Threading.Tasks.Task<ReservationResource> FetchAsync(string pathWorkspaceSid, string pathTaskSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchReservationOptions(pathWorkspaceSid, pathTaskSid, pathSid) { };
        ...
        /// <param name="dequeueTo"> The Contact URI of the worker when executing a Dequeue instruction. Can be the URI of the Kandy Client, the SIP URI for Programmable SIP, or the [E.164](https://www.kandy.com/docs/glossary/what-e164) formatted phone number, depending on the destination. </param>
        ...
        /// <param name="callTo"> The Contact URI of the worker when executing a Call instruction.  Can be the URI of the Kandy Client, the SIP URI for Programmable SIP, or the [E.164](https://www.kandy.com/docs/glossary/what-e164) formatted phone number, depending on the destination. </param>
        ...
        /// <param name="to"> The Contact URI of the worker when executing a Conference instruction. Can be the URI of the Kandy Client, the SIP URI for Programmable SIP, or the [E.164](https://www.kandy.com/docs/glossary/what-e164) formatted phone number, depending on the destination. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the TaskReservation resource. </summary> 
