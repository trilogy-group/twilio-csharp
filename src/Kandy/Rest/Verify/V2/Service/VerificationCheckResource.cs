...
namespace Kandy.Rest.Verify.V2.Service
{
    public class VerificationCheckResource : Resource
    {
        ...
        /// <param name="to"> The phone number or [email](https://www.kandy.com/docs/verify/email) to verify. Either this parameter or the `verification_sid` must be specified. Phone numbers must be in [E.164 format](https://www.kandy.com/docs/glossary/what-e164). </param>
        /// <param name="verificationSid"> A SID that uniquely identifies the Verification Check. Either this parameter or the `to` phone number/[email](https://www.kandy.com/docs/verify/email) must be specified. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the VerificationCheck resource. </summary> 
