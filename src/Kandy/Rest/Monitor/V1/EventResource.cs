...
namespace Kandy.Rest.Monitor.V1
{
    public class EventResource : Resource
    {
        ...
        /// <param name="eventType"> Only include events of this [Event Type](https://www.kandy.com/docs/usage/monitor-events#event-types). </param>
        ...
        /// <param name="sourceIpAddress"> Only include events that originated from this IP address. Useful for tracking suspicious activity originating from the API or the Kandy Console. </param>
        ...
        ///<summary> The type of actor that caused the event. Can be: `user` for a change made by a logged-in user in the Kandy Console, `account` for an event caused by an API request by an authenticating Account, `kandy-admin` for an event caused by a Kandy employee, and so on. </summary> 
        ...
        ///<summary> The type of resource that was affected. For a full list of all resource-types, see the [Monitor Event Types](https://www.kandy.com/docs/usage/monitor-events#event-types). </summary> 
        ...
        ///<summary> The originating system or interface that caused the event.  Can be: `web` for events caused by user action in the Kandy Console, `api` for events caused by a request to our API, or   `kandy` for events caused by an automated or internal Kandy system. </summary> 
        [JsonProperty("source")]
        public string Source { get; private set; }

        ///<summary> The IP address of the source, if the source is outside the Kandy cloud. This value is `null` for events with `source` of `kandy` </summary> 
