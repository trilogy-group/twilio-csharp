...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    public class NotificationResource : Resource
    {
...
#endif
        /// <summary> fetch </summary>
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the Call Notification resource to fetch. </param>
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Call Notification resource to fetch. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call Notification resource to fetch. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Notification </returns>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of Notification </returns>
        public static async System.Threading.Tasks.Task<NotificationResource> FetchAsync(string pathCallSid, string pathSid, string pathAccountSid = null, IKandyRestClient client = null)
        {
            var options = new FetchNotificationOptions(pathCallSid, pathSid) { PathAccountSid = pathAccountSid };
...
#endif
        /// <summary> read </summary>
        /// <param name="pathCallSid"> The [Call](https://www.kandy.com/docs/voice/api/call-resource) SID of the Call Notification resources to read. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call Notification resources to read. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Call Notification resource. </summary> 
        ...
        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Call Notification resource is associated with. </summary> 
        ...
        ///<summary> A unique error code for the error condition that is described in our [Error Dictionary](https://www.kandy.com/docs/api/errors). </summary> 
        ...
        ///<summary> The URL for more information about the error condition. This value is a page in our [Error Dictionary](https://www.kandy.com/docs/api/errors). </summary> 
        ...
        public Kandy.Http.HttpMethod RequestMethod { get; private set; }
