...
namespace Kandy.Rest.Preview.Understand.Assistant.Task
{
    public class FieldResource : Resource
    {
        ...
        ///<summary> The Field Type of this field. It can be any [Built-in Field Type](https://www.kandy.com/docs/assistant/api/built-in-field-types) or the unique_name or sid of a custom Field Type. </summary> 
