...
namespace Kandy.Rest.Conversations.V1.Service
{
    public class ConfigurationResource : Resource
    {
        ...
        /// <param name="defaultConversationCreatorRoleSid"> The conversation-level role assigned to a conversation creator when they join a new conversation. See the [Conversation Role](https://www.kandy.com/docs/conversations/api/role-resource) for more info about roles. </param>
        /// <param name="defaultConversationRoleSid"> The conversation-level role assigned to users when they are added to a conversation. See the [Conversation Role](https://www.kandy.com/docs/conversations/api/role-resource) for more info about roles. </param>
        /// <param name="defaultChatServiceRoleSid"> The service-level role assigned to users when they are added to the service. See the [Conversation Role](https://www.kandy.com/docs/conversations/api/role-resource) for more info about roles. </param>
        /// <param name="reachabilityEnabled"> Whether the [Reachability Indicator](https://www.kandy.com/docs/chat/reachability-indicator) is enabled for this Conversations Service. The default is `false`. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Configuration </returns>
        ...
        ///<summary> The conversation-level role assigned to a conversation creator user when they join a new conversation. See the [Conversation Role](https://www.kandy.com/docs/conversations/api/role-resource) for more info about roles. </summary> 
        [JsonProperty("default_conversation_creator_role_sid")]
        public string DefaultConversationCreatorRoleSid { get; private set; }

        ///<summary> The conversation-level role assigned to users when they are added to a conversation. See the [Conversation Role](https://www.kandy.com/docs/conversations/api/role-resource) for more info about roles. </summary> 
        [JsonProperty("default_conversation_role_sid")]
        public string DefaultConversationRoleSid { get; private set; }

        ///<summary> The service-level role assigned to users when they are added to the service. See the [Conversation Role](https://www.kandy.com/docs/conversations/api/role-resource) for more info about roles. </summary> 
        ...
        ///<summary> Whether the [Reachability Indicator](https://www.kandy.com/docs/chat/reachability-indicator) is enabled for this Conversations Service. The default is `false`. </summary> 
