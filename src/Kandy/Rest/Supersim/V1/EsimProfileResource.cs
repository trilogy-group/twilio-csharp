...
namespace Kandy.Rest.Supersim.V1
{
    public class EsimProfileResource : Resource
    {
        ...
        /// <param name="simSid"> Find the eSIM Profile resource related to a [Sim](https://www.kandy.com/docs/wireless/api/sim-resource) resource by providing the SIM SID. Will always return an array with either 1 or 0 records. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) to which the eSIM Profile resource belongs. </summary> 
        ...
        ///<summary> The SID of the [Sim](https://www.kandy.com/docs/wireless/api/sim-resource) resource that this eSIM Profile controls. </summary> 
