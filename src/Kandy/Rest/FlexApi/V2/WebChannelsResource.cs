...
namespace Kandy.Rest.FlexApi.V2
{
    public class WebChannelsResource : Resource
    {
        ...
        /// <param name="chatFriendlyName"> The Conversation's friendly name. See the [Conversation resource](https://www.kandy.com/docs/conversations/api/conversation-resource) for an example. </param>
        /// <param name="customerFriendlyName"> The Conversation participant's friendly name. See the [Conversation Participant Resource](https://www.kandy.com/docs/conversations/api/conversation-participant-resource) for an example. </param>
        ...
        ///<summary> The unique string representing the [Conversation resource](https://www.kandy.com/docs/conversations/api/conversation-resource) created. </summary> 
        [JsonProperty("conversation_sid")]
        public string ConversationSid { get; private set; }

        ///<summary> The unique string representing the User created and should be authorized to participate in the Conversation. For more details, see [User Identity & Access Tokens](https://www.kandy.com/docs/conversations/identity). </summary> 
