...
namespace Kandy.Rest.Supersim.V1
{
    ...
    public class CreateSmsCommandOptions : IOptions<SmsCommandResource>
    {
        ...
        ///<summary> The `sid` or `unique_name` of the [SIM](https://www.kandy.com/docs/iot/supersim/api/sim-resource) to send the SMS Command to. </summary> 
    ...
    public class ReadSmsCommandOptions : ReadOptions<SmsCommandResource>
    {
        ...
        ///<summary> The status of the SMS Command. Can be: `queued`, `sent`, `delivered`, `received` or `failed`. See the [SMS Command Status Values](https://www.kandy.com/docs/iot/supersim/api/smscommand-resource#status-values) for a description of each. </summary> 
