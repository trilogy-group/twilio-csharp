...
namespace Kandy.Rest.Pricing.V2.Voice
{
    public class NumberResource : Resource
    {
...
#endif
        /// <summary> Fetch pricing information for a specific destination and, optionally, origination phone number. </summary>
        /// <param name="pathDestinationNumber"> The destination phone number, in [E.164](https://www.kandy.com/docs/glossary/what-e164) format, for which to fetch the origin-based voice pricing information. E.164 format consists of a + followed by the country code and subscriber number. </param>
        /// <param name="originationNumber"> The origination phone number, in [E.164](https://www.kandy.com/docs/glossary/what-e164) format, for which to fetch the origin-based voice pricing information. E.164 format consists of a + followed by the country code and subscriber number. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Number </returns>
        ...
        ///<summary> The destination phone number in [E.164](https://www.kandy.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number. </summary> 
        [JsonProperty("destination_number")]
        [JsonConverter(typeof(PhoneNumberConverter))]
        public Types.PhoneNumber DestinationNumber { get; private set; }

        ///<summary> The origination phone number in [[E.164](https://www.kandy.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number. </summary> 
        ...
        ///<summary> The list of [OutboundCallPriceWithOrigin](https://www.kandy.com/docs/voice/pricing#outbound-call-price-with-origin) records. </summary> 
