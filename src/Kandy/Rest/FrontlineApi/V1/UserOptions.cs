...
namespace Kandy.Rest.FrontlineApi.V1
{
    ...
    public class UpdateUserOptions : IOptions<UserResource>
    {
        ...
        ///<summary> Whether the User is available for new conversations. Set to `false` to prevent User from receiving new inbound conversations if you are using [Pool Routing](https://www.kandy.com/docs/frontline/handle-incoming-conversations#3-pool-routing). </summary> 
