...
namespace Kandy.Rest.Conversations.V1.Service.Conversation.Message
{
    public class DeliveryReceiptResource : Resource
    {
...
#endif
        /// <summary> Fetch the delivery and read receipts of the conversation message </summary>
        /// <param name="pathChatServiceSid"> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Message resource is associated with. </param>
        ...
        /// <param name="pathMessageSid"> The SID of the message within a [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) the delivery receipt belongs to. </param>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of DeliveryReceipt </returns>
        public static async System.Threading.Tasks.Task<DeliveryReceiptResource> FetchAsync(string pathChatServiceSid, string pathConversationSid, string pathMessageSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchDeliveryReceiptOptions(pathChatServiceSid, pathConversationSid, pathMessageSid, pathSid) { };
        ...
        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) the Message resource is associated with. </summary> 
        ...
        ///<summary> The SID of the message within a [Conversation](https://www.kandy.com/docs/conversations/api/conversation-resource) the delivery receipt belongs to </summary> 
        ...
        ///<summary> The message [delivery error code](https://www.kandy.com/docs/sms/api/message-resource#delivery-related-errors) for a `failed` status,  </summary> 
