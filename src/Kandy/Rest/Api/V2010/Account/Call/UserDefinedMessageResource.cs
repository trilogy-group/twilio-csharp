...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    public class UserDefinedMessageResource : Resource
    {
        ...
        /// <summary> Create a new User Defined Message for the given Call SID. </summary>
        /// <param name="pathCallSid"> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the User Defined Message is associated with. </param>
        /// <param name="content"> The User Defined Message in the form of URL-encoded JSON string. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created User Defined Message. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created User Defined Message. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the User Defined Message is associated with. </summary> 
