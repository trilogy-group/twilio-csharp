...
namespace Kandy.Rest.Api.V2010.Account.Message
{
    ...
    public class DeleteMediaOptions : IOptions<MediaResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Media resource to delete </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Media resource(s) to delete. </summary> 
    ...
    public class FetchMediaOptions : IOptions<MediaResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Media resource to fetch </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Media resource(s) to fetch. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class ReadMediaOptions : ReadOptions<MediaResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Media resource(s) to read. </summary> 
        public string PathAccountSid { get; set; }
