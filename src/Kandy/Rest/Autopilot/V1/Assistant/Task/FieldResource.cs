...
namespace Kandy.Rest.Autopilot.V1.Assistant.Task
{
    public class FieldResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Field resource. </summary> 
        ...
        ///<summary> The Field Type of the field. Can be: a [Built-in Field Type](https://www.kandy.com/docs/autopilot/built-in-field-types), the unique_name, or the SID of a custom Field Type. </summary> 
        [JsonProperty("field_type")]
        public string FieldType { get; private set; }

        ///<summary> The SID of the [Task](https://www.kandy.com/docs/autopilot/api/task) resource associated with this Field. </summary> 
