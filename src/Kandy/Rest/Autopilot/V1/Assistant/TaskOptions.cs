...
namespace Kandy.Rest.Autopilot.V1.Assistant
{
    ...
    public class CreateTaskOptions : IOptions<TaskResource>
    {
        ...
        ///<summary> The JSON string that specifies the [actions](https://www.kandy.com/docs/autopilot/actions) that instruct the Assistant on how to perform the task. It is optional and not unique. </summary> 
    ...
    public class DeleteTaskOptions : IOptions<TaskResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Task resource to delete. </summary> 
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Task resource to delete. </param>
    ...
    public class FetchTaskOptions : IOptions<TaskResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Task resource to fetch. </summary> 
        public string PathSid { get; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Task resource to fetch. </param>
    ...
    public class UpdateTaskOptions : IOptions<TaskResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Task resource to update. </summary> 
        public string PathSid { get; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Task resource to update. </param>
