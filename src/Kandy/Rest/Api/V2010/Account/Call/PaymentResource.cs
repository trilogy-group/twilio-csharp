...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    public class PaymentResource : Resource
    {
        ...
        /// <param name="statusCallback"> Provide an absolute or relative URL to receive status updates regarding your Pay session. Read more about the [expected StatusCallback values](https://www.kandy.com/docs/voice/api/payment-resource#statuscallback) </param>
        ...
        /// <param name="parameter"> A single-level JSON object used to pass custom parameters to payment processors. (Required for ACH payments). The information that has to be included here depends on the <Pay> Connector. [Read more](https://www.kandy.com/console/voice/pay-connectors). </param>
        /// <param name="paymentConnector"> This is the unique name corresponding to the Pay Connector installed in the Kandy Add-ons. Learn more about [<Pay> Connectors](https://www.kandy.com/console/voice/pay-connectors). The default value is `Default`. </param>
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that will update the resource. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Payments resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Payments resource is associated with. This will refer to the call sid that is producing the payment card (credit/ACH) information thru DTMF. </summary> 
