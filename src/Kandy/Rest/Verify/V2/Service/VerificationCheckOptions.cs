...
namespace Kandy.Rest.Verify.V2.Service
{
    ...
    public class CreateVerificationCheckOptions : IOptions<VerificationCheckResource>
    {
        ...
        ///<summary> The phone number or [email](https://www.kandy.com/docs/verify/email) to verify. Either this parameter or the `verification_sid` must be specified. Phone numbers must be in [E.164 format](https://www.kandy.com/docs/glossary/what-e164). </summary> 
        public string To { get; set; }

        ///<summary> A SID that uniquely identifies the Verification Check. Either this parameter or the `to` phone number/[email](https://www.kandy.com/docs/verify/email) must be specified. </summary> 
