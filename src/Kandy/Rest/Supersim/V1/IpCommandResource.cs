...
namespace Kandy.Rest.Supersim.V1
{
    public class IpCommandResource : Resource
    {
        ...
        /// <summary> Send an IP Command to a Super SIM. </summary>
        /// <param name="sim"> The `sid` or `unique_name` of the [Super SIM](https://www.kandy.com/docs/iot/supersim/api/sim-resource) to send the IP Command to. </param>
        ...
        /// <param name="status"> The status of the IP Command. Can be: `queued`, `sent`, `received` or `failed`. See the [IP Command Status Values](https://www.kandy.com/docs/wireless/api/ipcommand-resource#status-values) for a description of each. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the IP Command resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Super SIM](https://www.kandy.com/docs/iot/supersim/api/sim-resource) that this IP Command was sent to or from. </summary> 
        [JsonProperty("sim_sid")]
        public string SimSid { get; private set; }

        ///<summary> The [ICCID](https://en.wikipedia.org/wiki/Subscriber_identity_module#ICCID) of the [Super SIM](https://www.kandy.com/docs/iot/supersim/api/sim-resource) that this IP Command was sent to or from. </summary> 
