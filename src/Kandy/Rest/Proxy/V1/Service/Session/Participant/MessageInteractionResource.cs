...
namespace Kandy.Rest.Proxy.V1.Service.Session.Participant
{
    public class MessageInteractionResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the MessageInteraction resource. </summary> 
        ...
        ///<summary> The SID of the outbound [Participant](https://www.kandy.com/docs/proxy/api/participant) resource. </summary> 
        [JsonProperty("outbound_participant_sid")]
        public string OutboundParticipantSid { get; private set; }

        ///<summary> The SID of the outbound [Message](https://www.kandy.com/docs/sms/api/message-resource) resource. </summary> 
        ...
        ///<summary> The URL of the Kandy message resource. </summary> 
