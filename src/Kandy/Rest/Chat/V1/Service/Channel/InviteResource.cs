...
namespace Kandy.Rest.Chat.V1.Service.Channel
{
    public class InviteResource : Resource
    {
        ...
        /// <param name="roleSid"> The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to the new member. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Invite </returns>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the Invite resource. </summary> 
        ...
        ///<summary> The SID of the [Role](https://www.kandy.com/docs/api/chat/rest/roles) assigned to the resource. </summary> 
