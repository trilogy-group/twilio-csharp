...
namespace Kandy.Rest.Studio.V1.Flow.Engagement.Step
{
    public class StepContextResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the StepContext resource. </summary> 
