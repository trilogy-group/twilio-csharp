...
namespace Kandy.Rest.Api.V2010.Account.IncomingPhoneNumber
{
    public class TollFreeResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateTollFreeOptions options, IKandyRestClient client)
        {
        ...
        public static TollFreeResource Create(CreateTollFreeOptions options, IKandyRestClient client = null)
        {
