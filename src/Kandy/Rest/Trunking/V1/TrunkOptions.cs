...
namespace Kandy.Rest.Trunking.V1
{
    ...
    public class CreateTrunkOptions : IOptions<TrunkResource>
    {
        ...
        ///<summary> The URL we should call using the `disaster_recovery_method` if an error occurs while sending SIP traffic towards the configured Origination URL. We retrieve TwiML from the URL and execute the instructions like any other normal TwiML call. See [Disaster Recovery](https://www.kandy.com/docs/sip-trunking#disaster-recovery) for more information. </summary> 
        ...
        public Kandy.Http.HttpMethod DisasterRecoveryMethod { get; set; }
