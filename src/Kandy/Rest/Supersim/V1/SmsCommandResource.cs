...
namespace Kandy.Rest.Supersim.V1
{
    public class SmsCommandResource : Resource
    {
        ...
        /// <summary> Send SMS Command to a Sim. </summary>
        /// <param name="sim"> The `sid` or `unique_name` of the [SIM](https://www.kandy.com/docs/iot/supersim/api/sim-resource) to send the SMS Command to. </param>
        ...
        /// <param name="status"> The status of the SMS Command. Can be: `queued`, `sent`, `delivered`, `received` or `failed`. See the [SMS Command Status Values](https://www.kandy.com/docs/iot/supersim/api/smscommand-resource#status-values) for a description of each. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the SMS Command resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [SIM](https://www.kandy.com/docs/iot/supersim/api/sim-resource) that this SMS Command was sent to or from. </summary> 
