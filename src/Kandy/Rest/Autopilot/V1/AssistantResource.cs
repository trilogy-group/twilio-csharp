...
namespace Kandy.Rest.Autopilot.V1
{
    public class AssistantResource : Resource
    {
        ...
        /// <param name="styleSheet"> The JSON string that defines the Assistant's [style sheet](https://www.kandy.com/docs/autopilot/api/assistant/stylesheet) </param>
        /// <param name="defaults"> A JSON object that defines the Assistant's [default tasks](https://www.kandy.com/docs/autopilot/api/assistant/defaults) for various scenarios, including initiation actions and fallback tasks. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Assistant </returns>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Assistant resource. </summary> 
