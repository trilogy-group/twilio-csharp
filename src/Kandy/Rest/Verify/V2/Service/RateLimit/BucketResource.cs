...
namespace Kandy.Rest.Verify.V2.Service.RateLimit
{
    public class BucketResource : Resource
    {
        ...
        /// <summary> Create a new Bucket for a Rate Limit </summary>
        /// <param name="pathServiceSid"> The SID of the [Service](https://www.kandy.com/docs/verify/api/service) the resource is associated with. </param>
        /// <param name="pathRateLimitSid"> The Kandy-provided string that uniquely identifies the Rate Limit resource. </param>
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Rate Limit resource. </summary> 
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Rate Limit resource. </summary> 
