...
namespace Kandy.Rest.Numbers.V2.RegulatoryCompliance
{
    ...
    public class ReadBundleOptions : ReadOptions<BundleResource>
    {
        ...
        ///<summary> The verification status of the Bundle resource. Please refer to [Bundle Statuses](https://www.kandy.com/docs/phone-numbers/regulatory/api/bundles#bundle-statuses) for more details. </summary> 
        ...
        ///<summary> The unique string of a [Regulation resource](https://www.kandy.com/docs/phone-numbers/regulatory/api/regulations) that is associated to the Bundle resource. </summary> 
        public string RegulationSid { get; set; }
