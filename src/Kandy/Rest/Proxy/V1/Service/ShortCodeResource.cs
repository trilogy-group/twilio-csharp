...
namespace Kandy.Rest.Proxy.V1.Service
{
    public class ShortCodeResource : Resource
    {
        ...
        /// <param name="isReserved"> Whether the short code should be reserved and not be assigned to a participant using proxy pool logic. See [Reserved Phone Numbers](https://www.kandy.com/docs/proxy/reserved-phone-numbers) for more information. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of ShortCode </returns>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ShortCode resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the ShortCode resource's parent [Service](https://www.kandy.com/docs/proxy/api/service) resource. </summary> 
