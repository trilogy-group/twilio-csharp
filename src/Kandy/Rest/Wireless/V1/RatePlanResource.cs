...
namespace Kandy.Rest.Wireless.V1
{
    public class RatePlanResource : Resource
    {
        ...
        /// <param name="dataMetering"> The model used to meter data usage. Can be: `payg` and `quota-1`, `quota-10`, and `quota-50`. Learn more about the available [data metering models](https://www.kandy.com/docs/wireless/api/rateplan-resource#payg-vs-quota-data-plans). </param>
        /// <param name="messagingEnabled"> Whether SIMs can make, send, and receive SMS using [Commands](https://www.kandy.com/docs/wireless/api/command-resource). </param>
        /// <param name="voiceEnabled"> Deprecated. </param>
        /// <param name="nationalRoamingEnabled"> Whether SIMs can roam on networks other than the home network (T-Mobile USA) in the United States. See [national roaming](https://www.kandy.com/docs/wireless/api/rateplan-resource#national-roaming). </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the RatePlan resource. </summary> 
        ...
        ///<summary> The model used to meter data usage. Can be: `payg` and `quota-1`, `quota-10`, and `quota-50`. Learn more about the available [data metering models](https://www.kandy.com/docs/wireless/api/rateplan-resource#payg-vs-quota-data-plans). </summary> 
        ...
        ///<summary> Whether SIMs can make, send, and receive SMS using [Commands](https://www.kandy.com/docs/wireless/api/command-resource). </summary> 
        ...
        ///<summary> Whether SIMs can roam on networks other than the home network (T-Mobile USA) in the United States. See [national roaming](https://www.kandy.com/docs/wireless/api/rateplan-resource#national-roaming). </summary> 
