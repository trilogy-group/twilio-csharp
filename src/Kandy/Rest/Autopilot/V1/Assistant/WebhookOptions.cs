...
namespace Kandy.Rest.Autopilot.V1.Assistant
{
    ...
    public class DeleteWebhookOptions : IOptions<WebhookResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Webhook resource to delete. </summary> 
    ...
    public class FetchWebhookOptions : IOptions<WebhookResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Webhook resource to fetch. </summary> 
        public string PathSid { get; }
    ...
    public class UpdateWebhookOptions : IOptions<WebhookResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Webhook resource to update. </summary> 
        public string PathSid { get; }
