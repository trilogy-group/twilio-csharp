...
namespace Kandy.Rest.Api.V2010.Account
{
    public class ValidationRequestResource : Resource
    {
        ...
        /// <summary> create </summary>
        /// <param name="phoneNumber"> The phone number to verify in [E.164](https://www.kandy.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for the new caller ID resource. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for the Caller ID. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Caller ID is associated with. </summary> 
        ...
        ///<summary> The phone number to verify in [E.164](https://www.kandy.com/docs/glossary/what-e164) format, which consists of a + followed by the country code and subscriber number. </summary> 
