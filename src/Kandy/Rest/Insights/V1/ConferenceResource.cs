...
namespace Kandy.Rest.Insights.V1
{
    public class ConferenceResource : Resource
    {
        ...
        /// <param name="mixerRegion"> Kandy region where the conference media was mixed. </param>
        /// <param name="tags"> Tags applied by Kandy for common potential configuration, quality, or performance issues. </param>
        ...
        ///<summary> Potential issues detected by Kandy during the conference. </summary> 
