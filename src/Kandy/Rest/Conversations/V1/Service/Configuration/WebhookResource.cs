...
namespace Kandy.Rest.Conversations.V1.Service.Configuration
{
    public class WebhookResource : Resource
    {
...
#endif
        /// <summary> Fetch a specific service webhook configuration. </summary>
        /// <param name="pathChatServiceSid"> The unique ID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) this conversation belongs to. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of Webhook </returns>
        ...
        ///<summary> The unique ID of the [Account](https://www.kandy.com/docs/iam/api/account) responsible for this service. </summary> 
