...
namespace Kandy.Rest.Api.V2010.Account
{
    public class TokenResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Token resource. </summary> 
        ...
        ///<summary> The temporary password that the username will use when authenticating with Kandy. </summary> 
