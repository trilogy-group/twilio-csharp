...
namespace Kandy.Rest.FlexApi.V1
{
    public class InsightsSettingsAnswerSetsResource : Resource
    {
        ...
        private static Request BuildFetchRequest(FetchInsightsSettingsAnswerSetsOptions options, IKandyRestClient client)
        {
        ...
        public static InsightsSettingsAnswerSetsResource Fetch(FetchInsightsSettingsAnswerSetsOptions options, IKandyRestClient client = null)
        {
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of InsightsSettingsAnswerSets </returns>
        public static async System.Threading.Tasks.Task<InsightsSettingsAnswerSetsResource> FetchAsync(string authorization = null, IKandyRestClient client = null)
        {
            var options = new FetchInsightsSettingsAnswerSetsOptions() { Authorization = authorization };
