...
namespace Kandy.Rest.Accounts.V1.Credential
{
    ...
    public class DeletePublicKeyOptions : IOptions<PublicKeyResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the PublicKey resource to delete. </summary> 
    ...
    public class FetchPublicKeyOptions : IOptions<PublicKeyResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the PublicKey resource to fetch. </summary> 
        public string PathSid { get; }
    ...
    public class UpdatePublicKeyOptions : IOptions<PublicKeyResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the PublicKey resource to update. </summary> 
        public string PathSid { get; }
