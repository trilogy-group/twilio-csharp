...
namespace Kandy.Rest.Proxy.V1.Service
{
    public class PhoneNumberResource : Resource
    {
        ...
        /// <param name="sid"> The SID of a Kandy [IncomingPhoneNumber](https://www.kandy.com/docs/phone-numbers/api/incomingphonenumber-resource) resource that represents the Kandy Number you would like to assign to your Proxy Service. </param>
        /// <param name="phoneNumber"> The phone number in [E.164](https://www.kandy.com/docs/glossary/what-e164) format.  E.164 phone numbers consist of a + followed by the country code and subscriber number without punctuation characters. For example, +14155551234. </param>
        /// <param name="isReserved"> Whether the new phone number should be reserved and not be assigned to a participant using proxy pool logic. See [Reserved Phone Numbers](https://www.kandy.com/docs/proxy/reserved-phone-numbers) for more information. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of PhoneNumber </returns>
        ...
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> Task that resolves to A single instance of PhoneNumber </returns>
        public static async System.Threading.Tasks.Task<PhoneNumberResource> FetchAsync(string pathServiceSid, string pathSid, IKandyRestClient client = null)
        {
            var options = new FetchPhoneNumberOptions(pathServiceSid, pathSid) { };
        ...
        /// <param name="isReserved"> Whether the phone number should be reserved and not be assigned to a participant using proxy pool logic. See [Reserved Phone Numbers](https://www.kandy.com/docs/proxy/reserved-phone-numbers) for more information. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of PhoneNumber </returns>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the PhoneNumber resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the PhoneNumber resource's parent [Service](https://www.kandy.com/docs/proxy/api/service) resource. </summary> 
        ...
        ///<summary> The number of open session assigned to the number. See the [How many Phone Numbers do I need?](https://www.kandy.com/docs/proxy/phone-numbers-needed) guide for more information. </summary> 
        [JsonProperty("in_use")]
