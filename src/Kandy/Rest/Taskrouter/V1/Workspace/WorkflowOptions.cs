...
namespace Kandy.Rest.Taskrouter.V1.Workspace
{
    ...
    public class CreateWorkflowOptions : IOptions<WorkflowResource>
    {
        ...
        ///<summary> A JSON string that contains the rules to apply to the Workflow. See [Configuring Workflows](https://www.kandy.com/docs/taskrouter/workflow-configuration) for more information. </summary> 
        public string Configuration { get; }

        ///<summary> The URL from your application that will process task assignment events. See [Handling Task Assignment Callback](https://www.kandy.com/docs/taskrouter/handle-assignment-callbacks) for more details. </summary> 
