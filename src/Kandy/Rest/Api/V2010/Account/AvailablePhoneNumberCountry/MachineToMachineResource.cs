...
namespace Kandy.Rest.Api.V2010.Account.AvailablePhoneNumberCountry
{
    public class MachineToMachineResource : Resource
    {
        ...
        private static Request BuildReadRequest(ReadMachineToMachineOptions options, IKandyRestClient client)
        {
        ...
        public static ResourceSet<MachineToMachineResource> Read(ReadMachineToMachineOptions options, IKandyRestClient client = null)
        {
        ...
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) requesting the AvailablePhoneNumber resources. </param>
        /// <param name="areaCode"> The area code of the phone numbers to read. Applies to only phone numbers in the US and Canada. </param>
        /// <param name="contains"> The pattern on which to match phone numbers. Valid characters are `*`, `0-9`, `a-z`, and `A-Z`. The `*` character matches any single digit. For examples, see [Example 2](https://www.kandy.com/docs/phone-numbers/api/availablephonenumber-resource#local-get-basic-example-2) and [Example 3](https://www.kandy.com/docs/phone-numbers/api/availablephonenumber-resource#local-get-basic-example-3). If specified, this value must have at least two characters. </param>
        ...
        /// <param name="excludeAllAddressRequired"> Whether to exclude phone numbers that require an [Address](https://www.kandy.com/docs/usage/api/address). Can be: `true` or `false` and the default is `false`. </param>
        /// <param name="excludeLocalAddressRequired"> Whether to exclude phone numbers that require a local [Address](https://www.kandy.com/docs/usage/api/address). Can be: `true` or `false` and the default is `false`. </param>
        /// <param name="excludeForeignAddressRequired"> Whether to exclude phone numbers that require a foreign [Address](https://www.kandy.com/docs/usage/api/address). Can be: `true` or `false` and the default is `false`. </param>
        /// <param name="beta"> Whether to read phone numbers that are new to the Kandy platform. Can be: `true` or `false` and the default is `true`. </param>
        ...
        public static Page<MachineToMachineResource> GetPage(string targetUrl, IKandyRestClient client)
        {
            client = client ?? KandyClient.GetRestClient();
        ...
        public static Page<MachineToMachineResource> NextPage(Page<MachineToMachineResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
        ...
        public static Page<MachineToMachineResource> PreviousPage(Page<MachineToMachineResource> page, IKandyRestClient client)
        {
            var request = new Request(
                HttpMethod.Get,
