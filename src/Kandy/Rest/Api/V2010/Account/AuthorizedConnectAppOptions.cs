...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class FetchAuthorizedConnectAppOptions : IOptions<AuthorizedConnectAppResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the AuthorizedConnectApp resource to fetch. </summary> 
    ...
    public class ReadAuthorizedConnectAppOptions : ReadOptions<AuthorizedConnectAppResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the AuthorizedConnectApp resources to read. </summary> 
        public string PathAccountSid { get; set; }
