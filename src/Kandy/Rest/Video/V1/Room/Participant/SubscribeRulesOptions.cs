...
namespace Kandy.Rest.Video.V1.Room.Participant
{
    ...
    public class UpdateSubscribeRulesOptions : IOptions<SubscribeRulesResource>
    {
        ...
        ///<summary> A JSON-encoded array of subscribe rules. See the [Specifying Subscribe Rules](https://www.kandy.com/docs/video/api/track-subscriptions#specifying-sr) section for further information. </summary> 
