...
namespace Kandy.Rest.Supersim.V1
{
    ...
    public class CreateIpCommandOptions : IOptions<IpCommandResource>
    {
        ...
        ///<summary> The `sid` or `unique_name` of the [Super SIM](https://www.kandy.com/docs/iot/supersim/api/sim-resource) to send the IP Command to. </summary> 
    ...
    public class ReadIpCommandOptions : ReadOptions<IpCommandResource>
    {
        ...
        ///<summary> The status of the IP Command. Can be: `queued`, `sent`, `received` or `failed`. See the [IP Command Status Values](https://www.kandy.com/docs/wireless/api/ipcommand-resource#status-values) for a description of each. </summary> 
