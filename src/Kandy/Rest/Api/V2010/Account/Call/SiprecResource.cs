...
namespace Kandy.Rest.Api.V2010.Account.Call
{
    public class SiprecResource : Resource
    {
        ...
        /// <summary> Create a Siprec </summary>
        /// <param name="pathCallSid"> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Siprec resource is associated with. </param>
        /// <param name="pathAccountSid"> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created this Siprec resource. </param>
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created this Siprec resource. </summary> 
        [JsonProperty("account_sid")]
        public string AccountSid { get; private set; }

        ///<summary> The SID of the [Call](https://www.kandy.com/docs/voice/api/call-resource) the Siprec resource is associated with. </summary> 
