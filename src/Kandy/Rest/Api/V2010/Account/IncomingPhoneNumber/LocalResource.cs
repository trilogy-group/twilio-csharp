...
namespace Kandy.Rest.Api.V2010.Account.IncomingPhoneNumber
{
    public class LocalResource : Resource
    {
        ...
        private static Request BuildCreateRequest(CreateLocalOptions options, IKandyRestClient client)
        {
        ...
        public static LocalResource Create(CreateLocalOptions options, IKandyRestClient client = null)
        {
