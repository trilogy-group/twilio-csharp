...
namespace Kandy.Rest.Conversations.V1.Service
{
    ...
    public class CreateUserOptions : IOptions<UserResource>
    {
        ...
        ///<summary> The SID of a service-level [Role](https://www.kandy.com/docs/conversations/api/role-resource) to assign to the user. </summary> 
    ...
    public class DeleteUserOptions : IOptions<UserResource>
    {
        ...
        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to delete the User resource from. </summary> 
        public string PathChatServiceSid { get; }
    ...
    public class FetchUserOptions : IOptions<UserResource>
    {
        ...
        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to fetch the User resource from. </summary> 
        public string PathChatServiceSid { get; }
    ...
    public class ReadUserOptions : ReadOptions<UserResource>
    {
        ...
        ///<summary> The SID of the [Conversation Service](https://www.kandy.com/docs/conversations/api/service-resource) to read the User resources from. </summary> 
        public string PathChatServiceSid { get; }
