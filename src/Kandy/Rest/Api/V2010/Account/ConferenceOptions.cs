...
namespace Kandy.Rest.Api.V2010.Account
{
    ...
    public class FetchConferenceOptions : IOptions<ConferenceResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Conference resource to fetch </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference resource(s) to fetch. </summary> 
    ...
    public class ReadConferenceOptions : ReadOptions<ConferenceResource>
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference resource(s) to read. </summary> 
        public string PathAccountSid { get; set; }
    ...
    public class UpdateConferenceOptions : IOptions<ConferenceResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Conference resource to update </summary> 
        public string PathSid { get; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the Conference resource(s) to update. </summary> 
        public string PathAccountSid { get; set; }
