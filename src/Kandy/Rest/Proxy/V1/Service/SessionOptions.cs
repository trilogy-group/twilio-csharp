...
namespace Kandy.Rest.Proxy.V1.Service
{
    ...
    public class DeleteSessionOptions : IOptions<SessionResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Session resource to delete. </summary> 
    ...
    public class FetchSessionOptions : IOptions<SessionResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Session resource to fetch. </summary> 
        public string PathSid { get; }
    ...
    public class ReadSessionOptions : ReadOptions<SessionResource>
    {
        ...
        ///<summary> The SID of the parent [Service](https://www.kandy.com/docs/proxy/api/service) of the resource to read. </summary> 
        public string PathServiceSid { get; }
    ...
    public class UpdateSessionOptions : IOptions<SessionResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Session resource to update. </summary> 
        public string PathSid { get; }
