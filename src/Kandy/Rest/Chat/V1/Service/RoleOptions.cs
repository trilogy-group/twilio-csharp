...
namespace Kandy.Rest.Chat.V1.Service
{
    ...
    public class DeleteRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Role resource to delete. </summary> 
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Role resource to delete. </param>
    ...
    public class FetchRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Role resource to fetch. </summary> 
        public string PathSid { get; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Role resource to fetch. </param>
    ...
    public class UpdateRoleOptions : IOptions<RoleResource>
    {
        ...
        ///<summary> The Kandy-provided string that uniquely identifies the Role resource to update. </summary> 
        public string PathSid { get; }
        ...
        /// <param name="pathSid"> The Kandy-provided string that uniquely identifies the Role resource to update. </param>
