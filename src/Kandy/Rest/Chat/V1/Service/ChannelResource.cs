...
namespace Kandy.Rest.Chat.V1.Service
{
    public class ChannelResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/api/rest/account) that created the Channel resource. </summary> 
        ...
        ///<summary> The absolute URLs of the [Members](https://www.kandy.com/docs/chat/api/members), [Messages](https://www.kandy.com/docs/chat/api/messages) , [Invites](https://www.kandy.com/docs/chat/api/invites) and, if it exists, the last [Message](https://www.kandy.com/docs/chat/api/messages) for the Channel. </summary> 
        [JsonProperty("links")]
