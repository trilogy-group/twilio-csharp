...
namespace Kandy.Rest.Numbers.V2.RegulatoryCompliance
{
    public class EndUserResource : Resource
    {
        ...
        /// <summary> Delete a specific End User. </summary>
        /// <param name="pathSid"> The unique string created by Kandy to identify the End User resource. </param>
        /// <param name="client"> Client to make requests to Kandy </param>
        /// <returns> A single instance of EndUser </returns>
        ...
        ///<summary> The unique string created by Kandy to identify the End User resource. </summary> 
        [JsonProperty("sid")]
        public string Sid { get; private set; }

        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the End User resource. </summary> 
