...
namespace Kandy.Rest.Studio.V1.Flow.Execution.ExecutionStep
{
    public class ExecutionStepContextResource : Resource
    {
        ...
        ///<summary> The SID of the [Account](https://www.kandy.com/docs/iam/api/account) that created the ExecutionStepContext resource. </summary> 
